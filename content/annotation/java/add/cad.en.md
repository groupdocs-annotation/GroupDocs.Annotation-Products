...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/cad"/>

############################# Head ############################
head_title: "Add Annotations to CAD in Java Application"
head_description: "Java API to create and Add popular annotation types to CAD, images, drawings and document file formats."

############################# Header ############################
title: "Add CAD Files to Java"
description: ""
