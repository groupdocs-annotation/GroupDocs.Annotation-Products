...
draft: false
############################# Head ############################
head_title: "Добавление аннотаций в САПР в приложениях Java"
head_description: "Java API для создания и добавления популярных типов аннотаций в САПР, изображения, чертежи и форматы файлов документов."
############################# Header ############################
title: "Аннотировать файлы САПР в Java"
description: "Добавляйте аннотации к CAD, документам Microsoft Office, изображениям, HTML, чертежам и файлам других форматов в любых типах приложений Java."
