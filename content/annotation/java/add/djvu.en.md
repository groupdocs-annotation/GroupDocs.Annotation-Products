...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/djvu"/>

############################# Head ############################
head_title: "Add Annotations to DJVU in Java Application"
head_description: "Java API to create and Add popular annotation types to DJVU, images, drawings and document file formats."

############################# Header ############################
title: "Add DJVU Files to Java"
description: ""
