...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/dot"/>

############################# Head ############################
head_title: "Add Annotations to DOT in Java Application"
head_description: "Java API to create and Add popular annotation types to DOT, images, drawings and document file formats."

############################# Header ############################
title: "Add DOT Files to Java"
description: ""
