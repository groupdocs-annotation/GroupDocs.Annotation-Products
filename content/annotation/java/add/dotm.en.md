...
############################# Head ############################
head_title: "Add Annotations to DOTM in Java Application"
head_description: "Java API to create and Add popular annotation types to DOTM, images, drawings and document file formats."

############################# Header ############################
title: "Add DOTM Files to Java"
description: "Add annotations to DOTM, Microsoft Office documents, images, HTML, drawings and other file formats in any type of Java application."
...
steps:
    enable: true
    title_left: "Steps to Add Annotations to DOTM in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easy for Java developers to add various annotation types to DOTM files within any Java-based application by implementing a few easy steps.
