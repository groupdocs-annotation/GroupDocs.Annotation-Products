...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/dwg"/>

############################# Head ############################
head_title: "Add Annotations to DWG in Java Application"
head_description: "Java API to create and Add popular annotation types to DWG, images, drawings and document file formats."

############################# Header ############################
title: "Add DWG Files to Java"
description: ""
