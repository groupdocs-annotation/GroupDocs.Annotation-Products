...
head_title: "JavaアプリケーションのDWGに注釈を追加する"
head_description: "一般的な注釈タイプを作成してDWG、画像、図面、およびドキュメントファイル形式に追加するJava API."

title: "JavaでDWGファイルに注釈を付ける"
description: "あらゆるタイプのJavaアプリケーションで、DWG、Microsoft Officeドキュメント、画像、HTML、図面、およびその他のファイル形式に注釈を追加します."
...
demos:
    ...
    content: |
        [GroupDocs.Annotationライブデモ](https://products.groupdocs.app/annotation/family)サイトにアクセスして、今すぐDWGファイルに注釈を作成して追加します。  
        ライブデモには次の利点があります
