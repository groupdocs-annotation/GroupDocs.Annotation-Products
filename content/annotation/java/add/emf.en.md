...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/emf"/>

############################# Head ############################
head_title: "Add Annotations to EMF in Java Application"
head_description: "Java API to create and Add popular annotation types to EMF, images, drawings and document file formats."

############################# Header ############################
title: "Add EMF Files to Java"
description: ""
