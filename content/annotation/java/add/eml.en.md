...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/eml"/>

############################# Head ############################
head_title: "Add Annotations to EML in Java Application"
head_description: "Java API to create and Add popular annotation types to EML, images, drawings and document file formats."

############################# Header ############################
title: "Add EML Files to Java"
description: ""
