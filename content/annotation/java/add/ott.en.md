...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/ott"/>

############################# Head ############################
head_title: "Add Annotations to OTT in Java Application"
head_description: "Java API to create and Add popular annotation types to OTT, images, drawings and document file formats."

############################# Header ############################
title: "Add OTT Files to Java"
description: ""
