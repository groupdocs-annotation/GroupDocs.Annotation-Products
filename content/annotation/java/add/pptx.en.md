...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/pptx"/>

############################# Head ############################
head_title: "Add Annotations to PPTX in Java Application"
head_description: "Java API to create and Add popular annotation types to PPTX, images, drawings and document file formats."

############################# Header ############################
title: "Add PPTX Files to Java"
description: ""
