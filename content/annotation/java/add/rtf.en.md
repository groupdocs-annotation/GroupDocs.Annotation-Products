...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/rtf"/>

############################# Head ############################
head_title: "Add Annotations to RTF in Java Application"
head_description: "Java API to create and Add popular annotation types to RTF, images, drawings and document file formats."

############################# Header ############################
title: "Add RTF Files to Java"
description: ""
