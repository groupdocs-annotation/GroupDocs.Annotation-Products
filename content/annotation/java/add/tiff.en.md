...
############################# Head ############################
head_title: "Add Annotations to TIFF in Java Application"
head_description: "Java API to create and Add popular annotation types to TIFF, images, drawings and document file formats."

############################# Header ############################
title: "Add TIFF Files to Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Add Annotations to TIFF in Java"
    content_left: |
