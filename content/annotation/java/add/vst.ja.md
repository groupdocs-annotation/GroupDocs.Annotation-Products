...
head_title: "JavaアプリケーションのVSTに注釈を追加する"
head_description: "一般的なアノテーションタイプを作成してVST、画像、図面、ドキュメントファイル形式に追加するJava API."

title: "JavaでVSTファイルに注釈を付ける"
description: "あらゆるタイプのJavaアプリケーションで、VST、Microsoft Officeドキュメント、画像、HTML、図面、その他のファイル形式に注釈を追加します."
...
demos:
    ...
    content: |
        [GroupDocs.Annotationライブデモ](https://products.groupdocs.app/annotation/family)サイトにアクセスして、今すぐVSTファイルに注釈を作成して追加します。  
        ライブデモには次の利点があります
