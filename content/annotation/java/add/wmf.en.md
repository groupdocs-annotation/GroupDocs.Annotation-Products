...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/wmf"/>

############################# Head ############################
head_title: "Add Annotations to WMF in Java Application"
head_description: "Java API to create and Add popular annotation types to WMF, images, drawings and document file formats."

############################# Header ############################
title: "Add WMF Files to Java"
description: ""
