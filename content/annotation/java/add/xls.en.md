...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/xls"/>

############################# Head ############################
head_title: "Add Annotations to XLS in Java Application"
head_description: "Java API to create and Add popular annotation types to XLS, images, drawings and document file formats."

############################# Header ############################
title: "Add XLS Files to Java"
description: ""
