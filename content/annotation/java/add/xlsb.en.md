...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/add/xlsb"/>

############################# Head ############################
head_title: "Add Annotations to XLSB in Java Application"
head_description: "Java API to create and Add popular annotation types to XLSB, images, drawings and document file formats."

############################# Header ############################
title: "Add XLSB Files to Java"
description: ""
