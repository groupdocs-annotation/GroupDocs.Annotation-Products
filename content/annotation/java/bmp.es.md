...
############################# Head ############################
head_title: "Java BMP API de anotación Anotar en C#"
head_description: "Java API para crear y Anotar tipos de anotaciones populares de BMP, imágenes, dibujos y formatos de archivos de documentos."

############################# Header ############################
title: "Anotar BMP de Java"
description: ""
...
about:
    ...
    content: |
        ...
        Esta biblioteca le permite trabajar no solo con documentos BMP, sino también con muchos otros tipos de documentos como Word, Excel, PowerPoint, correos electrónicos de Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad y muchos otros.
        ...
        El ejemplo (consulte a continuación) demuestra cómo trabajar con el documento BMP, en este ejemplo puede ver los pasos principales de cómo trabajar con GroupDocs. anotación, agregando objetos de datos para establecer las propiedades de la anotación de acuerdo con sus requisitos y guardando el resultado en el lugar necesario. También puede echar un vistazo más detallado a las funciones admitidas en nuestra de github [página](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java), o en nuestro producto [documentación](https://docs.groupdocs.com/annotation/java/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Pasos para agregar anotaciones de BMP en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita a los desarrolladores de Java agregar varios tipos de anotaciones a los archivos BMP dentro de cualquier aplicación basada en Java mediante la implementación de unos sencillos pasos.
...
steps_Remove:
    enable: true
    title_left: "Pasos para eliminar anotaciones de BMP en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) hace que sea más fácil para los desarrolladores de Java eliminar los detalles de las anotaciones de los archivos BMP dentro de cualquier aplicación basada en Java mediante la implementación de unos sencillos pasos.
        * Crear objetos de respuesta con comentario y fecha.
...
steps_Edit:
    enable: true
    title_left: "Pasos para editar anotaciones de BMP en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) hace que sea más fácil para los desarrolladores de Java actualizar varias propiedades de anotación de archivos BMP dentro de cualquier aplicación basada en Java mediante la implementación de unos sencillos pasos.
...
steps_Extract:
    enable: true
    title_left: "Pasos para extraer anotaciones de BMP en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita a los desarrolladores de Java anotar documentos y extraer información de anotaciones de archivos BMP dentro de cualquier aplicación basada en Java mediante la implementación de unos sencillos pasos.
        * Crear objetos de respuesta con comentario y fecha.
...
demos:
    ...
    content: |
        Añada, elimine, edite y extraiga anotaciones en archivos BMP ahora mismo visitando el sitio web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-bmp"
          title: "Acerca del formato de archivo BMP"
          content: |
