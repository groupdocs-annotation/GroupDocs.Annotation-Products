...
############################# Head ############################
head_title: "Java BMP Adnotare API Adnotare în C#"
head_description: "API Java pentru a crea și adnota tipuri populare de adnotări din BMP, imagini, desene și formate de fișiere de documente."

############################# Header ############################
title: "Adnotă BMP din Java"
description: ""
...
about:
    ...
    content: |
        ...
        Această bibliotecă vă permite să lucrați nu numai cu documentul BMP, ci și cu multe alte tipuri de documente, cum ar fi Word, Excel, PowerPoint, e-mailuri Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad și multe altele.
...
steps_Remove:
    enable: true
    title_left: "Pași pentru a elimina adnotările din BMP în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java eliminarea detaliilor adnotărilor din fișierele BMP din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
steps_Edit:
    enable: true
    title_left: "Pași pentru editarea adnotărilor din BMP în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java actualizarea diferitelor proprietăți de adnotări din fișierele BMP din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
...
steps_Extract:
    enable: true
    title_left: "Pași pentru extragerea adnotărilor din BMP în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) le permite dezvoltatorilor Java să adnoteze documente și să extragă informații despre adnotări din fișiere BMP din orice aplicație bazată pe Java, prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
demos:
    ...
    content: |
        Adăugați, eliminați, editați și extrageți adnotări în fișierul BMP chiar acum, vizitând site-ul web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo-ul live are următoarele beneficii
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-bmp"
          title: "Despre formatul de fișier BMP"
          content: |
