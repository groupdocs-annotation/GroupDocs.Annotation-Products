...
############################# Head ############################
head_title: "Java BMP Annotation API C# 中的注释"
head_description: "Java API 用于从 BMP、图像、绘图和文档文件格式创建和注释流行的注释类型。"
...
steps_Add:
    enable: true
    title_left: "在 Java 中向 BMP 添加注释的步骤"
    content_left: |
...
steps_Remove:
    enable: true
    title_left: "在 Java 中从 BMP 中删除注释的步骤"
    content_left: |
...
steps_Edit:
    enable: true
    title_left: "在 Java 中编辑 BMP 注释的步骤"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) 通过实施几个简单的步骤，Java 开发人员可以更轻松地从任何基于 Java 的应用程序中的 BMP 文件更新各种注释属性。
...
steps_Extract:
    enable: true
    title_left: "在 Java 中从 BMP 提取注释的步骤"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) 通过实施几个简单的步骤，Java 开发人员可以轻松地对文档进行注释并从任何基于 Java 的应用程序中的 BMP 文件中提取注释信息。
        *   创建带有评论和日期的 Reply 对象。
