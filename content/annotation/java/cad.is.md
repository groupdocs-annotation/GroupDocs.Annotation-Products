...
############################# Head ############################
head_title: "Java CAD Annotation API Annotate í C#"
head_description: "Java API til að búa til og athugasemda við vinsælar athugasemdagerðir úr CAD, myndum, teikningum og skjalaskráarsniðum."

############################# Header ############################
title: "Skýrðu CAD frá Java"
description: ""
...
about:
    ...
    content: |
        ...
        Þetta bókasafn gerir þér kleift að vinna ekki aðeins með CAD skjölum heldur einnig með mörgum öðrum skjölum eins og Word, Excel, PowerPoint, Outlook tölvupósti, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad og mörgum öðrum.
        ...
        Dæmið (vinsamlegast sjáðu hér að neðan) sýnir að þú vinnur með CAD skjal, í þessu dæmi gætirðu séð helstu skrefin í því hvernig á að vinna með GroupDocs.Athugasemd: Setja upp leyfi, opna skjal sem þú vilt vinna með, búa til athugasemd, bæta við gagnahlutum til að stilla athugasemdareiginleika í samræmi við kröfur þínar og vista niðurstöðuna á nauðsynlegum stað. Þú gætir líka skoðað studdu eiginleikana á github [síðu] okkar (https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java), eða í vörunni okkar [skjölum](https: //docs.groupdocs.com/annotation/java/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Skref til að bæta athugasemdum við CAD í Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) gerir það auðvelt fyrir Java forritara að bæta ýmsum athugasemdategundum við CAD skrár innan hvaða Java-undirstaða forrits sem er með því að útfæra nokkur auðveld skref.
...
steps_Remove:
    enable: true
    title_left: "Skref til að fjarlægja athugasemdir úr CAD í Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) gerir það auðveldara fyrir Java forritara að fjarlægja athugasemdaupplýsingar úr CAD skrám innan hvaða Java-undirstaða forrits sem er með því að útfæra nokkur einföld skref.
        *   Búðu til svarhluti með athugasemd og dagsetningu.
...
steps_Edit:
    enable: true
    title_left: "Skref til að breyta athugasemdum frá CAD í Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) gerir það auðveldara fyrir Java forritara að uppfæra ýmsa skýringaeiginleika úr CAD skrám innan hvaða Java-undirstaða forrits sem er með því að útfæra nokkur einföld skref.
...
steps_Extract:
    enable: true
    title_left: "Skref til að draga út athugasemdir úr CAD í Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) gerir það auðvelt fyrir Java forritara að skrifa athugasemdir við skjöl og draga út athugasemdaupplýsingar úr CAD skrám í hvaða Java-undirstaða forriti sem er með því að útfæra nokkur einföld skref.
        *   Búðu til svarhluti með athugasemd og dagsetningu.
...
demos:
    ...
    content: |
        Bættu við, fjarlægðu, breyttu og dragðu út athugasemdir við CAD skrána núna með því að fara á vefsíðu [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Lifandi kynningin hefur eftirfarandi kosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-cad"
          title: "Um CAD skráarsnið"
          content: |
            CAD stendur fyrir Computer Aided Design. Hugtakið CADD (for Computer Aided Design and Drafting) er einnig notað. Það er notað fyrir 3D grafík skráarsnið og getur innihaldið 2D eða 3D hönnun. CAD skrá er stafrænt skráarsnið hlutar sem er búinn til og notaður af CAD hugbúnaði. CAD skrá inniheldur tækniteikningu, teikningu, skýringarmynd eða 3D flutning á hlut. Það kunna að vera önnur CAD verkfæri sem hægt er að nota til að búa til, opna, breyta og flytja þessar .cad skrár yfir í meira notað CAD teikningaskráarsnið.
