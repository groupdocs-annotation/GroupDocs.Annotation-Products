...
head_description: "Java API to create and Annotate popular annotation types from CSV, images, drawings and document file formats."

############################# Header ############################
title: "Annotate CSV from Java"
description: ""
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations from CSV in Java"
    content_left: |
...
steps_Remove:
    enable: true
    title_left: "Steps to Remove Annotations from CSV in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Java developers to remove annotation details from CSV files within any Java-based application by implementing a few easy steps.
