...
############################# Head ############################
head_title: "Remove Annotations from CSV in Java Application"
head_description: "Java API to create and Remove popular annotation types from CSV, images, drawings and document file formats."
