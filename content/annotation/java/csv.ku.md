...
head_description: "Java API ku ji CSV, wêne, xêzkirin û formatên pelên pelgeyê celebên annotasyonên populer çêbike û annot bike."

############################# Header ############################
title: "Ji Javayê CSV şîrove bikin"
description: ""
...
about:
    ...
    content: |
        ...
        Ev pirtûkxane dihêle hûn ne tenê bi belgeya CSV re lê her weha bi gelek celeb belgeyên din ên wekî Word, Excel, PowerPoint, e-nameyên Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad û gelekên din re bixebitin.
...
steps_Add:
    enable: true
    title_left: "Gavên Zêdekirina Şîroveyan li CSV di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve cûrbecûr şîrovekirinê li pelên CSV zêde bikin.
...
steps_Remove:
    enable: true
    title_left: "Gavên Rakirina Şîroveyan ji CSV li Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku hûrguliyên annotasyonê ji pelên CSV di nav her serîlêdana Java-yê de bi cîbicîkirina çend gavên hêsan rakin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
steps_Edit:
    enable: true
    title_left: "Gavên Guherandinên Şîrove ji CSV di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku bi pêkanîna çend gavên hêsan ve taybetmendiyên cûrbecûr şîrovekirinê ji pelên CSV di nav her serlêdanek Java-yê de nûve bikin.
...
steps_Extract:
    enable: true
    title_left: "Gavên Derxistina Şîroveyan ji CSV di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsan dike ku bi pêkanîna çend gavên hêsan belgeyan binivîsin û agahdariya şîrovekirinê ji pelên CSV derxînin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
demos:
    ...
    content: |
        Bi seredana malpera [GroupDocs.Annotation Demos Zindî](https://products.groupdocs.app/annotation/family) niha li pelê CSV şîroveyan zêde bikin, jêbikin, biguherînin û derxin. Demoya zindî xwedî feydeyên jêrîn e
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-csv"
          title: "Derbarê CSV Forma Pelê"
          content: |
            Pelên bi dirêjkirina CSV (Nirxên Veqetandî yên Bi Comma) pelên nivîsê yên sade temsîl dikin ku tomarên daneyan bi nirxên ji hev veqetandî hene. Her rêzek di pelek CSV de tomarek nû ye ji komek tomarên ku di pelê de hene. Pelên weha têne çêkirin dema ku veguheztina daneyê ji yek pergalek hilanînê berbi yekî din tê armanc kirin. Ji ber ku hemî serîlêdan dikarin tomarên ku bi kommayê veqetandî nas bikin, anîna van pelên daneyê ji databasê re pir bi hêsanî tê kirin. Hema hema hemî serîlêdanên pelgeyê yên wekî Microsoft Excel an OpenOffice Calc dikarin CSV bêyî hewildanek zêde bikin. Daneyên ku ji pelên weha têne derxistin di hucreyên pelgeyek belavokê de ji bo nûnertiya bikarhênerê têne rêz kirin.
