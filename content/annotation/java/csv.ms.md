...
############################# Head ############################
head_title: "Java CSV Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada CSV, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi CSV daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen CSV tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada CSV dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail CSV dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada CSV dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail CSV dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada CSV dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail CSV dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail CSV sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-csv"
          title: "Mengenai Format Fail CSV."
          content: |
            Fail dengan sambungan CSV (Comma Separated Values) mewakili fail teks biasa yang mengandungi rekod data dengan nilai dipisahkan koma. Setiap baris dalam fail CSV ialah rekod baharu daripada set rekod yang terkandung dalam fail. Fail sedemikian dijana apabila pemindahan data bertujuan dari satu sistem storan ke sistem storan yang lain. Memandangkan semua aplikasi boleh mengecam rekod yang dipisahkan dengan koma, import fail data tersebut ke pangkalan data dilakukan dengan sangat mudah. Hampir semua aplikasi hamparan seperti Microsoft Excel atau OpenOffice Calc boleh mengimport CSV tanpa banyak usaha. Data yang diimport daripada fail sedemikian disusun dalam sel hamparan untuk perwakilan kepada pengguna.
