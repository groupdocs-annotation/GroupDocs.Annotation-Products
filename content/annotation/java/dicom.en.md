...
############################# Head ############################
head_title: "Remove Annotations from DICOM in Java Application"
head_description: "Java API to create and Remove popular annotation types from DICOM, images, drawings and document file formats."
...
demos:
    ...
    content: |
        View and remove annotations from DICOM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
