...
############################# Head ############################
head_title: "Java DICOM Annotation API Annotate u C#"
head_description: "Java API za stvaranje i označavanje popularnih vrsta komentara iz DICOM, slika, crteža i formata datoteka dokumenata."

############################# Header ############################
title: "Označite DICOM iz Jave"
description: ""
...
about:
    ...
    content: |
        ...
        Ova biblioteka vam omogućuje rad ne samo s dokumentom DICOM već i s mnogim drugim vrstama dokumenata kao što su Word, Excel, PowerPoint, Outlook e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraci za uklanjanje komentara iz DICOM u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima uklanjanje detalja komentara iz datoteka DICOM unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraci za uređivanje komentara iz DICOM u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima ažuriranje različitih svojstava komentara iz DICOM datoteka unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
...
steps_Extract:
    enable: true
    title_left: "Koraci za izdvajanje komentara iz DICOM u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java programerima olakšava označavanje dokumenata i izdvajanje informacija o komentarima iz datoteka DICOM unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
demos:
    ...
    content: |
        Dodajte, uklonite, uredite i ekstrahirajte komentare u datoteku DICOM odmah tako da posjetite [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) web mjesto. Demo uživo ima sljedeće prednosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          title: "O formatu datoteke DICOM"
          content: |
            DICOM je akronim za Digital Imaging and Communications in Medicine i odnosi se na područje medicinske informatike. DICOM je kombinacija definicije formata datoteke i mrežnog komunikacijskog protokola. DICOM koristi ekstenziju .DCM. .DCM postoji u dva različita formata, tj. format 1.x i format 2.x. DCM Format 1.x nadalje je dostupan u dvije verzije, normalnoj i proširenoj. DICOM se koristi za integraciju medicinskih uređaja za slikanje kao što su pisači, poslužitelji, skeneri itd. različitih dobavljača, a također sadrži identifikacijske podatke svakog pacijenta radi jedinstvenosti. DICOM datoteke mogu se dijeliti između dvije strane ako mogu primati slikovne podatke u DICOM formatu. Komunikacijski dio DICOM-a je protokol aplikacijskog sloja i koristi TCP/IP za komunikaciju između entiteta. HTTP i HTTPS protokoli koriste se za web usluge DICOM. Verzije koje podržavaju web usluge su 1.0, 1.1, 2 ili novije.
