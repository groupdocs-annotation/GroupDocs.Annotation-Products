...
############################# Head ############################
head_title: "Java DICOM API di annotazione Annota in C#"
head_description: "API Java per creare e annotare tipi di annotazioni popolari da DICOM, immagini, disegni e formati di file di documenti."

############################# Header ############################
title: "Annota DICOM da Java"
description: ""
...
about:
    ...
    content: |
        ...
        Questa libreria ti consente di lavorare non solo con il documento DICOM ma anche con molti altri tipi di documenti come Word, Excel, PowerPoint, e-mail di Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad e molti altri.
...
steps_Remove:
    enable: true
    title_left: "Passaggi per rimuovere le annotazioni da DICOM in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende più facile per gli sviluppatori Java rimuovere i dettagli delle annotazioni dai file DICOM all'interno di qualsiasi applicazione basata su Java implementando alcuni semplici passaggi.
        *   Crea oggetti Reply con commento e data.
...
steps_Edit:
    enable: true
    title_left: "Passaggi per modificare le annotazioni da DICOM in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende più facile per gli sviluppatori Java aggiornare varie proprietà di annotazione da file DICOM all'interno di qualsiasi applicazione basata su Java implementando alcuni semplici passaggi.
...
steps_Extract:
    enable: true
    title_left: "Passaggi per estrarre annotazioni da DICOM in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende facile per gli sviluppatori Java annotare documenti ed estrarre informazioni di annotazione da file DICOM all'interno di qualsiasi applicazione basata su Java implementando pochi semplici passaggi.
        *   Crea oggetti Reply con commento e data.
...
demos:
    ...
    content: |
        Aggiungi, rimuovi, modifica ed estrai subito le annotazioni dal file DICOM visitando il sito web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demo dal vivo ha i seguenti vantaggi
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          title: "Informazioni sul formato file DICOM"
          content: |
            DICOM è l'acronimo di Digital Imaging and Communications in Medicine e appartiene al campo dell'informatica medica. DICOM è la combinazione della definizione del formato file e di un protocollo di comunicazione di rete. DICOM utilizza l'estensione .DCM. .DCM esiste in due diversi formati, ovvero il formato 1.x e il formato 2.x. Il formato DCM 1.x è inoltre disponibile in due versioni normale ed estesa. DICOM viene utilizzato per l'integrazione di dispositivi di imaging medico come stampanti, server, scanner ecc. di vari fornitori e contiene anche i dati di identificazione di ciascun paziente per l'unicità. I file DICOM possono essere condivisi tra due parti se sono in grado di ricevere dati immagine in formato DICOM. La parte di comunicazione di DICOM è il protocollo a livello di applicazione e utilizza TCP/IP per comunicare tra le entità. I protocolli HTTP e HTTPS vengono utilizzati per i servizi Web di DICOM. Le versioni supportate dai servizi Web sono 1.0, 1.1, 2 o successive.
