...
############################# Head ############################
head_title: "Java DICOM Annotation API Annotate v C#"
head_description: "Java API za ustvarjanje in označevanje priljubljenih vrst opomb iz DICOM, slik, risb in oblik datotek dokumentov."
...
about:
    ...
    content: |
        ...
        Ta knjižnica vam omogoča delo ne samo z dokumentom DICOM, ampak tudi z mnogimi drugimi vrstami dokumentov, kot so Word, Excel, PowerPoint, Outlookova e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad in mnogi drugi.
        ...
        Primer (glejte spodaj) prikazuje delo z dokumentom DICOM, v tem primeru si lahko ogledate glavne korake dela z GroupDocs. Opomba: nastavite licenco, odprite dokument, s katerim želite delati, ustvarite opombo, dodajanje podatkovnih objektov za nastavitev lastnosti opombe glede na vaše zahteve in shranjevanje rezultata na potrebno mesto. Prav tako si lahko podrobneje ogledate podprte funkcije na naši [strani github](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java) ali v [dokumentaciji našega izdelka](https://docs.groupdocs.com/annotation/java/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Koraki za dodajanje opomb k DICOM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša dodajanje različnih vrst opomb datotekam DICOM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
...
steps_Remove:
    enable: true
    title_left: "Koraki za odstranitev opomb iz DICOM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša odstranjevanje podrobnosti opombe iz datotek DICOM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
        *   Ustvarite objekte odgovora s komentarjem in datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraki za urejanje opomb iz DICOM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša posodabljanje različnih lastnosti opomb iz datotek DICOM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
...
steps_Extract:
    enable: true
    title_left: "Koraki za ekstrahiranje opomb iz DICOM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša dodajanje opomb dokumentom in pridobivanje informacij o opombah iz datotek DICOM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
        *   Ustvarite objekte odgovora s komentarjem in datumom.
...
demos:
    ...
    content: |
        Takoj dodajte, odstranite, uredite in izvlecite opombe v datoteko DICOM tako, da obiščete spletno mesto [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Predstavitev v živo ima naslednje prednosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          ...
          content: |
            DICOM je akronim za Digital Imaging and Communications in Medicine in se nanaša na področje medicinske informatike. DICOM je kombinacija definicije formata datoteke in omrežnega komunikacijskega protokola. DICOM uporablja razširitev .DCM. .DCM obstaja v dveh različnih formatih, tj. formatu 1.x in formatu 2.x. Format DCM 1.x je na voljo tudi v dveh različicah, običajni in razširjeni. DICOM se uporablja za integracijo medicinskih slikovnih naprav, kot so tiskalniki, strežniki, skenerji itd. različnih proizvajalcev, in vsebuje tudi identifikacijske podatke vsakega bolnika za edinstvenost. Datoteke DICOM lahko delita dve strani, če lahko sprejemata slikovne podatke v formatu DICOM. Komunikacijski del DICOM je protokol aplikacijskega sloja in uporablja TCP/IP za komunikacijo med entitetami. Za spletne storitve DICOM se uporabljata protokola HTTP in HTTPS. Različice, ki jih podpirajo spletne storitve, so 1.0, 1.1, 2 ali novejše.
