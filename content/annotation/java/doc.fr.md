...
############################# Head ############################
head_title: "Java DOC Annotation API Annoter en C#"
head_description: "Java API pour créer et Annoter types d'annotations populaires depuis DOC, images, dessins et formats de fichiers de documents."
...
demos:
    ...
    content: |
        Ajoutez, supprimez, modifiez et extrayez des annotations au fichier DOC dès maintenant en visitant le site Web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
