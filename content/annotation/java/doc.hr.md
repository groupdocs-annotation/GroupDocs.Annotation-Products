...
############################# Head ############################
head_title: "Java DOC Annotation API Annotate u C#"
head_description: "Java API za stvaranje i označavanje popularnih vrsta komentara iz DOC, slika, crteža i formata datoteka dokumenata."

############################# Header ############################
title: "Označite DOC iz Jave"
description: ""
...
about:
    ...
    content: |
        ...
        Ova biblioteka vam omogućuje rad ne samo s dokumentom DOC već i s mnogim drugim vrstama dokumenata kao što su Word, Excel, PowerPoint, Outlook e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraci za uklanjanje komentara iz DOC u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima uklanjanje detalja komentara iz datoteka DOC unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraci za uređivanje komentara iz DOC u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima ažuriranje različitih svojstava komentara iz DOC datoteka unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
...
steps_Extract:
    enable: true
    title_left: "Koraci za izdvajanje komentara iz DOC u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java programerima olakšava označavanje dokumenata i izdvajanje informacija o komentarima iz datoteka DOC unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
demos:
    ...
    content: |
        Dodajte, uklonite, uredite i ekstrahirajte komentare u datoteku DOC odmah tako da posjetite [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) web mjesto. Demo uživo ima sljedeće prednosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-doc"
          title: "O formatu datoteke DOC"
          content: |
            Datoteke s ekstenzijom .doc predstavljaju dokumente generirane Microsoft Wordom ili drugim dokumentima za obradu teksta u binarnom formatu datoteke. Proširenje se u početku koristilo za dokumentaciju običnog teksta na nekoliko različitih operativnih sustava. Može sadržavati nekoliko različitih vrsta podataka kao što su slike, formatirani kao i obični tekst, grafikoni, dijagrami, ugrađeni objekti, poveznice, stranice, formatiranje stranice, postavke ispisa i puno drugih. Format je bio popularan za sve vrste dokumentacije zbog niza mogućnosti koje nudi korisnicima za pisanje priručnika, prijedloga, specifikacija, životopisa, članaka ili sličnih dokumenata. Ažurirana verzija DOC-a je DOCX koja se temelji na Office OpenXML-u čije su specifikacije javno dostupne.
