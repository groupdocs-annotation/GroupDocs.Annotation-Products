...
head_description: "Java API om gewilde annotasietipes van DOT, beelde, tekeninge en dokumentlêerformate te skep en te annoteer."

############################# Header ############################
title: "Annoteer DOT vanaf Java"
description: ""
...
steps_Add:
    enable: true
    title_left: "Stappe om aantekeninge by DOT in Java te voeg"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit maklik vir Java-ontwikkelaars om verskeie aantekeningtipes by DOT-lêers binne enige Java-gebaseerde toepassing by te voeg deur 'n paar maklike stappe te implementeer.
...
steps_Remove:
    enable: true
    title_left: "Stappe om aantekeninge van DOT in Java te verwyder"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit makliker vir Java-ontwikkelaars om aantekeningbesonderhede van DOT-lêers binne enige Java-gebaseerde toepassing te verwyder deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
steps_Edit:
    enable: true
    title_left: "Stappe om aantekeninge van DOT in Java te wysig"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit makliker vir Java-ontwikkelaars om verskeie annotasie-eienskappe vanaf DOT-lêers binne enige Java-gebaseerde toepassing op te dateer deur 'n paar maklike stappe te implementeer.
...
steps_Extract:
    enable: true
    title_left: "Stappe om aantekeninge uit DOT in Java te onttrek"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit maklik vir Java-ontwikkelaars om dokumente te annoteer en annotasie-inligting uit DOT-lêers binne enige Java-gebaseerde toepassing te onttrek deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
