...
############################# Head ############################
head_title: "Java DOT Anodi API Anodi yn C#"
head_description: "Java API i greu ac Anodi mathau o anodiadau poblogaidd o DOT, delweddau, lluniadau a fformatau ffeil dogfen."

############################# Header ############################
title: "Anodwch DOT o Java"
description: ""
...
about:
    ...
    content: |
        ...
        Mae'r llyfrgell hon yn eich galluogi i weithio nid yn unig gyda DOT dogfen ond hefyd gyda llawer o fathau eraill o ddogfennau megis Word, Excel, PowerPoint, e-byst Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad a llawer o rai eraill.
        ...
        Mae'r enghraifft (gweler isod) yn dangos gweithio gyda dogfen DOT, yn yr enghraifft hon gallech weld y prif gamau o sut i weithio gyda GroupDocs.Annotation: Gosod trwydded, agor dogfen rydych am weithio gyda hi, creu a anodi, ychwanegu gwrthrychau data i osod priodweddau anodi yn unol â'ch gofynion ac arbed y canlyniad i'r lle sydd ei angen. Hefyd fe allech chi gael golwg fanylach ar y nodweddion a gefnogir ar ein tudalen [github](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java), neu yn ein cynnyrch [dogfennaeth](https://docs.groupdocs.com/annotation/java/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Camau i Ychwanegu Anodiadau i DOT yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud yn hawdd i ddatblygwyr Java ychwanegu gwahanol fathau o anodiadau at ffeiliau DOT o fewn unrhyw raglen sy'n seiliedig ar Java trwy roi ychydig o gamau hawdd ar waith.
...
steps_Remove:
    enable: true
    title_left: "Camau i Dynnu Anodiadau o DOT yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud yn haws i ddatblygwyr Java dynnu manylion anodiad o DOT o ffeiliau o fewn unrhyw raglen sy'n seiliedig ar Java drwy roi ychydig o gamau hawdd ar waith.
        *   Creu gwrthrychau Ateb gyda sylw a dyddiad.
...
steps_Edit:
    enable: true
    title_left: "Camau i Olygu Anodiadau o DOT yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud yn haws i ddatblygwyr Java ddiweddaru priodweddau anodi amrywiol o DOT o ffeiliau o fewn unrhyw raglen sy'n seiliedig ar Java trwy roi ychydig o gamau hawdd ar waith.
...
steps_Extract:
    enable: true
    title_left: "Camau i Echdynnu Anodiadau o DOT yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud hi'n hawdd i ddatblygwyr Java anodi dogfennau a thynnu gwybodaeth anodiad o DOT ffeil o fewn unrhyw raglen sy'n seiliedig ar Java trwy roi ychydig o gamau hawdd ar waith.
        *   Creu gwrthrychau Ateb gyda sylw a dyddiad.
...
demos:
    ...
    content: |
        Ychwanegu, dileu, golygu a thynnu anodiadau i ffeil DOT ar hyn o bryd drwy ymweld â gwefan [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Mae gan y demo byw y buddion canlynol
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          title: "Ynglŷn â DOT Fformat Ffeil"
          content: |
            Mae ffeiliau ag estyniad .DOT yn ffeiliau templed a grëwyd gan Microsoft Word i gael gosodiadau wedi'u fformatio ymlaen llaw ar gyfer cynhyrchu ffeiliau DOC neu DOCX pellach. Crëir ffeil templed er mwyn cael gosodiadau defnyddiwr penodol y dylid eu cymhwyso i ffeiliau dilynol a grëwyd o'r rhain. Mae'r gosodiadau hyn yn cynnwys ymylon tudalennau, ffiniau, penawdau, troedynnau, a gosodiadau tudalennau eraill. Defnyddir templedi o'r fath mewn dogfennau swyddogol fel penawdau llythyrau cwmni a ffurflenni safonol. Mae fformat ffeil DOT yn benodol i Microsoft Word 2003 ac yn gynharach, ond fe'i cefnogir gan fersiynau uwch hefyd. Mae Microsoft Word yn ddiofyn yn agor pob dogfen newydd yn seiliedig ar ffeil normal.dot. Os cânt eu haddasu, bydd yr holl ffeiliau newydd a grëir yn arwain at yr un gosodiadau ag o'r ffeil templed. Yn Microsoft Word 2007, mae fformat ffeil DOT wedi'i ddisodli gan fformat ffeil DOTX Office OpenXML.
