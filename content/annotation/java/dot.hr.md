...
############################# Head ############################
head_title: "Java DOT Annotation API Annotate u C#"
head_description: "Java API za stvaranje i označavanje popularnih vrsta komentara iz DOT, slika, crteža i formata datoteka dokumenata."

############################# Header ############################
title: "Označite DOT iz Jave"
description: ""
...
about:
    ...
    content: |
        ...
        Ova biblioteka vam omogućuje rad ne samo s dokumentom DOT već i s mnogim drugim vrstama dokumenata kao što su Word, Excel, PowerPoint, Outlook e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraci za uklanjanje komentara iz DOT u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima uklanjanje detalja komentara iz datoteka DOT unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraci za uređivanje komentara iz DOT u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima ažuriranje različitih svojstava komentara iz DOT datoteka unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
...
steps_Extract:
    enable: true
    title_left: "Koraci za izdvajanje komentara iz DOT u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java programerima olakšava označavanje dokumenata i izdvajanje informacija o komentarima iz datoteka DOT unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
demos:
    ...
    content: |
        Dodajte, uklonite, uredite i ekstrahirajte komentare u datoteku DOT odmah tako da posjetite [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) web mjesto. Demo uživo ima sljedeće prednosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          title: "O formatu datoteke DOT"
          content: |
            Datoteke s ekstenzijom .DOT datoteke su predložaka koje je izradio Microsoft Word kako bi imale unaprijed formatirane postavke za generiranje daljnjih DOC ili DOCX datoteka. Datoteka predloška se stvara kako bi se imale specifične korisničke postavke koje bi se trebale primijeniti na sljedeće datoteke stvorene iz njih. Ove postavke uključuju margine stranice, obrube, zaglavlja, podnožja i druge postavke stranice. Takvi se predlošci koriste u službenim dokumentima kao što su zaglavlja poduzeća i standardizirani obrasci. DOT format datoteke specifičan je za Microsoft Word 2003 i ranije, ali ga podržavaju i novije verzije. Microsoft Word prema zadanim postavkama otvara svaki novi dokument na temelju datoteke normal.dot. Ako se izmijene, sve nove stvorene datoteke rezultirat će istim postavkama kao iz datoteke predloška. U programu Microsoft Word 2007, DOT format datoteke zamijenjen je DOTX formatom datoteke koji se temelji na Office OpenXML-u.
