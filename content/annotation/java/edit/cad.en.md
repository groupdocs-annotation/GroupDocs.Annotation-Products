...
############################# Head ############################
head_title: "Edit Annotations in CAD in Java Application"
head_description: "Java API to create and Edit popular annotation types in CAD, images, drawings and document file formats."

############################# Header ############################
title: "Edit CAD Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in CAD in Java"
    content_left: |
