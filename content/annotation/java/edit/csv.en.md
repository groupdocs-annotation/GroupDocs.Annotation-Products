...
############################# Head ############################
head_title: "Edit Annotations in CSV in Java Application"
head_description: "Java API to create and Edit popular annotation types in CSV, images, drawings and document file formats."

############################# Header ############################
title: "Edit CSV Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in CSV in Java"
    content_left: |
