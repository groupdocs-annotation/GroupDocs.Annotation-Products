...
############################# Head ############################
head_title: "Edit Annotations in DCM in Java Application"
head_description: "Java API to create and Edit popular annotation types in DCM, images, drawings and document file formats."

############################# Header ############################
title: "Edit DCM Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in DCM in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from DCM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
