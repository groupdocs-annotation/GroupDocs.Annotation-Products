...
############################# Head ############################
head_title: "Edit DOC File Annotations in Java Applications"
head_description: "Java annotations editor API to update popular annotation types from DOC, images, drawings and document file formats."

############################# Header ############################
title: "Edit Annotations in DOC File in Java"
description: "Java annotation editor for images, Microsoft Office and other document file formats. Annotate DOC files using 13 different annotation types like; area, text, notes, watermark etc."
...
steps:
    ...
    code: |
        ```java
        String outputPath = "UpdateAnnotation.doc";
        Annotator annotator = new Annotator("input.doc");
