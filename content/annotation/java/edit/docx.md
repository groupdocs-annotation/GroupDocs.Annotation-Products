...
############################# Head ############################
head_title: "Edit DOCX File Annotations in Java Applications"
head_description: "Java annotations editor API to update popular annotation types from DOCX, images, drawings and document file formats."

############################# Header ############################
title: "Edit Annotations in DOCX File in Java"
description: "Java annotation editor for images, Microsoft Office and other document file formats. Annotate DOCX files using 13 different annotation types like; area, text, notes, watermark etc."
...
steps:
    ...
    code: |
        ```java
        String outputPath = "UpdateAnnotation.docx";
...
demos:
    ...
    content: |
        Read and edit annotations from DOCX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
