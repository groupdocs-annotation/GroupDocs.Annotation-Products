...
############################# Head ############################
head_title: "Edit Annotations in DOTM in Java Application"
head_description: "Java API to create and Edit popular annotation types in DOTM, images, drawings and document file formats."

############################# Header ############################
title: "Edit DOTM Files in Java"
description: "Add annotations in DOTM, Microsoft Office documents, images, HTML, drawings and other file formats in any type of Java application."
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in DOTM in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Java developers to update various annotation properties from DOTM files within any Java-based application by implementing a few easy steps.
...
demos:
    ...
    content: |
        Read and edit annotations from DOTM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
