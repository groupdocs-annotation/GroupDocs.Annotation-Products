...
############################# Head ############################
head_title: "Edit DXF File Annotations in Java Applications"
head_description: "Java annotations editor API to update popular annotation types from DXF, images, drawings and document file formats."

############################# Header ############################
title: "Edit Annotations in DXF File in Java"
description: "Java annotation editor for images, Microsoft Office and other document file formats. Annotate DXF files using 13 different annotation types like; area, text, notes, watermark etc."
...
steps:
    ...
    code: |
        ```java
        String outputPath = "UpdateAnnotation.dxf";
        Annotator annotator = new Annotator("input.dxf");
...
demos:
    ...
    content: |
        Read and edit annotations from DXF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
