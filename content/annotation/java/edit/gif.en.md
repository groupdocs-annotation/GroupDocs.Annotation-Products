...
############################# Head ############################
head_title: "Edit Annotations in GIF in Java Application"
head_description: "Java API to create and Edit popular annotation types in GIF, images, drawings and document file formats."

############################# Header ############################
title: "Edit GIF Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in GIF in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from GIF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
