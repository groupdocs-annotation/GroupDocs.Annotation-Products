...
############################# Head ############################
head_title: "Edit Annotations in HTML in Java Application"
head_description: "Java API to create and Edit popular annotation types in HTML, images, drawings and document file formats."

############################# Header ############################
title: "Edit HTML Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in HTML in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from HTML file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
