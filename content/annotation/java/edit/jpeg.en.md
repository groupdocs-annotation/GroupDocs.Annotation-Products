...
############################# Head ############################
head_title: "Edit Annotations in JPEG in Java Application"
head_description: "Java API to create and Edit popular annotation types in JPEG, images, drawings and document file formats."

############################# Header ############################
title: "Edit JPEG Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in JPEG in Java"
    content_left: |
