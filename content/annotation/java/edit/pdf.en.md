...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/edit/pdf"/>

############################# Head ############################
head_title: "Edit Annotations in PDF in Java Application"
head_description: "Java API to create and Edit popular annotation types in PDF, images, drawings and document file formats."

############################# Header ############################
title: "Edit PDF Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in PDF in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from PDF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
