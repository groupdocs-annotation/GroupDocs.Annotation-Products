...
############################# Head ############################
head_title: "Edit PNG File Annotations in Java Applications"
head_description: "Java annotations editor API to update popular annotation types from PNG, images, drawings and document file formats."

############################# Header ############################
title: "Edit Annotations in PNG File in Java"
description: "Java annotation editor for images, Microsoft Office and other document file formats. Annotate PNG files using 13 different annotation types like; area, text, notes, watermark etc."
...
demos:
    ...
    content: |
        Read and edit annotations from PNG file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
