...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/edit/pps"/>

############################# Head ############################
head_title: "Edit Annotations in PPS in Java Application"
head_description: "Java API to create and Edit popular annotation types in PPS, images, drawings and document file formats."

############################# Header ############################
title: "Edit PPS Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in PPS in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from PPS file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
