...
############################# Head ############################
head_title: "Edit Annotations in VSD in Java Application"
head_description: "Java API to create and Edit popular annotation types in VSD, images, drawings and document file formats."

############################# Header ############################
title: "Edit VSD Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in VSD in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from VSD file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
