...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/edit/vsdx"/>

############################# Head ############################
head_title: "Edit Annotations in VSDX in Java Application"
head_description: "Java API to create and Edit popular annotation types in VSDX, images, drawings and document file formats."

############################# Header ############################
title: "Edit VSDX Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in VSDX in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from VSDX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
