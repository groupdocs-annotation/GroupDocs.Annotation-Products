...
############################# Head ############################
head_title: "Edit Annotations in VST in Java Application"
head_description: "Java API to create and Edit popular annotation types in VST, images, drawings and document file formats."

############################# Header ############################
title: "Edit VST Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in VST in Java"
    content_left: |
