...
############################# Head ############################
head_title: "Edit Annotations in VSX in Java Application"
head_description: "Java API to create and Edit popular annotation types in VSX, images, drawings and document file formats."

############################# Header ############################
title: "Edit VSX Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in VSX in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from VSX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
