...
############################# Head ############################
head_title: "Edit Annotations in XLSM in Java Application"
head_description: "Java API to create and Edit popular annotation types in XLSM, images, drawings and document file formats."

############################# Header ############################
title: "Edit XLSM Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in XLSM in Java"
    content_left: |
