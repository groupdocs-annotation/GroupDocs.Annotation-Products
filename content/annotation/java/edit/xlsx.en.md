...
############################# Head ############################
head_title: "Edit Annotations in XLSX in Java Application"
head_description: "Java API to create and Edit popular annotation types in XLSX, images, drawings and document file formats."

############################# Header ############################
title: "Edit XLSX Files in Java"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in XLSX in Java"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from XLSX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
