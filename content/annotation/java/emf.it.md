...
############################# Head ############################
head_title: "Java EMF API di annotazione Annotate in C#"
head_description: "Java API per creare e Annotate tipi di annotazioni popolari da EMF, immagini, disegni e formati di file di documenti."
...
steps_Add:
    enable: true
    title_left: "Passaggi per aggiungere annotazioni da EMF in Java"
    content_left: |
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende più facile per gli sviluppatori Java aggiornare varie proprietà di annotazione da file EMF all'interno di qualsiasi applicazione basata su Java implementando pochi semplici passaggi.
...
steps_Extract:
    enable: true
    title_left: "Passaggi per estrarre le annotazioni da EMF in Java"
    content_left: |
