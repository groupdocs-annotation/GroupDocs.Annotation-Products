...
head_description: "Java API to create and Annotate popular annotation types from EML, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to EML in Java"
    content_left: |
