...
############################# Head ############################
head_title: "Extract Annotation from DXF in Java - Annotation Extraction API"
head_description: "Java annotation extraction API to extract popular annotation types from DXF, images, drawings and document file formats."
...
steps:
    ...
    code: |
        ```java
        // for using this example input file ("annotated.dxf") must be with annotations
         
        LoadOptions loadOptions = new LoadOptions();
        loadOptions.setImportAnnotations(true);
        
        final Annotator annotator = new Annotator("annotated.dxf", loadOptions);
...
demos:
    ...
    content: |
        Extract annotation information from DXF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
