...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/extract/odt"/>

############################# Head ############################
head_title: "Extract Annotations from ODT in Java Application"
head_description: "Java API to create and Extract popular annotation types from ODT, images, drawings and document file formats."

############################# Header ############################
title: "Extract ODT Files from Java"
description: ""
...
demos:
    ...
    content: |
        Extract annotation information from ODT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
