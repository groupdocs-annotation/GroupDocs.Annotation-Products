...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/extract/xls"/>

############################# Head ############################
head_title: "Extract Annotations from XLS in Java Application"
head_description: "Java API to create and Extract popular annotation types from XLS, images, drawings and document file formats."

############################# Header ############################
title: "Extract XLS Files from Java"
description: ""
...
demos:
    ...
    content: |
        Extract annotation information from XLS file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
