...
############################# Head ############################
head_title: "Java GIF Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada GIF, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi GIF daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen GIF tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada GIF dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail GIF dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada GIF dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail GIF dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada GIF dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail GIF dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-gif"
          title: "Mengenai Format Fail GIF."
          content: |
            GIF atau Format Pertukaran Grafik ialah sejenis imej yang sangat mampat. Dimiliki oleh Unisys, GIF menggunakan algoritma pemampatan LZW yang tidak merendahkan kualiti imej. Untuk setiap imej GIF biasanya membenarkan sehingga 8 bit setiap piksel dan sehingga 256 warna dibenarkan merentasi imej. Berbeza dengan imej JPEG, yang boleh memaparkan sehingga 16 juta warna dan cukup menyentuh batas mata manusia. Ketika internet muncul, GIF kekal sebagai pilihan terbaik kerana ia memerlukan lebar jalur yang rendah dan serasi untuk grafik yang menggunakan kawasan warna pepejal. GIF animasi menggabungkan banyak imej atau bingkai ke dalam satu fail dan memaparkannya dalam urutan untuk menghasilkan klip animasi atau video pendek. Had warna adalah sehingga 256 untuk setiap bingkai dan berkemungkinan paling kurang sesuai untuk menghasilkan semula imej dan gambar lain dengan kecerunan warna.
