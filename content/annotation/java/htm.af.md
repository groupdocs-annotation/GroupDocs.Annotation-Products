...
head_description: "Java API om gewilde annotasietipes van HTM, beelde, tekeninge en dokumentlêerformate te skep en te annoteer."

############################# Header ############################
title: "Annoteer HTM vanaf Java"
description: ""
...
about:
    ...
    content: |
        ...
        Hierdie biblioteek laat jou toe om nie net met HTM dokument te werk nie, maar ook met baie ander tipe dokumente soos Word, Excel, PowerPoint, Outlook-e-posse, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad en vele ander.
...
steps_Remove:
    enable: true
    title_left: "Stappe om aantekeninge van HTM in Java te verwyder"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit makliker vir Java-ontwikkelaars om aantekeningbesonderhede van HTM-lêers binne enige Java-gebaseerde toepassing te verwyder deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
steps_Edit:
    enable: true
    title_left: "Stappe om aantekeninge van HTM in Java te wysig"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit makliker vir Java-ontwikkelaars om verskeie annotasie-eienskappe vanaf HTM-lêers binne enige Java-gebaseerde toepassing op te dateer deur 'n paar maklike stappe te implementeer.
...
steps_Extract:
    enable: true
    title_left: "Stappe om aantekeninge uit HTM in Java te onttrek"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit maklik vir Java-ontwikkelaars om dokumente te annoteer en annotasie-inligting uit HTM-lêers binne enige Java-gebaseerde toepassing te onttrek deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-htm"
          title: "Oor HTM Lêerformaat"
          content: |
            Lêers met HTM-uitbreiding verteenwoordig Hypertext Markup Language vir die skep van webblaaie vir vertoon in webblaaiers soos Google Chrome, Internet Explorer, Firefox en 'n aantal ander. Dit definieer die opmaak vir die skep van statiese bladsye wat op World Wide Web (WWW) gepubliseer moet word vir toegang deur ander. Hierdie opmaak vertel die blaaiers hoe om 'n webblad se inhoud te vertoon. Sulke bladsye kan gewone teks, beelde, hiperskakels na ander bladsye, video's en ander media-inligting bevat. Wanneer 'n webblad gepubliseer word, kan u na die opmaakkode daaragter kyk deur die bladsybron daarvan te bekyk. Moderne blaaiers laat toe om elke afdeling van 'n webblad te inspekteer waar elke onderafdeling of opmaakelement in die HTM-bron uitgebrei is.
