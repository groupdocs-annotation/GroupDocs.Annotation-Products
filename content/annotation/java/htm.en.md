...
############################# Head ############################
head_title: "Remove Annotations from HTM in Java Application"
head_description: "Java API to create and Remove popular annotation types from HTM, images, drawings and document file formats."
...
demos:
    ...
    content: |
        View and remove annotations from HTM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
