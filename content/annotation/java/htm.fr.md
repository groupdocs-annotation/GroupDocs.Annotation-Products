...
############################# Head ############################
head_title: "API d'annotation Java HTM Annoter en C#"
head_description: "API Java pour créer et annoter des types d'annotations populaires à partir de HTM, des images, des dessins et des formats de fichiers de documents."

############################# Header ############################
title: "Annoter HTM à partir de Java"
description: ""
...
steps_Add:
    enable: true
    title_left: "Étapes pour ajouter des annotations à HTM en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) permet aux développeurs Java d'ajouter facilement divers types d'annotations aux fichiers HTM dans n'importe quelle application Java en implémentant quelques étapes simples.
...
steps_Remove:
    enable: true
    title_left: "Étapes pour supprimer les annotations de HTM en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) permet aux développeurs Java de supprimer plus facilement les détails d'annotation des fichiers HTM dans n'importe quelle application Java en implémentant quelques étapes simples.
        *   Créez des objets de réponse avec un commentaire et une date.
...
steps_Edit:
    enable: true
    title_left: "Étapes pour modifier les annotations de HTM en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) permet aux développeurs Java de mettre à jour plus facilement diverses propriétés d'annotation à partir de fichiers HTM dans n'importe quelle application Java en implémentant quelques étapes simples.
...
steps_Extract:
    enable: true
    title_left: "Étapes pour extraire les annotations de HTM en Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) permet aux développeurs Java d'annoter facilement des documents et d'extraire des informations d'annotation à partir de fichiers HTM dans n'importe quelle application Java en implémentant quelques étapes simples.
        *   Créez des objets de réponse avec un commentaire et une date.
