...
############################# Head ############################
head_title: "Java HTM Annotation API Annoter en C#"
head_description: "Java API pour créer et Annoter types d'annotations populaires depuis HTM, images, dessins et formats de fichiers de documents."
...
demos:
    ...
    content: |
        Ajoutez, supprimez, modifiez et extrayez des annotations au fichier HTM dès maintenant en visitant le site Web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
