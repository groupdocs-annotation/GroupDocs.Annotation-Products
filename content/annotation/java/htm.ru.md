...
############################# Head ############################
head_title: "Удаление Аннотаций с HTM в Java приложении"
...
demos:
    ...
    content: |
        Просмотрите и удалите аннотации из файла HTM прямо сейчас, посетив [живые демонстрации](https://products.groupdocs.app/annotation/family).
