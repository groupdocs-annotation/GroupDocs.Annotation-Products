...
############################# Head ############################
head_title: "Java HTM Anotácia API Anotácia v C#"
head_description: "Java API na vytváranie a komentovanie populárnych typov anotácií z HTM, obrázkov, nákresov a formátov súborov dokumentov."

############################# Header ############################
title: "Anotujte súbor HTM z jazyka Java"
description: ""
...
about:
    ...
    content: |
        ...
        Táto knižnica vám umožňuje pracovať nielen s dokumentom HTM, ale aj s mnohými ďalšími typmi dokumentov, ako sú Word, Excel, PowerPoint, Outlook e-maily, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad a mnoho ďalších.
...
steps_Remove:
    enable: true
    title_left: "Kroky na odstránenie anotácií zo súboru HTM v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom jazyka Java odstraňovanie podrobností anotácií zo súborov HTM v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
        *   Vytvorte objekty odpovede s komentárom a dátumom.
...
steps_Edit:
    enable: true
    title_left: "Kroky na úpravu anotácií zo súboru HTM v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom Java aktualizovať rôzne vlastnosti anotácií zo súborov HTM v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
...
steps_Extract:
    enable: true
    title_left: "Kroky na extrahovanie anotácií zo súboru HTM v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom jazyka Java anotáciu dokumentov a extrahovanie informácií o anotáciách zo súborov HTM v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
        *   Vytvorte objekty odpovede s komentárom a dátumom.
...
demos:
    ...
    content: |
        Pridávajte, odstraňujte, upravujte a extrahujte anotácie do súboru HTM práve teraz na webovej lokalite [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Živá ukážka má nasledujúce výhody
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-htm"
          title: "Informácie o formáte súboru HTM"
          content: |
            Súbory s príponou HTM predstavujú jazyk Hypertext Markup Language na vytváranie webových stránok na zobrazenie vo webových prehliadačoch, ako sú Google Chrome, Internet Explorer, Firefox a množstvo ďalších. Definuje značky pre vytváranie statických stránok, ktoré sa majú publikovať na World Wide Web (WWW), aby k nim mali prístup ostatní. Tieto označenia hovoria prehliadačom, ako majú zobraziť obsah webovej stránky. Takéto stránky môžu obsahovať obyčajný text, obrázky, hypertextové odkazy na iné stránky, videá a iné mediálne informácie. Keď je webová stránka publikovaná, môžete sa pozrieť na značkovací kód za ňou zobrazením zdroja stránky. Moderné prehliadače umožňujú kontrolovať každú sekciu webovej stránky, kde je vypracovaná každá podskupina alebo značkovací prvok v zdroji HTM.
