...
head_description: "Java API om gewilde annotasietipes van HTML, beelde, tekeninge en dokumentlêerformate te skep en te annoteer."

############################# Header ############################
title: "Annoteer HTML vanaf Java"
description: ""
...
about:
    ...
    content: |
        ...
        Hierdie biblioteek laat jou toe om nie net met HTML dokument te werk nie, maar ook met baie ander tipe dokumente soos Word, Excel, PowerPoint, Outlook-e-posse, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad en vele ander.
...
steps_Remove:
    enable: true
    title_left: "Stappe om aantekeninge van HTML in Java te verwyder"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit makliker vir Java-ontwikkelaars om aantekeningbesonderhede van HTML-lêers binne enige Java-gebaseerde toepassing te verwyder deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
steps_Edit:
    enable: true
    title_left: "Stappe om aantekeninge van HTML in Java te wysig"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit makliker vir Java-ontwikkelaars om verskeie annotasie-eienskappe vanaf HTML-lêers binne enige Java-gebaseerde toepassing op te dateer deur 'n paar maklike stappe te implementeer.
...
steps_Extract:
    enable: true
    title_left: "Stappe om aantekeninge uit HTML in Java te onttrek"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) maak dit maklik vir Java-ontwikkelaars om dokumente te annoteer en annotasie-inligting uit HTML-lêers binne enige Java-gebaseerde toepassing te onttrek deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
demos:
    ...
    content: |
        Voeg, verwyder, redigeer en onttrek aantekeninge by HTML-lêer op die oomblik deur [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) webwerf te besoek. Die lewendige demo het die volgende voordele
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Oor HTML Lêerformaat"
          content: |
            HTML (Hyper Text Markup Language) is die uitbreiding vir webblaaie wat geskep is om in blaaiers te vertoon. Bekend as taal van die web, het HTML ontwikkel met die vereistes van nuwe inligtingvereistes wat as deel van webblaaie vertoon moet word. Die nuutste variant staan ​​bekend as HTML 5 wat baie buigsaamheid gee om met die taal te werk. HTML-bladsye word óf van die bediener ontvang, waar dit gehuisves word, óf kan ook vanaf die plaaslike stelsel gelaai word. Elke HTML-bladsy bestaan ​​uit HTML-elemente soos vorms, teks, beelde, animasies, skakels, ens. Hierdie elemente word verteenwoordig deur merkers soos img, a, p en verskeie ander waar elke merker begin en einde het. Dit kan ook toepassings insluit wat geskryf is in skriftale soos JavaScript en Style Sheets (CSS) vir algehele uitlegvoorstelling.
