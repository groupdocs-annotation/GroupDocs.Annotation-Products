...
############################# Head ############################
head_title: "Remove Annotations from HTML in Java Application"
head_description: "Java API to create and Remove popular annotation types from HTML, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations from HTML in Java"
    content_left: |
