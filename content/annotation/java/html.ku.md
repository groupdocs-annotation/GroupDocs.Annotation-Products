...
head_description: "Java API ku ji HTML, wêne, xêzkirin û formatên pelên pelgeyê celebên annotasyonên populer çêbike û annot bike."

############################# Header ############################
title: "Ji Javayê HTML şîrove bikin"
description: ""
...
about:
    ...
    content: |
        ...
        Ev pirtûkxane dihêle hûn ne tenê bi belgeya HTML re lê her weha bi gelek celeb belgeyên din ên wekî Word, Excel, PowerPoint, e-nameyên Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad û gelekên din re bixebitin.
...
steps_Add:
    enable: true
    title_left: "Gavên Zêdekirina Şîroveyan li HTML di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve cûrbecûr şîrovekirinê li pelên HTML zêde bikin.
...
steps_Remove:
    enable: true
    title_left: "Gavên Rakirina Şîroveyan ji HTML li Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku hûrguliyên annotasyonê ji pelên HTML di nav her serîlêdana Java-yê de bi cîbicîkirina çend gavên hêsan rakin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
steps_Edit:
    enable: true
    title_left: "Gavên Guherandinên Şîrove ji HTML di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku bi pêkanîna çend gavên hêsan ve taybetmendiyên cûrbecûr şîrovekirinê ji pelên HTML di nav her serlêdanek Java-yê de nûve bikin.
...
steps_Extract:
    enable: true
    title_left: "Gavên Derxistina Şîroveyan ji HTML di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsan dike ku bi pêkanîna çend gavên hêsan belgeyan binivîsin û agahdariya şîrovekirinê ji pelên HTML derxînin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
demos:
    ...
    content: |
        Bi seredana malpera [GroupDocs.Annotation Demos Zindî](https://products.groupdocs.app/annotation/family) niha li pelê HTML şîroveyan zêde bikin, jêbikin, biguherînin û derxin. Demoya zindî xwedî feydeyên jêrîn e
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Derbarê HTML Forma Pelê"
          content: |
            HTML (Zimanê Nîşandana Hîper Text) dirêjkirina rûpelên malperê ye ku ji bo pêşandana gerokan hatine afirandin. HTML ku wekî zimanê tevneyê tê zanîn, bi hewcedariyên hewcedariyên agahdariya nû ya ku wekî beşek ji rûpelên malperê bêne xuyang kirin pêş ketiye. Guhertoya herî paşîn wekî HTML 5 tête zanîn ku ji bo xebata bi ziman re gelek nermî dide. Rûpelên HTML-ê an ji serverê têne wergirtin, ku ew lê têne mêvan kirin, an jî dikarin ji pergala herêmî jî werin barkirin. Her rûpelek HTML ji hêmanên HTML-ê yên wekî form, nivîs, wêne, anîmasyon, girêdan û hwd pêk tê. Di heman demê de ew dikare serîlêdanên ku bi zimanên nivîsandinê yên wekî JavaScript û Style Sheets (CSS) hatine nivîsandin jî ji bo temsîla sêwirana giştî bicîh bike.
