...
############################# Head ############################
head_title: "Java HTML Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada HTML, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi HTML daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen HTML tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada HTML dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail HTML dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada HTML dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail HTML dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada HTML dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail HTML dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail HTML sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Mengenai Format Fail HTML."
          content: |
            HTML (Hyper Text Markup Language) ialah sambungan untuk halaman web yang dibuat untuk paparan dalam penyemak imbas. Dikenali sebagai bahasa web, HTML telah berkembang dengan keperluan keperluan maklumat baharu untuk dipaparkan sebagai sebahagian daripada halaman web. Varian terkini dikenali sebagai HTML 5 yang memberikan banyak fleksibiliti untuk bekerja dengan bahasa tersebut. Halaman HTML sama ada diterima daripada pelayan, di mana halaman ini dihoskan, atau boleh dimuatkan dari sistem tempatan juga. Setiap halaman HTML terdiri daripada elemen HTML seperti borang, teks, imej, animasi, pautan, dll. Elemen ini diwakili oleh tag seperti img, a, p dan beberapa yang lain di mana setiap teg mempunyai permulaan dan penamat. Ia juga boleh membenamkan aplikasi yang ditulis dalam bahasa skrip seperti JavaScript dan Helaian Gaya (CSS) untuk perwakilan reka letak keseluruhan.
