...
############################# Head ############################
head_title: "Java HTML Adnotare API Adnotare în C#"
head_description: "API Java pentru a crea și adnota tipuri populare de adnotări din HTML, imagini, desene și formate de fișiere de documente."

############################# Header ############################
title: "Adnotă HTML din Java"
description: ""
...
about:
    ...
    content: |
        ...
        Această bibliotecă vă permite să lucrați nu numai cu documentul HTML, ci și cu multe alte tipuri de documente, cum ar fi Word, Excel, PowerPoint, e-mailuri Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad și multe altele.
...
steps_Remove:
    enable: true
    title_left: "Pași pentru a elimina adnotările din HTML în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java eliminarea detaliilor adnotărilor din fișierele HTML din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
steps_Edit:
    enable: true
    title_left: "Pași pentru editarea adnotărilor din HTML în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java actualizarea diferitelor proprietăți de adnotări din fișierele HTML din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
...
steps_Extract:
    enable: true
    title_left: "Pași pentru extragerea adnotărilor din HTML în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) le permite dezvoltatorilor Java să adnoteze documente și să extragă informații despre adnotări din fișiere HTML din orice aplicație bazată pe Java, prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
demos:
    ...
    content: |
        Adăugați, eliminați, editați și extrageți adnotări în fișierul HTML chiar acum, vizitând site-ul web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo-ul live are următoarele beneficii
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Despre formatul de fișier HTML"
          content: |
            HTML (Hyper Text Markup Language) este extensia pentru paginile web create pentru afișare în browsere. Cunoscut ca limbajul web, HTML a evoluat odată cu cerințele noilor cerințe de informații care urmează să fie afișate ca parte a paginilor web. Cea mai recentă variantă este cunoscută ca HTML 5, care oferă multă flexibilitate pentru lucrul cu limbajul. Paginile HTML sunt fie primite de la server, unde acestea sunt găzduite, fie pot fi încărcate și din sistemul local. Fiecare pagină HTML este alcătuită din elemente HTML cum ar fi formulare, text, imagini, animații, link-uri etc. Aceste elemente sunt reprezentate de etichete precum img, a, p și alte câteva, unde fiecare etichetă are început și sfârșit. De asemenea, poate încorpora aplicații scrise în limbaje de scripting, cum ar fi JavaScript și Foi de stil (CSS) pentru reprezentarea generală a aspectului.
