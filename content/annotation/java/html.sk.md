...
############################# Head ############################
head_title: "Java HTML Anotácia API Anotácia v C#"
head_description: "Java API na vytváranie a komentovanie populárnych typov anotácií z HTML, obrázkov, nákresov a formátov súborov dokumentov."

############################# Header ############################
title: "Anotujte súbor HTML z jazyka Java"
description: ""
...
about:
    ...
    content: |
        ...
        Táto knižnica vám umožňuje pracovať nielen s dokumentom HTML, ale aj s mnohými ďalšími typmi dokumentov, ako sú Word, Excel, PowerPoint, Outlook e-maily, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad a mnoho ďalších.
...
steps_Remove:
    enable: true
    title_left: "Kroky na odstránenie anotácií zo súboru HTML v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom jazyka Java odstraňovanie podrobností anotácií zo súborov HTML v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
        *   Vytvorte objekty odpovede s komentárom a dátumom.
...
steps_Edit:
    enable: true
    title_left: "Kroky na úpravu anotácií zo súboru HTML v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom Java aktualizovať rôzne vlastnosti anotácií zo súborov HTML v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
...
steps_Extract:
    enable: true
    title_left: "Kroky na extrahovanie anotácií zo súboru HTML v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom jazyka Java anotáciu dokumentov a extrahovanie informácií o anotáciách zo súborov HTML v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
        *   Vytvorte objekty odpovede s komentárom a dátumom.
...
demos:
    ...
    content: |
        Pridávajte, odstraňujte, upravujte a extrahujte anotácie do súboru HTML práve teraz na webovej lokalite [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Živá ukážka má nasledujúce výhody
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Informácie o formáte súboru HTML"
          content: |
            HTML (Hyper Text Markup Language) je rozšírenie pre webové stránky vytvorené na zobrazenie v prehliadačoch. HTML, známy ako jazyk webu, sa vyvinul s požiadavkami na nové informačné požiadavky, ktoré sa majú zobrazovať ako súčasť webových stránok. Najnovší variant je známy ako HTML 5, ktorý poskytuje veľkú flexibilitu pri práci s jazykom. HTML stránky sú buď prijímané zo servera, kde sú hosťované, alebo môžu byť načítané aj z lokálneho systému. Každá stránka HTML sa skladá z prvkov HTML, ako sú formuláre, text, obrázky, animácie, odkazy atď. Tieto prvky sú reprezentované značkami ako img, a, p a niekoľkými ďalšími, pričom každá značka má začiatok a koniec. Môže tiež vkladať aplikácie napísané v skriptovacích jazykoch, ako sú JavaScript a šablóny štýlov (CSS), aby sa zabezpečilo celkové znázornenie rozloženia.
