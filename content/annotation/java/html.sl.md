...
############################# Head ############################
head_title: "Java HTML Annotation API Annotate v C#"
head_description: "Java API za ustvarjanje in označevanje priljubljenih vrst opomb iz HTML, slik, risb in oblik datotek dokumentov."
...
about:
    ...
    content: |
        ...
        Ta knjižnica vam omogoča delo ne samo z dokumentom HTML, ampak tudi z mnogimi drugimi vrstami dokumentov, kot so Word, Excel, PowerPoint, Outlookova e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad in mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraki za odstranitev opomb iz HTML v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša odstranjevanje podrobnosti opombe iz datotek HTML znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
        *   Ustvarite objekte odgovora s komentarjem in datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraki za urejanje opomb iz HTML v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša posodabljanje različnih lastnosti opomb iz datotek HTML znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
...
steps_Extract:
    enable: true
    title_left: "Koraki za ekstrahiranje opomb iz HTML v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša dodajanje opomb dokumentom in pridobivanje informacij o opombah iz datotek HTML znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
        *   Ustvarite objekte odgovora s komentarjem in datumom.
...
demos:
    ...
    content: |
        Takoj dodajte, odstranite, uredite in izvlecite opombe v datoteko HTML tako, da obiščete spletno mesto [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Predstavitev v živo ima naslednje prednosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          ...
          content: |
            HTML (Hyper Text Markup Language) je razširitev za spletne strani, ustvarjene za prikaz v brskalnikih. HTML, poznan kot jezik spleta, se je razvil z zahtevami novih informacij, ki naj bodo prikazane kot del spletnih strani. Najnovejša različica je znana kot HTML 5, ki daje veliko prilagodljivosti pri delu z jezikom. Strani HTML prejmemo s strežnika, kjer te gostujejo, ali pa jih lahko naložimo tudi iz lokalnega sistema. Vsaka stran HTML je sestavljena iz elementov HTML, kot so obrazci, besedilo, slike, animacije, povezave itd. Ti elementi so predstavljeni z oznakami, kot so img, a, p in številne druge, kjer ima vsaka oznaka začetek in konec. Prav tako lahko vdela aplikacije, napisane v skriptnih jezikih, kot sta JavaScript in Style Sheets (CSS), za celotno predstavitev postavitve.
