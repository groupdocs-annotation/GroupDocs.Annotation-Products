...
demos:
    ...
    content: |
        Agregue, elimine, edite y extraiga anotaciones en el archivo JPEG ahora mismo visitando el sitio web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
