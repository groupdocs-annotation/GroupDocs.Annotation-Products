...
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada JPEG, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi JPEG daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen JPEG tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada JPEG dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail JPEG dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada JPEG dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail JPEG dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada JPEG dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail JPEG dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail JPEG sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-jpeg"
          title: "Mengenai Format Fail JPEG."
          content: |
            JPEG ialah sejenis format imej yang disimpan menggunakan kaedah pemampatan lossy. Imej output, hasil daripada pemampatan, adalah pertukaran antara saiz storan dan kualiti imej. Pengguna boleh melaraskan tahap mampatan untuk mencapai tahap kualiti yang diingini dan pada masa yang sama mengurangkan saiz storan. Kualiti imej boleh diabaikan terjejas jika pemampatan 10:1 digunakan pada imej. Semakin tinggi nilai mampatan, semakin tinggi kemerosotan kualiti imej. Format fail imej JPEG telah diseragamkan oleh Kumpulan Pakar Fotografi Bersama dan, oleh itu, nama JPEG. Formatnya telah menjadi pilihan untuk menyimpan dan menghantar imej fotografi di web. Hampir semua sistem Pengendalian kini mempunyai penonton yang menyokong visualisasi imej JPEG, yang sering disimpan dengan sambungan JPG juga. Malah pelayar web menyokong visualisasi imej JPEG.
