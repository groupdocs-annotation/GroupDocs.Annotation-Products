...
head_description: "Java API to create and Annotate popular annotation types from JPG, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to JPG in Java"
    content_left: |
...
demos:
    ...
    content: |
        Add, remove, edit and extract annotations to JPG file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website. The live demo has the following benefits
