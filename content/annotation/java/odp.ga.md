...
############################# Head ############################
head_title: "Java ODP Anótáil API Anótáil i C#"
head_description: "Java API chun cineálacha móréilimh anótála a chruthú agus a Anótáil ó ODP, íomhánna, líníochtaí agus formáidí comhaid doiciméad."

############################# Header ############################
title: "Anótáil ODP ó Java"
description: ""
...
about:
    ...
    content: |
        ...
        Ligeann an leabharlann seo duit oibriú ní hamháin le doiciméad ODP ach freisin le go leor cineálacha doiciméad eile ar nós Word, Excel, PowerPoint, ríomhphoist Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad agus go leor eile.
        ...
        Léiríonn an sampla (féach thíos) oibriú le doiciméad ODP, sa sampla seo d'fhéadfá na príomhchéimeanna a fheiceáil maidir le conas oibriú le GroupDocs.Annotation: Socraigh ceadúnas, oscail doiciméad a bhfuil tú ag iarraidh oibriú leis, cruthaigh doiciméad anótáil, rudaí sonraí a chur leis chun airíonna anótála a shocrú de réir do riachtanas agus an toradh a shábháil chuig an áit atá ag teastáil. Chomh maith leis sin d'fhéadfá breathnú níos mionsonraithe a bheith agat ar na gnéithe tacaithe ar ár leathanach github [] (https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java), nó inár dtáirge [doiciméadúchán] (https: //docs.groupdocs.com/annotation/java/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Céimeanna chun Anótálacha a Chur le ODP i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé éasca d’fhorbróirí Java cineálacha éagsúla nótaí a chur le comhaid ODP laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
...
steps_Remove:
    enable: true
    title_left: "Céimeanna chun Anótálacha a Bhaint ó ODP i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé níos fusa d’fhorbróirí Java sonraí anóta a bhaint de chomhaid ODP laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
        *   Cruthaigh oibiachtaí Freagra le trácht agus dáta.
...
steps_Edit:
    enable: true
    title_left: "Céimeanna chun Anótálacha ó ODP a chur in eagar i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé níos fusa d’fhorbróirí Java airíonna nótaí éagsúla ó chomhaid ODP a nuashonrú laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
...
steps_Extract:
    enable: true
    title_left: "Céimeanna chun Anótálacha a Bhaint as ODP i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé éasca d’fhorbróirí Java doiciméid a anótáil agus faisnéis anótála a bhaint as comhaid ODP laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
        *   Cruthaigh oibiachtaí Freagra le trácht agus dáta.
...
demos:
    ...
    content: |
        Cuir nótaí le ODP leis, bain, cuir in eagar agus bain amach iad faoi láthair trí chuairt a thabhairt ar [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Tá na buntáistí seo a leanas ag an taispeántas beo
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-odp"
          title: "Maidir le ODP Formáid Chomhaid"
          content: |
            Is ionann comhaid a bhfuil síneadh ODP acu agus formáid comhaid léirithe a úsáideann OpenOffice.org sa chaighdeán OASISOpen. Is éard atá i gcomhad léirithe ná bailiúchán sleamhnán inar féidir le gach sleamhnán a bheith comhdhéanta de théacs, íomhánna, formáidiú, beochan, agus meáin eile. Cuirtear na sleamhnáin seo i láthair don lucht féachana i bhfoirm taispeántais sleamhnán le socruithe saincheaptha cur i láthair. Is féidir comhaid ODP a oscailt le feidhmchláir a chloíonn leis an bhformáid OpenDocument (amhail OpenOffice nó StarOffice).
