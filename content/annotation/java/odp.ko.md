...
############################# Head ############################
head_title: "Java ODP 주석 API C# 주석"
head_description: "ODP, 이미지, 그림 및 문서 파일 형식에서 인기 있는 주석 유형을 만들고 주석을 추가하는 Java API."

############################# Header ############################
title: "자바에서 ODP에 주석 달기"
description: ""
...
about:
    ...
    content: |
        ...
        이 라이브러리를 사용하면 ODP 문서뿐만 아니라 Word, Excel, PowerPoint, Outlook 이메일, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad 및 기타 여러 유형의 문서와 함께 작업할 수 있습니다.
        ...
        예제(아래 참조)는 ODP 문서 작업을 보여줍니다. 이 예제에서는 GroupDocs 작업 방법의 주요 단계를 볼 수 있습니다. 주석: 라이선스 설정, 작업할 문서 열기, 주석, 데이터 개체를 추가하여 요구 사항에 따라 주석 속성을 설정하고 결과를 필요한 위치에 저장합니다. 또한 github [페이지](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java) 또는 제품 [문서](https: //docs.groupdocs.com/annotation/java/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Java에서 ODP에 주석을 추가하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java 개발자가 몇 가지 간단한 단계를 구현하여 Java 기반 응용 프로그램 내의 ODP 파일에 다양한 주석 유형을 쉽게 추가할 수 있습니다.
...
steps_Remove:
    enable: true
    title_left: "Java의 ODP에서 주석을 제거하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java 개발자가 몇 가지 간단한 단계를 구현하여 Java 기반 응용 프로그램 내의 ODP 파일에서 주석 세부 정보를 쉽게 제거할 수 있습니다.
        *   댓글과 날짜가 포함된 Reply 객체를 생성합니다.
...
steps_Edit:
    enable: true
    title_left: "Java에서 ODP의 주석을 편집하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java 개발자가 몇 가지 간단한 단계를 구현하여 Java 기반 응용 프로그램 내의 ODP 파일에서 다양한 주석 속성을 쉽게 업데이트할 수 있습니다.
...
steps_Extract:
    enable: true
    title_left: "Java의 ODP에서 주석을 추출하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java 개발자가 몇 가지 간단한 단계를 구현하여 Java 기반 애플리케이션 내의 ODP 파일에서 쉽게 문서에 주석을 달고 주석 정보를 추출할 수 있습니다.
        *   댓글과 날짜가 포함된 Reply 객체를 생성합니다.
...
demos:
    ...
    content: |
        지금 바로 [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) 웹사이트를 방문하여 주석을 ODP 파일에 추가, 제거, 편집 및 추출하세요. 라이브 데모에는 다음과 같은 이점이 있습니다.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-odp"
          title: "ODP 파일 형식 정보"
          content: |
            ODP 확장자를 가진 파일은 OASISOpen 표준에서 OpenOffice.org에서 사용하는 프레젠테이션 파일 형식을 나타냅니다. 프리젠테이션 파일은 각 슬라이드가 텍스트, 이미지, 서식, 애니메이션 및 기타 미디어로 구성될 수 있는 슬라이드 모음입니다. 이러한 슬라이드는 사용자 지정 프레젠테이션 설정이 있는 슬라이드쇼 형식으로 청중에게 제공됩니다. ODP 파일은 OpenDocument 형식(예: OpenOffice 또는 StarOffice)을 준수하는 응용 프로그램에서 열 수 있습니다.
