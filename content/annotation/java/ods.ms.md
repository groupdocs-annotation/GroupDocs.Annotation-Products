...
############################# Head ############################
head_title: "Java ODS Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada ODS, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi ODS daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen ODS tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada ODS dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail ODS dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada ODS dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail ODS dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada ODS dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail ODS dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail ODS sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ods"
          title: "Mengenai Format Fail ODS."
          content: |
            Fail dengan sambungan ODS berdiri untuk format OpenDocument Spreadsheet Document yang boleh diedit oleh pengguna. Data disimpan di dalam fail ODF ke dalam baris dan lajur. Ia adalah format berasaskan XML dan merupakan salah satu daripada beberapa subjenis dalam keluarga Open Document Formats (ODF). Format ditentukan sebagai sebahagian daripada spesifikasi ODF 1.2 yang diterbitkan dan diselenggara oleh OASIS. Sebilangan aplikasi pada Windows serta sistem pengendalian lain boleh membuka fail ODS untuk penyuntingan dan manipulasi termasuk Microsoft Excel, NeoOffice dan LibreOffice. Fail ODS juga boleh ditukar kepada format hamparan lain seperti XLS, XLSX dan lain-lain melalui aplikasi yang berbeza.
