...
############################# Head ############################
head_title: "Remove Annotations from ODT in Java Application"
head_description: "Java API to create and Remove popular annotation types from ODT, images, drawings and document file formats."
...
demos:
    ...
    content: |
        View and remove annotations from ODT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
