...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to OTP in Java"
    content_left: |
...
demos:
    ...
    content: |
        Add, remove, edit and extract annotations to OTP file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website. The live demo has the following benefits
