...
############################# Head ############################
head_title: "Java OTP Anótáil API Anótáil i C#"
head_description: "Java API chun cineálacha móréilimh anótála a chruthú agus a Anótáil ó OTP, íomhánna, líníochtaí agus formáidí comhaid doiciméad."

############################# Header ############################
title: "Anótáil OTP ó Java"
description: ""
...
about:
    ...
    content: |
        ...
        Ligeann an leabharlann seo duit oibriú ní hamháin le doiciméad OTP ach freisin le go leor cineálacha doiciméad eile ar nós Word, Excel, PowerPoint, ríomhphoist Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad agus go leor eile.
...
steps_Remove:
    enable: true
    title_left: "Céimeanna chun Anótálacha a Bhaint ó OTP i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé níos fusa d’fhorbróirí Java sonraí anóta a bhaint de chomhaid OTP laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
        *   Cruthaigh oibiachtaí Freagra le trácht agus dáta.
...
steps_Edit:
    enable: true
    title_left: "Céimeanna chun Anótálacha ó OTP a chur in eagar i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé níos fusa d’fhorbróirí Java airíonna nótaí éagsúla ó chomhaid OTP a nuashonrú laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
...
steps_Extract:
    enable: true
    title_left: "Céimeanna chun Anótálacha a Bhaint as OTP i Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) déanann sé éasca d’fhorbróirí Java doiciméid a anótáil agus faisnéis anótála a bhaint as comhaid OTP laistigh d’fheidhmchlár Java-bhunaithe ar bith trí roinnt céimeanna éasca a chur i bhfeidhm.
        *   Cruthaigh oibiachtaí Freagra le trácht agus dáta.
...
demos:
    ...
    content: |
        Cuir nótaí le OTP leis, bain, cuir in eagar agus bain amach iad faoi láthair trí chuairt a thabhairt ar [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Tá na buntáistí seo a leanas ag an taispeántas beo
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-otp"
          title: "Maidir le OTP Formáid Chomhaid"
          content: |
            Is ionann comhaid le síneadh .OTP agus comhaid teimpléid láithreoireachta cruthaithe ag feidhmchláir i bhformáid chaighdeánach OASIS OpenDocument. Áirítear le hábhar comhaid den sórt sin faisnéis cur i láthair i bhfoirm sleamhnáin le téacs, íomhánna, cruthanna, ábhar ilmheán, éifeachtaí aistrithe agus eilimintí sleamhnáin eile. Úsáidtear na comhaid teimpléid seo chun cuir i láthair nua a chruthú go tapa bunaithe ar an eolas stílithe atá stóráilte sa teimpléad féin. Is féidir comhaid OTP a chruthú agus a shábháil le roinnt feidhmchláir éagsúla cosúil le Impress a thagann le sraith OpenOffice agus Microsoft PowerPoint. Tá formáid comhaid OTP cosúil le comhaid teimpléid Microsoft PowerPoint .POT agus .POTX.
