...
demos:
    ...
    content: |
        Aggiungi, rimuovi, modifica ed estrai subito le annotazioni dal file OTP visitando il sito web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
