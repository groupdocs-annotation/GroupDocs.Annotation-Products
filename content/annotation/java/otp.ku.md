...
head_description: "Java API ku ji OTP, wêne, xêzkirin û formatên pelên pelgeyê celebên annotasyonên populer çêbike û annot bike."

############################# Header ############################
title: "Ji Javayê OTP şîrove bikin"
description: ""
...
about:
    ...
    content: |
        ...
        Ev pirtûkxane dihêle hûn ne tenê bi belgeya OTP re lê her weha bi gelek celeb belgeyên din ên wekî Word, Excel, PowerPoint, e-nameyên Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad û gelekên din re bixebitin.
...
steps_Add:
    enable: true
    title_left: "Gavên Zêdekirina Şîroveyan li OTP di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve cûrbecûr şîrovekirinê li pelên OTP zêde bikin.
...
steps_Remove:
    enable: true
    title_left: "Gavên Rakirina Şîroveyan ji OTP li Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku hûrguliyên annotasyonê ji pelên OTP di nav her serîlêdana Java-yê de bi cîbicîkirina çend gavên hêsan rakin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
steps_Edit:
    enable: true
    title_left: "Gavên Guherandinên Şîrove ji OTP di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku bi pêkanîna çend gavên hêsan ve taybetmendiyên cûrbecûr şîrovekirinê ji pelên OTP di nav her serlêdanek Java-yê de nûve bikin.
...
steps_Extract:
    enable: true
    title_left: "Gavên Derxistina Şîroveyan ji OTP di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsan dike ku bi pêkanîna çend gavên hêsan belgeyan binivîsin û agahdariya şîrovekirinê ji pelên OTP derxînin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
demos:
    ...
    content: |
        Bi seredana malpera [GroupDocs.Annotation Demos Zindî](https://products.groupdocs.app/annotation/family) niha li pelê OTP şîroveyan zêde bikin, jêbikin, biguherînin û derxin. Demoya zindî xwedî feydeyên jêrîn e
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-otp"
          title: "Derbarê OTP Forma Pelê"
          content: |
            Pelên bi dirêjkirina .OTP pelên şablonên pêşkêşkirinê yên ku ji hêla serîlêdanan ve di formata standard OASIS OpenDocument ve hatine afirandin temsîl dikin. Naveroka pelek wusa agahdariya pêşkêşkirinê di forma slaytên bi nivîs, wêne, şikil, naveroka multimedia, bandorên veguheztinê û hêmanên din ên slaytê de vedihewîne. Van pelên şablonê ji bo afirandina pêşandanên nû zû li ser bingeha agahdariya şêwazê ya ku di şablonê bixwe de hatî hilanîn têne bikar anîn. Pelên OTP dikarin bi gelek serîlêdanên cihêreng ên wekî Impress ku bi suite OpenOffice û Microsoft PowerPoint-ê tê de werin afirandin û hilanîn. Forma pelê OTP dişibe pelên şablonê Microsoft PowerPoint .POT û .POTX.
