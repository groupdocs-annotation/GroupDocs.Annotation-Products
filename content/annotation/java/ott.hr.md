...
############################# Head ############################
head_title: "Java OTT Annotation API Annotate u C#"
head_description: "Java API za stvaranje i označavanje popularnih vrsta komentara iz OTT, slika, crteža i formata datoteka dokumenata."
...
about:
    ...
    content: |
        ...
        Ova biblioteka vam omogućuje rad ne samo s dokumentom OTT već i s mnogim drugim vrstama dokumenata kao što su Word, Excel, PowerPoint, Outlook e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraci za uklanjanje komentara iz OTT u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima uklanjanje detalja komentara iz datoteka OTT unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraci za uređivanje komentara iz OTT u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima ažuriranje različitih svojstava komentara iz OTT datoteka unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
...
steps_Extract:
    enable: true
    title_left: "Koraci za izdvajanje komentara iz OTT u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java programerima olakšava označavanje dokumenata i izdvajanje informacija o komentarima iz datoteka OTT unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ott"
          ...
          content: |
            Datoteke s ekstenzijom OTT predstavljaju predloške dokumenata koje generiraju aplikacije u skladu s OASIS-ovim standardnim formatom OpenDocument. Oni su stvoreni s programima za obradu teksta kao što je besplatni OpenOffice Writer i mogu sadržavati postavke koje se mogu koristiti za generiranje novih dokumenata iz ovih datoteka predložaka. Ove postavke uključuju margine stranice, obrube, zaglavlja, podnožja i druge postavke stranice. Takvi se predlošci koriste u službenim dokumentima kao što su zaglavlja poduzeća i standardizirani obrasci.
