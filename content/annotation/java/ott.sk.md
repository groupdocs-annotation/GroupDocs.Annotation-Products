...
############################# Head ############################
head_title: "Java OTT Anotácia API Anotácia v C#"
head_description: "Java API na vytváranie a komentovanie populárnych typov anotácií z OTT, obrázkov, nákresov a formátov súborov dokumentov."

############################# Header ############################
title: "Anotujte súbor OTT z jazyka Java"
description: ""
...
about:
    ...
    content: |
        ...
        Táto knižnica vám umožňuje pracovať nielen s dokumentom OTT, ale aj s mnohými ďalšími typmi dokumentov, ako sú Word, Excel, PowerPoint, Outlook e-maily, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad a mnoho ďalších.
...
steps_Remove:
    enable: true
    title_left: "Kroky na odstránenie anotácií zo súboru OTT v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom jazyka Java odstraňovanie podrobností anotácií zo súborov OTT v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
        *   Vytvorte objekty odpovede s komentárom a dátumom.
...
steps_Edit:
    enable: true
    title_left: "Kroky na úpravu anotácií zo súboru OTT v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom Java aktualizovať rôzne vlastnosti anotácií zo súborov OTT v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
...
steps_Extract:
    enable: true
    title_left: "Kroky na extrahovanie anotácií zo súboru OTT v jazyku Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) uľahčuje vývojárom jazyka Java anotáciu dokumentov a extrahovanie informácií o anotáciách zo súborov OTT v akejkoľvek aplikácii založenej na jazyku Java implementáciou niekoľkých jednoduchých krokov.
        *   Vytvorte objekty odpovede s komentárom a dátumom.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ott"
          title: "Informácie o formáte súboru OTT"
          content: |
            Súbory s príponou OTT predstavujú šablónové dokumenty generované aplikáciami v súlade so štandardným formátom OpenDocument OASIS. Sú vytvorené pomocou aplikácií textového procesora, ako je napríklad bezplatný OpenOffice Writer, a môžu obsahovať nastavenia, ktoré možno použiť na generovanie nových dokumentov z týchto súborov šablón. Tieto nastavenia zahŕňajú okraje, orámovanie, hlavičky, päty a ďalšie nastavenia strany. Takéto šablóny sa používajú v oficiálnych dokumentoch, ako sú hlavičkové papiere spoločností a štandardizované formuláre.
