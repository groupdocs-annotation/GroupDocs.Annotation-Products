...
############################# Head ############################
head_title: "Java PDF Annotation API Annotate u C#"
head_description: "Java API za stvaranje i označavanje popularnih vrsta komentara iz PDF, slika, crteža i formata datoteka dokumenata."
...
about:
    ...
    content: |
        ...
        Ova biblioteka vam omogućuje rad ne samo s dokumentom PDF već i s mnogim drugim vrstama dokumenata kao što su Word, Excel, PowerPoint, Outlook e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraci za uklanjanje komentara iz PDF u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima uklanjanje detalja komentara iz datoteka PDF unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraci za uređivanje komentara iz PDF u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) olakšava Java programerima ažuriranje različitih svojstava komentara iz PDF datoteka unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
...
steps_Extract:
    enable: true
    title_left: "Koraci za izdvajanje komentara iz PDF u Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java programerima olakšava označavanje dokumenata i izdvajanje informacija o komentarima iz datoteka PDF unutar bilo koje aplikacije temeljene na Javi implementacijom nekoliko jednostavnih koraka.
        *   Stvorite objekte odgovora s komentarom i datumom.
...
demos:
    ...
    content: |
        Dodajte, uklonite, uredite i ekstrahirajte komentare u datoteku PDF odmah tako da posjetite [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) web mjesto. Demo uživo ima sljedeće prednosti
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pdf"
          ...
          content: |
            Portable Document Format (PDF) vrsta je dokumenta koji je stvorio Adobe 1990-ih. Svrha ovog formata datoteke bila je uvođenje standarda za predstavljanje dokumenata i drugog referentnog materijala u formatu koji je neovisan o aplikacijskom softveru, hardveru kao i operativnom sustavu. PDF datoteke mogu se otvoriti u programu Adobe Acrobat Reader/Writer kao iu većini modernih preglednika kao što su Chrome, Safari, Firefox putem proširenja/dodataka. Većina komercijalno dostupnih softverskih paketa također nudi konverziju svojih dokumenata u PDF format datoteke bez potrebe za bilo kakvom dodatnom softverskom komponentom. Dakle, PDF format datoteke ima punu mogućnost sadržavanja informacija poput teksta, slika, hiperveza, polja obrasca, obogaćenih medija, digitalnih potpisa, privitaka, metapodataka, geoprostornih značajki i 3D objekata koji mogu postati dio izvornog dokumenta.
