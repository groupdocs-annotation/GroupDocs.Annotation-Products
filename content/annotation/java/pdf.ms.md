...
############################# Head ############################
head_title: "Java PDF Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada PDF, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi PDF daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen PDF tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada PDF dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail PDF dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada PDF dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail PDF dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada PDF dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail PDF dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail PDF sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pdf"
          title: "Mengenai Format Fail PDF."
          content: |
            Format Dokumen Mudah Alih (PDF) ialah sejenis dokumen yang dicipta oleh Adobe pada tahun 1990-an. Tujuan format fail ini adalah untuk memperkenalkan piawaian bagi perwakilan dokumen dan bahan rujukan lain dalam format yang bebas daripada perisian aplikasi, perkakasan serta Sistem Pengendalian. Fail PDF boleh dibuka dalam Adobe Acrobat Reader/Writer serta dalam kebanyakan penyemak imbas moden seperti Chrome, Safari, Firefox melalui sambungan/plug-in. Kebanyakan suite perisian yang tersedia secara komersial juga menawarkan penukaran dokumen mereka kepada format fail PDF tanpa memerlukan sebarang komponen perisian tambahan. Oleh itu, format fail PDF mempunyai keupayaan penuh untuk mengandungi maklumat seperti teks, imej, hiperpautan, medan borang, media kaya, tandatangan digital, lampiran, metadata, ciri Geospatial dan objek 3D di dalamnya yang boleh menjadi sebahagian daripada dokumen sumber.
