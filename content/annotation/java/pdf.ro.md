...
############################# Head ############################
head_title: "Java PDF Adnotare API Adnotare în C#"
head_description: "API Java pentru a crea și adnota tipuri populare de adnotări din PDF, imagini, desene și formate de fișiere de documente."

############################# Header ############################
title: "Adnotă PDF din Java"
description: ""
...
about:
    ...
    content: |
        ...
        Această bibliotecă vă permite să lucrați nu numai cu documentul PDF, ci și cu multe alte tipuri de documente, cum ar fi Word, Excel, PowerPoint, e-mailuri Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad și multe altele.
...
steps_Remove:
    enable: true
    title_left: "Pași pentru a elimina adnotările din PDF în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java eliminarea detaliilor adnotărilor din fișierele PDF din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
steps_Edit:
    enable: true
    title_left: "Pași pentru editarea adnotărilor din PDF în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java actualizarea diferitelor proprietăți de adnotări din fișierele PDF din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
...
steps_Extract:
    enable: true
    title_left: "Pași pentru extragerea adnotărilor din PDF în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) le permite dezvoltatorilor Java să adnoteze documente și să extragă informații despre adnotări din fișiere PDF din orice aplicație bazată pe Java, prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
demos:
    ...
    content: |
        Adăugați, eliminați, editați și extrageți adnotări în fișierul PDF chiar acum, vizitând site-ul web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo-ul live are următoarele beneficii
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pdf"
          title: "Despre formatul de fișier PDF"
          content: |
            Portable Document Format (PDF) este un tip de document creat de Adobe în anii 1990. Scopul acestui format de fișier a fost de a introduce un standard pentru reprezentarea documentelor și a altor materiale de referință într-un format care este independent de software-ul aplicației, hardware-ul și sistemul de operare. Fișierele PDF pot fi deschise în Adobe Acrobat Reader/Writer, precum și în majoritatea browserelor moderne precum Chrome, Safari, Firefox prin extensii/plug-in-uri. Cele mai multe dintre suitele de software disponibile comercial oferă, de asemenea, conversia documentelor lor în format de fișier PDF fără a fi necesară nicio componentă software suplimentară. Astfel, formatul de fișier PDF are capacitatea deplină de a conține informații cum ar fi text, imagini, hyperlinkuri, câmpuri de formular, rich media, semnături digitale, atașamente, metadate, caracteristici geospațiale și obiecte 3D care pot deveni parte a documentului sursă.
