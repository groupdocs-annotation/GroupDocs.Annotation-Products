...
############################# Head ############################
head_title: "Java PNG Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada PNG, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi PNG daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen PNG tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada PNG dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail PNG dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada PNG dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail PNG dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada PNG dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail PNG dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail PNG sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-png"
          title: "Mengenai Format Fail PNG."
          content: |
            PNG, Grafik Rangkaian Mudah Alih, merujuk kepada jenis format fail imej raster yang menggunakan pemampatan tanpa rugi. Format fail ini dicipta sebagai pengganti Format Pertukaran Grafik (GIF) dan tidak mempunyai had hak cipta. Walau bagaimanapun, format fail PNG tidak menyokong animasi. Format fail PNG menyokong pemampatan imej tanpa kehilangan yang menjadikannya popular di kalangan penggunanya. Dengan peredaran masa, PNG telah berkembang sebagai salah satu format fail imej yang paling banyak digunakan. Hampir semua Sistem Pengendalian mempunyai sokongan untuk membuka fail PNG. Sebagai contoh, Microsoft Windows viewer mempunyai keupayaan untuk membuka fail PNG kerana OS secara lalai mempunyai sokongan yang tersedia sebagai sebahagian daripada pemasangan.
