...
############################# Head ############################
head_title: "Java PNG Adnotare API Adnotare în C#"
head_description: "API Java pentru a crea și adnota tipuri populare de adnotări din PNG, imagini, desene și formate de fișiere de documente."

############################# Header ############################
title: "Adnotă PNG din Java"
description: ""
...
about:
    ...
    content: |
        ...
        Această bibliotecă vă permite să lucrați nu numai cu documentul PNG, ci și cu multe alte tipuri de documente, cum ar fi Word, Excel, PowerPoint, e-mailuri Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad și multe altele.
...
steps_Remove:
    enable: true
    title_left: "Pași pentru a elimina adnotările din PNG în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java eliminarea detaliilor adnotărilor din fișierele PNG din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
steps_Edit:
    enable: true
    title_left: "Pași pentru editarea adnotărilor din PNG în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java actualizarea diferitelor proprietăți de adnotări din fișierele PNG din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
...
steps_Extract:
    enable: true
    title_left: "Pași pentru extragerea adnotărilor din PNG în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) le permite dezvoltatorilor Java să adnoteze documente și să extragă informații despre adnotări din fișiere PNG din orice aplicație bazată pe Java, prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
demos:
    ...
    content: |
        Adăugați, eliminați, editați și extrageți adnotări în fișierul PNG chiar acum, vizitând site-ul web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo-ul live are următoarele beneficii
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-png"
          title: "Despre formatul de fișier PNG"
          content: |
            PNG, Portable Network Graphics, se referă la un tip de format de fișier imagine raster care utilizează compresie fără pierderi. Acest format de fișier a fost creat ca înlocuitor al Graphics Interchange Format (GIF) și nu are limitări ale drepturilor de autor. Cu toate acestea, formatul de fișier PNG nu acceptă animații. Formatul de fișier PNG acceptă compresia fără pierderi de imagine, ceea ce îl face popular în rândul utilizatorilor săi. Odată cu trecerea timpului, PNG a evoluat ca unul dintre cele mai utilizate formate de fișiere imagine. Aproape toate sistemele de operare au suport pentru deschiderea fișierelor PNG. De exemplu, vizualizatorul Microsoft Windows are capacitatea de a deschide fișiere PNG, deoarece sistemul de operare are în mod implicit suportul disponibil ca parte a instalării.
