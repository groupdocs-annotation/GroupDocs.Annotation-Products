...
############################# Head ############################
head_title: "Java POTM Annotation API Annotate v C#"
head_description: "Java API za ustvarjanje in označevanje priljubljenih vrst opomb iz POTM, slik, risb in oblik datotek dokumentov."
...
about:
    ...
    content: |
        ...
        Ta knjižnica vam omogoča delo ne samo z dokumentom POTM, ampak tudi z mnogimi drugimi vrstami dokumentov, kot so Word, Excel, PowerPoint, Outlookova e-pošta, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad in mnogi drugi.
...
steps_Remove:
    enable: true
    title_left: "Koraki za odstranitev opomb iz POTM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša odstranjevanje podrobnosti opombe iz datotek POTM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
        *   Ustvarite objekte odgovora s komentarjem in datumom.
...
steps_Edit:
    enable: true
    title_left: "Koraki za urejanje opomb iz POTM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša posodabljanje različnih lastnosti opomb iz datotek POTM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
...
steps_Extract:
    enable: true
    title_left: "Koraki za ekstrahiranje opomb iz POTM v Javi"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) razvijalcem Java olajša dodajanje opomb dokumentom in pridobivanje informacij o opombah iz datotek POTM znotraj katere koli aplikacije, ki temelji na Javi, z implementacijo nekaj preprostih korakov.
        *   Ustvarite objekte odgovora s komentarjem in datumom.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-potm"
          ...
          content: |
            Datoteke s pripono POTM so datoteke predlog Microsoft PowerPoint s podporo za makre. Datoteke POTM so ustvarjene s programom PowerPoint 2007 ali novejšim in vsebujejo privzete nastavitve, ki jih je mogoče uporabiti za ustvarjanje nadaljnjih predstavitvenih datotek. Te nastavitve lahko vključujejo sloge, ozadja, barvno paleto, pisave in privzete nastavitve skupaj z makri, ki so sestavljeni iz funkcij po meri za opravljanje določene naloge. Lahko jih odpre tudi prejšnja različica PowerPointa z nameščeno podporo za dokumente Open XML. Datoteke POTM lahko odprete v programu Microsoft PowerPoint za urejanje kot vse druge datoteke PowerPoint.
