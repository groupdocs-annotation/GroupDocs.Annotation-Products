...
############################# Head ############################
head_title: "Remove Annotations from POTX in Java Application"
head_description: "Java API to create and Remove popular annotation types from POTX, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations from POTX in Java"
    content_left: |
