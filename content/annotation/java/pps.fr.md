...
############################# Head ############################
head_title: "Retirer Annotations depuis PPS dans l'application Java"
head_description: "Java API pour créer et Retirer types d'annotations populaires depuis PPS, images, dessins et formats de fichiers de documents."
