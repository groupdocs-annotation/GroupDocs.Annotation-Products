...
############################# Head ############################
head_title: "Java PPS API di annotazione Annotate in C#"
head_description: "Java API per creare e Annotate tipi di annotazioni popolari da PPS, immagini, disegni e formati di file di documenti."
...
about:
    ...
    content: |
        ...
        Questa libreria ti consente di lavorare non solo con il documento PPS ma anche con molti altri tipi di documenti come Word, Excel, PowerPoint, email di Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad e molti altri.
...
steps_Add:
    enable: true
    title_left: "Passaggi per aggiungere annotazioni da PPS in Java"
    content_left: |
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende più facile per gli sviluppatori Java aggiornare varie proprietà di annotazione da file PPS all'interno di qualsiasi applicazione basata su Java implementando pochi semplici passaggi.
...
steps_Extract:
    enable: true
    title_left: "Passaggi per estrarre le annotazioni da PPS in Java"
    content_left: |
...
demos:
    ...
    content: |
        Aggiungete, rimuovete, modificate ed estraete annotazioni al file PPS in questo momento visitando il sito web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
