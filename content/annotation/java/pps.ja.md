...
############################# Head ############################
head_title: "Java アプリケーションの 削除 注釈 から PPS"
head_description: "Java API と 削除 の一般的な注釈タイプ から PPS、画像、図面、ドキュメント ファイル形式を作成します。"
...
demos:
    ...
    title: "注釈を抽出するライブデモ"
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) Web サイトにアクセスして、今すぐ PPS ファイルから注釈を表示して削除します。
