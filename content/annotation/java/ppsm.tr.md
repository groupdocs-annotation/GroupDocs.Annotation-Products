...
demos:
    ...
    content: |
        Hemen şimdi [GroupDocs.Annotation Canlı Demolar](https://products.groupdocs.app/annotation/family) web sitesini ziyaret ederek PPSM dosyasına ek açıklama ekleyin, kaldırın, düzenleyin ve çıkarın.
