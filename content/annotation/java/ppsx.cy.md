...
############################# Head ############################
head_title: "Java PPSX Anodi API Anodi yn C#"
head_description: "Java API i greu ac Anodi mathau o anodiadau poblogaidd o PPSX, delweddau, lluniadau a fformatau ffeil dogfen."

############################# Header ############################
title: "Anodwch PPSX o Java"
description: ""
...
about:
    ...
    content: |
        ...
        Mae'r llyfrgell hon yn eich galluogi i weithio nid yn unig gyda PPSX dogfen ond hefyd gyda llawer o fathau eraill o ddogfennau megis Word, Excel, PowerPoint, e-byst Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad a llawer o rai eraill.
...
steps_Remove:
    enable: true
    title_left: "Camau i Dynnu Anodiadau o PPSX yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud yn haws i ddatblygwyr Java dynnu manylion anodiad o PPSX o ffeiliau o fewn unrhyw raglen sy'n seiliedig ar Java drwy roi ychydig o gamau hawdd ar waith.
        *   Creu gwrthrychau Ateb gyda sylw a dyddiad.
...
steps_Edit:
    enable: true
    title_left: "Camau i Olygu Anodiadau o PPSX yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud yn haws i ddatblygwyr Java ddiweddaru priodweddau anodi amrywiol o PPSX o ffeiliau o fewn unrhyw raglen sy'n seiliedig ar Java trwy roi ychydig o gamau hawdd ar waith.
...
steps_Extract:
    enable: true
    title_left: "Camau i Echdynnu Anodiadau o PPSX yn Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) yn ei gwneud hi'n hawdd i ddatblygwyr Java anodi dogfennau a thynnu gwybodaeth anodiad o PPSX ffeil o fewn unrhyw raglen sy'n seiliedig ar Java trwy roi ychydig o gamau hawdd ar waith.
        *   Creu gwrthrychau Ateb gyda sylw a dyddiad.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ppsx"
          title: "Ynglŷn â PPSX Fformat Ffeil"
          content: |
            Mae PPSX, Sioe Sleidiau Power Point, yn cael eu creu gan ddefnyddio Microsoft PowerPoint 2007 ac uwch at ddiben Sioe Sleidiau. Mae'n ddiweddariad i fformat ffeil PPS a gefnogwyd gan fersiynau Microsoft PowerPoint 97-2003. Pan fydd ffeil PPSX yn cael ei rhannu â defnyddiwr arall a'i hagor, mae'n dechrau fel sioe PowerPoint yn wahanol i ffeil PPTX sy'n agor yn y modd y gellir ei golygu. Mae dilyniant y sioe sleidiau yr un fath ag yn y cyflwyniad gwreiddiol. Mae'r sleidiau i gyd yn cyd-fynd â'r delweddau, seiniau a chyfryngau eraill sydd wedi'u mewnosod gyda'r sleidiau cyflwyno i'r PPSX yn ystod y sioe sleidiau.
