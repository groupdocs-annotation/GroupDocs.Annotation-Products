...
head_description: "Java API to create and Annotate popular annotation types from PPT, images, drawings and document file formats."

############################# Header ############################
title: "Annotate PPT from Java"
description: ""
...
steps_Remove:
    enable: true
    title_left: "Steps to Remove Annotations from PPT in Java"
    content_left: |
