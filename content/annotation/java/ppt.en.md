...
############################# Head ############################
head_title: "Remove Annotations from PPT in Java Application"
head_description: "Java API to create and Remove popular annotation types from PPT, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations from PPT in Java"
    content_left: |
