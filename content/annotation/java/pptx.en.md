...
head_description: "Java API to create and Annotate popular annotation types from PPTX, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to PPTX in Java"
    content_left: |
