...
############################# Head ############################
head_title: "Удаление Аннотаций с PPTX в Java приложении"
...
demos:
    ...
    content: |
        Просмотрите и удалите аннотации из файла PPTX прямо сейчас, посетив [живые демонстрации](https://products.groupdocs.app/annotation/family).
