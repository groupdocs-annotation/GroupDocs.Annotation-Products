...
head_description: "一般的な注釈タイプをDJVU、画像、図面、ドキュメントファイル形式から削除するJava Annotation API."
...
demos:
    ...
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family）Webサイトにアクセスして、今すぐDJVUファイルから注釈を表示および削除します。  
        ライブデモには次の利点があります
