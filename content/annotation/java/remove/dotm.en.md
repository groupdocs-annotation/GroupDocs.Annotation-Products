...
############################# Head ############################
head_title: "Remove Annotations from DOTM in Java Application"
head_description: "Java API to create and Remove popular annotation types from DOTM, images, drawings and document file formats."

############################# Header ############################
title: "Remove DOTM Files from Java"
...
steps:
    enable: true
    title_left: "Steps to Remove Annotations from DOTM in Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Java developers to remove annotation details from DOTM files within any Java-based application by implementing a few easy steps.
