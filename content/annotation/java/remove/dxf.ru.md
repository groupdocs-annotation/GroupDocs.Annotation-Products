...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/dxf"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с DXF in Java"
    content_left: |
