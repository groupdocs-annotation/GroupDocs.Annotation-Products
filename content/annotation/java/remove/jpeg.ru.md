...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/jpeg"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с JPEG in Java"
    content_left: |
