...
head_description: "一般的な注釈タイプをODS、画像、図面、ドキュメントファイル形式から削除するJava Annotation API."
...
demos:
    ...
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family）Webサイトにアクセスして、ODSファイルから注釈を表示および削除してください。  
        ライブデモには次の利点があります
