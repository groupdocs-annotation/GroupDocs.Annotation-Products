...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/otp"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с OTP in Java"
    content_left: |
