...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/potm"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с POTM in Java"
    content_left: |
