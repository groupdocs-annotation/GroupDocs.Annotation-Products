...
head_description: "一般的な注釈タイプをPOTX、画像、図面、ドキュメントファイル形式から削除するJavaannotation API."
...
demos:
    ...
    content: |
        [GroupDocs.Annotationライブデモ](https://products.groupdocs.app/annotation/family)サイトにアクセスして、POTXファイルから注釈を表示および削除してください。  
        ライブデモには次の利点があります
