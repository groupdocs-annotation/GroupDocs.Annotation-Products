...
head_description: "一般的な注釈タイプをPPSM、画像、図面、ドキュメントファイル形式から削除するJavaannotation API."
...
demos:
    ...
    content: |
        [GroupDocs.Annotationライブデモ](https://products.groupdocs.app/annotation/family)サイトにアクセスして、今すぐPPSMファイルから注釈を表示および削除してください。  
        ライブデモには次の利点があります
