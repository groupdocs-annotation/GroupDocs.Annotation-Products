...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/tif"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с TIF in Java"
    content_left: |
