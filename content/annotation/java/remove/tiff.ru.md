...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/tiff"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с TIFF in Java"
    content_left: |
