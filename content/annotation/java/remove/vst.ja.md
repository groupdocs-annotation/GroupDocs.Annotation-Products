...
head_title: "JavaアプリケーションのVSTから注釈を削除する"
head_description: "Javaannotation APIを使用して、VST、画像、図面、ドキュメントファイル形式から一般的な注釈タイプを削除します."

title: "JavaのVSTから注釈を削除する"
...
demos:
    ...
    content: |
        [GroupDocs.Annotationライブデモ](https://products.groupdocs.app/annotation/family)サイトにアクセスして、VSTファイルから注釈を表示および削除してください。  
        ライブデモには次の利点があります
