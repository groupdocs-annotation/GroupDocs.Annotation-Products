...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/vsx"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с VSX in Java"
    content_left: |
