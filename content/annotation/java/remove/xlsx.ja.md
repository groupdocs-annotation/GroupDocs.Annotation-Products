...
head_title: "JavaアプリケーションのXLSXから注釈を削除する"
head_description: "XLSX、画像、図面、ドキュメントファイル形式から一般的な注釈タイプを削除するJava Annotation API."

title: "JavaでXLSXから注釈を削除する"
...
steps:
    enable: true
    title_left: "JavaでXLSXから注釈を削除する手順"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/）を使用すると、Java開発者は、いくつかの簡単な手順を実装することで、Javaベースのアプリケーション内のXLSXファイルから注釈の詳細を簡単に削除できます。
...
demos:
    ...
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family）Webサイトにアクセスして、XLSXファイルから注釈を表示および削除してください。  
        ライブデモには次の利点があります
