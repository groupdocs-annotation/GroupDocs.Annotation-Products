...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/java/remove/xlsx"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с XLSX in Java"
    content_left: |
