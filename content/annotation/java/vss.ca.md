...
############################# Head ############################
head_title: "API d'anotació de Java VSS Anotar en C#"
head_description: "API de Java per crear i anotar tipus d'anotacions populars a partir de VSS, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu VSS des de Java"
description: ""
...
steps_Add:
    enable: true
    title_left: "Passos per afegir anotacions a VSS a Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita als desenvolupadors de Java afegir diversos tipus d'anotacions als fitxers VSS dins de qualsevol aplicació basada en Java implementant uns quants passos senzills.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de VSS a Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita als desenvolupadors de Java eliminar els detalls de les anotacions dels fitxers VSS dins de qualsevol aplicació basada en Java implementant uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar anotacions de VSS a Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita que els desenvolupadors de Java actualitzin diverses propietats d'anotació dels fitxers VSS dins de qualsevol aplicació basada en Java mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de VSS a Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita als desenvolupadors de Java anotar documents i extreure informació d'anotacions dels fitxers VSS dins de qualsevol aplicació basada en Java implementant uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
