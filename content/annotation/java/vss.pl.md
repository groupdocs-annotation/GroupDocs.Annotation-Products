...
demos:
    ...
    content: |
        Dodawaj, usuwaj, edytuj i wyodrębniaj adnotacje do pliku VSS już teraz, odwiedzając witrynę [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
