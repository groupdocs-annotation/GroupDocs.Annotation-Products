...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to VSX in Java"
    content_left: |
...
demos:
    ...
    content: |
        Add, remove, edit and extract annotations to VSX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website. The live demo has the following benefits
