...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to WMF in Java"
    content_left: |
...
demos:
    ...
    content: |
        Add, remove, edit and extract annotations to WMF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website. The live demo has the following benefits
