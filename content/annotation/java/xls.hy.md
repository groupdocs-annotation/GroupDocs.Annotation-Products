...
head_description: "Java API՝ XLS-ից հայտնի ծանոթագրությունների տեսակներ ստեղծելու և ծանոթագրելու համար, պատկերներ, գծագրեր և փաստաթղթերի ֆայլերի ձևաչափեր:"

############################# Header ############################
title: "Նշեք XLS Java-ից"
description: ""
...
steps_Add:
    enable: true
    title_left: "Java-ում XLS-ին ծանոթագրություններ ավելացնելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java-ի մշակողների համար հեշտացնում է անոտացիայի զանազան տեսակներ ավելացնել XLS ֆայլերին Java-ի վրա հիմնված ցանկացած հավելվածի մեջ՝ մի քանի հեշտ քայլեր իրականացնելով:
...
steps_Remove:
    enable: true
    title_left: "Java-ում ծանոթագրությունները XLS-ից հեռացնելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java-ի ծրագրավորողների համար հեշտացնում է անոտացիայի մանրամասները XLS ֆայլերից հեռացնելը Java-ի վրա հիմնված ցանկացած հավելվածի մեջ՝ մի քանի հեշտ քայլեր իրականացնելով:
        *   Ստեղծեք Reply օբյեկտներ՝ մեկնաբանությամբ և ամսաթվով:
...
steps_Edit:
    enable: true
    title_left: "Java-ում XLS-ի ծանոթագրությունները խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java-ի մշակողների համար հեշտացնում է անոտացիայի տարբեր հատկություններ թարմացնել XLS ֆայլերից Java-ի վրա հիմնված ցանկացած հավելվածի մեջ՝ իրականացնելով մի քանի հեշտ քայլեր:
...
steps_Extract:
    enable: true
    title_left: "Java-ում XLS-ից ծանոթագրություններ հանելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Java-ի մշակողների համար հեշտացնում է փաստաթղթերը ծանոթագրելը և XLS ֆայլերից անոտացիոն տեղեկություններ հանելը Java-ի վրա հիմնված ցանկացած հավելվածի մեջ՝ իրականացնելով մի քանի հեշտ քայլեր:
        *   Ստեղծեք Reply օբյեկտներ՝ մեկնաբանությամբ և ամսաթվով:
