...
############################# Head ############################
head_title: "Java XLS Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada XLS, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi XLS daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen XLS tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada XLS dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail XLS dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada XLS dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail XLS dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada XLS dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail XLS dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail XLS sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "Mengenai Format Fail XLS."
          content: |
            Fail dengan sambungan XLS mewakili Format Fail Binari Excel. Fail sedemikian boleh dibuat oleh Microsoft Excel serta program hamparan serupa yang lain seperti OpenOffice Calc atau Apple Numbers. Fail yang disimpan oleh Excel dikenali sebagai Buku Kerja di mana setiap buku kerja boleh mempunyai satu atau lebih lembaran kerja. Data disimpan dan dipaparkan kepada pengguna dalam format jadual dalam lembaran kerja dan boleh merangkumi nilai berangka, data teks, formula, sambungan data luaran, imej dan carta. Aplikasi seperti Microsoft Excel membolehkan anda mengeksport data buku kerja ke beberapa format berbeza termasuk PDF, CSV, XLSX, TXT, HTML, XPS dan beberapa format lain. Format fail XLS telah digantikan dengan format yang lebih terbuka dan berstruktur, XLSX, dengan keluaran Microsoft Excel 2007. Versi terkini masih memberikan sokongan untuk mencipta dan membaca fail XLS, walaupun XLSX ialah pilihan pertama penggunaan sekarang.
