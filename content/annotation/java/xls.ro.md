...
############################# Head ############################
head_title: "Java XLS Adnotare API Adnotare în C#"
head_description: "API Java pentru a crea și adnota tipuri populare de adnotări din XLS, imagini, desene și formate de fișiere de documente."

############################# Header ############################
title: "Adnotă XLS din Java"
description: ""
...
about:
    ...
    content: |
        ...
        Această bibliotecă vă permite să lucrați nu numai cu documentul XLS, ci și cu multe alte tipuri de documente, cum ar fi Word, Excel, PowerPoint, e-mailuri Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad și multe altele.
...
steps_Remove:
    enable: true
    title_left: "Pași pentru a elimina adnotările din XLS în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java eliminarea detaliilor adnotărilor din fișierele XLS din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
steps_Edit:
    enable: true
    title_left: "Pași pentru editarea adnotărilor din XLS în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilitează pentru dezvoltatorii Java actualizarea diferitelor proprietăți de adnotări din fișierele XLS din orice aplicație bazată pe Java prin implementarea câțiva pași simpli.
...
steps_Extract:
    enable: true
    title_left: "Pași pentru extragerea adnotărilor din XLS în Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) le permite dezvoltatorilor Java să adnoteze documente și să extragă informații despre adnotări din fișiere XLS din orice aplicație bazată pe Java, prin implementarea câțiva pași simpli.
        *   Creați obiecte Răspuns cu comentariu și dată.
...
demos:
    ...
    content: |
        Adăugați, eliminați, editați și extrageți adnotări în fișierul XLS chiar acum, vizitând site-ul web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo-ul live are următoarele beneficii
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "Despre formatul de fișier XLS"
          content: |
            Fișierele cu extensia XLS reprezintă Excel Binary File Format. Astfel de fișiere pot fi create de Microsoft Excel, precum și de alte programe de calcul similare, cum ar fi OpenOffice Calc sau Apple Numbers. Fișierul salvat de Excel este cunoscut ca Workbook, unde fiecare registru de lucru poate avea una sau mai multe foi de lucru. Datele sunt stocate și afișate utilizatorilor în format tabel în foaia de lucru și pot cuprinde valori numerice, date text, formule, conexiuni de date externe, imagini și diagrame. Aplicații precum Microsoft Excel vă permit să exportați datele din registrul de lucru în mai multe formate diferite, inclusiv PDF, CSV, XLSX, TXT, HTML, XPS și multe altele. Formatul de fișier XLS a fost înlocuit cu un format mai deschis și mai structurat, XLSX, odată cu lansarea Microsoft Excel 2007. Cele mai recente versiuni încă oferă suport pentru crearea și citirea fișierelor XLS, deși XLSX este prima alegere de utilizare acum.
