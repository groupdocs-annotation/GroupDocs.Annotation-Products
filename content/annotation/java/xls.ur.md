...
############################# Head ############################
head_title: "C# میں Java XLS تشریح API تشریح"
head_description: "جاوا API XLS، تصاویر، ڈرائنگ اور دستاویز کی فائل فارمیٹس سے مشہور تشریحی اقسام بنانے اور تشریح کرنے کے لیے۔"

############################# Header ############################
title: "جاوا سے XLS تشریح کریں۔"
description: ""
...
about:
    ...
    content: |
        ...
        یہ لائبریری آپ کو نہ صرف XLS دستاویز کے ساتھ کام کرنے کی اجازت دیتی ہے بلکہ بہت سی دوسری قسم کی دستاویزات جیسے Word, Excel, PowerPoint, Outlook ای میلز, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad اور بہت سے دوسرے کے ساتھ بھی کام کرنے کی اجازت دیتی ہے۔
        ...
        مثال (براہ کرم نیچے دیکھیں) XLS دستاویز کے ساتھ کام کرنے کو ظاہر کرتی ہے، اس مثال میں آپ گروپ ڈاکس کے ساتھ کام کرنے کے اہم مراحل دیکھ سکتے ہیں۔ تشریح: ایک لائسنس ترتیب دیں، وہ دستاویز کھولیں جس کے ساتھ آپ کام کرنا چاہتے ہیں، ایک تخلیق تشریح، آپ کی ضروریات کے مطابق تشریحی خصوصیات کو سیٹ کرنے کے لیے ڈیٹا آبجیکٹ کو شامل کرنا اور نتیجہ کو مطلوبہ جگہ پر محفوظ کرنا۔ اس کے علاوہ آپ ہمارے گیتھب [صفحہ](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-Java) پر یا ہماری پروڈکٹ [دستاویزات](https://docs.groupdocs.com/annotation/java/getting-started/)۔

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "جاوا میں XLS میں تشریحات شامل کرنے کے اقدامات"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) جاوا ڈویلپرز کے لیے کسی بھی جاوا پر مبنی ایپلی کیشن میں XLS فائلوں میں مختلف تشریحی اقسام کو شامل کرنا آسان بناتا ہے چند آسان مراحل کو لاگو کرکے۔
...
steps_Remove:
    enable: true
    title_left: "جاوا میں XLS سے تشریحات کو ہٹانے کے اقدامات"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) جاوا ڈویلپرز کے لیے کسی بھی جاوا پر مبنی ایپلیکیشن کے اندر سے XLS فائلوں سے تشریحی تفصیلات کو ہٹانا آسان بناتا ہے چند آسان اقدامات کو لاگو کرکے۔
        *   تبصرہ اور تاریخ کے ساتھ جوابی اشیاء بنائیں۔
...
steps_Edit:
    enable: true
    title_left: "جاوا میں XLS سے تشریحات میں ترمیم کرنے کے مراحل"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) جاوا ڈویلپرز کے لیے کسی بھی جاوا پر مبنی ایپلیکیشن کے اندر XLS فائلوں سے مختلف تشریحی خصوصیات کو اپ ڈیٹ کرنا آسان بناتا ہے چند آسان اقدامات کو لاگو کرکے۔
...
steps_Extract:
    enable: true
    title_left: "جاوا میں XLS سے تشریحات نکالنے کے مراحل"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) جاوا ڈویلپرز کے لیے کچھ آسان اقدامات کو لاگو کرکے کسی بھی جاوا پر مبنی ایپلیکیشن کے اندر دستاویزات کی تشریح اور XLS فائلوں سے تشریحی معلومات نکالنا آسان بناتا ہے۔
        *   تبصرہ اور تاریخ کے ساتھ جوابی اشیاء بنائیں۔
...
demos:
    ...
    content: |
        ابھی [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) ویب سائٹ پر جا کر XLS فائل میں تشریحات شامل کریں، ہٹائیں، ترمیم کریں اور نکالیں۔ لائیو ڈیمو کے درج ذیل فوائد ہیں۔
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "XLS فائل فارمیٹ کے بارے میں"
          content: |
            XLS ایکسٹینشن والی فائلیں ایکسل بائنری فائل فارمیٹ کی نمائندگی کرتی ہیں۔ ایسی فائلیں Microsoft Excel کے ساتھ ساتھ دیگر اسی طرح کے اسپریڈشیٹ پروگراموں جیسے OpenOffice Calc یا Apple Numbers کے ذریعے بنائی جا سکتی ہیں۔ ایکسل کے ذریعہ محفوظ کردہ فائل کو ورک بک کے نام سے جانا جاتا ہے جہاں ہر ورک بک میں ایک یا زیادہ ورک شیٹس ہوسکتی ہیں۔ ڈیٹا کو ورک شیٹ میں ٹیبل فارمیٹ میں صارفین کے لیے اسٹور اور ڈسپلے کیا جاتا ہے اور یہ عددی اقدار، ٹیکسٹ ڈیٹا، فارمولے، بیرونی ڈیٹا کنکشن، تصاویر اور چارٹ تک پھیلا سکتا ہے۔ مائیکروسافٹ ایکسل جیسی ایپلی کیشنز آپ کو ورک بک ڈیٹا کو پی ڈی ایف، CSV، XLSX، TXT، HTML، XPS، اور کئی دیگر فارمیٹس میں ایکسپورٹ کرنے دیتی ہیں۔ ایکس ایل ایس فائل فارمیٹ کو مائیکروسافٹ ایکسل 2007 کی ریلیز کے ساتھ ایک زیادہ کھلے اور منظم فارمیٹ، XLSX سے بدل دیا گیا۔ تازہ ترین ورژن اب بھی XLS فائلوں کو بنانے اور پڑھنے کے لیے معاونت فراہم کرتے ہیں، حالانکہ XLSX اب استعمال کا پہلا انتخاب ہے۔
