...
head_description: "API de Java para crear y anotar tipos de anotaciones populares de XLSB, imágenes, dibujos y formatos de archivos de documentos."

############################# Header ############################
title: "Anotar XLSB desde Java"
description: ""
...
steps_Add:
    enable: true
    title_left: "Pasos para agregar anotaciones a XLSB en Java"
    content_left: |
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita a los desarrolladores de Java la actualización de varias propiedades de anotación de los archivos XLSB dentro de cualquier aplicación basada en Java mediante la implementación de unos sencillos pasos.
...
demos:
    ...
    content: |
        Agregue, elimine, edite y extraiga anotaciones en el archivo XLSB ahora mismo visitando el sitio web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostración en vivo tiene los siguientes beneficios
