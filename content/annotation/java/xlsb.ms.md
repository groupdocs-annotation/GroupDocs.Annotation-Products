...
############################# Head ############################
head_title: "Java XLSB Anotasi API Anotasi dalam C#"
head_description: "Java API untuk mencipta dan Menganotasi jenis anotasi popular daripada XLSB, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi XLSB daripada Java"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen XLSB tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada XLSB dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengalih keluar butiran anotasi daripada fail XLSB dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada XLSB dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java mengemas kini pelbagai sifat anotasi daripada fail XLSB dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada XLSB dalam Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pembangun Java untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail XLSB dalam mana-mana aplikasi berasaskan Java dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail XLSB sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xlsb"
          title: "Mengenai Format Fail XLSB."
          content: |
            Format fail XLSB menentukan Format Fail Binari Excel, yang merupakan koleksi rekod dan struktur yang menentukan kandungan buku kerja Excel. Kandungan boleh termasuk jadual nombor tidak berstruktur atau separa berstruktur, teks, atau kedua-dua nombor dan teks, formula, sambungan data luaran, carta dan imej. Tidak seperti XLSX (yang berdasarkan format fail XML Terbuka), XLSB mewakili fail buku kerja Excel binari. Fail XLSB boleh dibaca dan ditulis dengan lebih pantas yang menjadikannya berguna untuk bekerja dengan fail besar. XLSB jarang digunakan untuk menyimpan buku kerja kerana XLSX (dan sebelum ini XLS) ialah format fail pilihan pengguna yang paling biasa untuk menyimpan buku kerja. Ia boleh dibuka oleh Microsoft Office 2007 dan ke atas.
