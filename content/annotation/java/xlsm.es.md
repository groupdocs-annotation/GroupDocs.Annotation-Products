...
head_description: "Java API para crear y Eliminar tipos de anotaciones populares de XLSM, imágenes, dibujos y formatos de archivos de documentos."
...
demos:
    ...
    content: |
        Vea y elimine las anotaciones del archivo XLSM ahora mismo visitando el sitio web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
