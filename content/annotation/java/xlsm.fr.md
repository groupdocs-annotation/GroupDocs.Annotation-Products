...
############################# Head ############################
head_title: "Java XLSM Annotation API Annoter en C#"
head_description: "Java API pour créer et Annoter types d'annotations populaires depuis XLSM, images, dessins et formats de fichiers de documents."
