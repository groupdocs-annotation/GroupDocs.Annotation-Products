...
head_description: "Java API ku ji XLSX, wêne, xêzkirin û formatên pelên pelgeyê celebên annotasyonên populer çêbike û annot bike."

############################# Header ############################
title: "Ji Javayê XLSX şîrove bikin"
description: ""
...
about:
    ...
    content: |
        ...
        Ev pirtûkxane dihêle hûn ne tenê bi belgeya XLSX re lê her weha bi gelek celeb belgeyên din ên wekî Word, Excel, PowerPoint, e-nameyên Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad û gelekên din re bixebitin.
...
steps_Add:
    enable: true
    title_left: "Gavên Zêdekirina Şîroveyan li XLSX di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve cûrbecûr şîrovekirinê li pelên XLSX zêde bikin.
...
steps_Remove:
    enable: true
    title_left: "Gavên Rakirina Şîroveyan ji XLSX li Java"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku hûrguliyên annotasyonê ji pelên XLSX di nav her serîlêdana Java-yê de bi cîbicîkirina çend gavên hêsan rakin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
steps_Edit:
    enable: true
    title_left: "Gavên Guherandinên Şîrove ji XLSX di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsantir dike ku bi pêkanîna çend gavên hêsan ve taybetmendiyên cûrbecûr şîrovekirinê ji pelên XLSX di nav her serlêdanek Java-yê de nûve bikin.
...
steps_Extract:
    enable: true
    title_left: "Gavên Derxistina Şîroveyan ji XLSX di Java de"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) Ji pêşdebirên Java-yê re hêsan dike ku bi pêkanîna çend gavên hêsan belgeyan binivîsin û agahdariya şîrovekirinê ji pelên XLSX derxînin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
demos:
    ...
    content: |
        Bi seredana malpera [GroupDocs.Annotation Demos Zindî](https://products.groupdocs.app/annotation/family) niha li pelê XLSX şîroveyan zêde bikin, jêbikin, biguherînin û derxin. Demoya zindî xwedî feydeyên jêrîn e
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xlsx"
          title: "Derbarê XLSX Forma Pelê"
          content: |
            XLSX ji bo belgeyên Microsoft Excel-ê formatek naskirî ye ku ji hêla Microsoft-ê ve bi berdana Microsoft Office 2007-an ve hatî destnîşan kirin. Li ser bingeha strukturê ku li gorî Peymanên Vekirî yên Pakkirinê hatî organîze kirin ku di Beşa 2-ê ya standarda OOXML ECMA-376 de hatî destnîşan kirin, formata nû ye. pakêtek zip a ku hejmarek pelên XML dihewîne. Struktura bingehîn û pelan dikare bi tenê vekirina pelê .xlsx were vekolîn.
