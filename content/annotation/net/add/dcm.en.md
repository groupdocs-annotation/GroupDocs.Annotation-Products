...
############################# Head ############################
head_title: "Add Annotations to DCM in Net Application"
head_description: "Net API to create and Add popular annotation types to DCM, images, drawings and document file formats."

############################# Header ############################
title: "Add DCM Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DCM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
