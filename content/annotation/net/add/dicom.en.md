...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/dicom"/>

############################# Head ############################
head_title: "Add Annotations to DICOM in Net Application"
head_description: "Net API to create and Add popular annotation types to DICOM, images, drawings and document file formats."

############################# Header ############################
title: "Add DICOM Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DICOM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
