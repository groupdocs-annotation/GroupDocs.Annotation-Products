...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/djvu"/>

############################# Head ############################
head_title: "Add Annotations to DJVU in Net Application"
head_description: "Net API to create and Add popular annotation types to DJVU, images, drawings and document file formats."

############################# Header ############################
title: "Add DJVU Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DJVU file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
