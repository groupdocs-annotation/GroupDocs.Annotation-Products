...
############################# Head ############################
head_title: "Add Annotations to DOC in Net Application"
head_description: "Net API to create and Add popular annotation types to DOC, images, drawings and document file formats."

############################# Header ############################
title: "Add DOC Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DOC file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
