...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/docm"/>

############################# Head ############################
head_title: "Add Annotations to DOCM in Net Application"
head_description: "Net API to create and Add popular annotation types to DOCM, images, drawings and document file formats."

############################# Header ############################
title: "Add DOCM Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DOCM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
