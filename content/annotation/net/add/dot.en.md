...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/dot"/>

############################# Head ############################
head_title: "Add Annotations to DOT in Net Application"
head_description: "Net API to create and Add popular annotation types to DOT, images, drawings and document file formats."

############################# Header ############################
title: "Add DOT Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DOT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
