...
head_title: "Tambahkan Anotasi ke File DOT di Aplikasi C# .NET"
head_description: "Pemrosesan anotasi C# .NET &amp; API manajemen untuk menambahkan jenis anotasi populer ke file DOT, gambar, gambar, dan format file dokumen."

title: "Tambahkan Anotasi ke DOT di .NET"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan Anotasi ke DOT di C#"
    content_left: |
        [GroupDocs.Annotation](/id/annotation/net/) memudahkan pengembang .NET untuk menambahkan properti anotasi ke file DOT dari dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Tambahkan anotasi ke file DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Annotation Live Demo](https://products.groupdocs.app/annotation/family).  
