...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for .NET developers to add annotation properties to DOT files from within their applications by implementing a few easy steps.
