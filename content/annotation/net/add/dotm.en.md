...
############################# Head ############################
head_title: "Add Annotations to DOTM in Net Application"
head_description: "Net API to create and Add popular annotation types to DOTM, images, drawings and document file formats."

############################# Header ############################
title: "Add DOTM Files to Net"
description: "Add annotations to DOTM, Microsoft Office documents, images, HTML, drawings and other file formats in any type of Net application."
...
steps:
    enable: true
    title_left: "Steps to Add Annotations to DOTM in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easy for Net developers to add various annotation types to DOTM files within any Net-based application by implementing a few easy steps.
...
demos:
    ...
    content: |
        Create and add annotations to DOTM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
