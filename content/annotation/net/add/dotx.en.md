...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/dotx"/>

############################# Head ############################
head_title: "Add Annotations to DOTX in Net Application"
head_description: "Net API to create and Add popular annotation types to DOTX, images, drawings and document file formats."

############################# Header ############################
title: "Add DOTX Files to Net"
description: ""
