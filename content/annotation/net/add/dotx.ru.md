...
draft: false
############################# Head ############################
head_title: "Добавление аннотации к файлам DOTX в приложениях C# .NET"
head_description: "Обработка аннотаций C# .NET &amp; API управления для добавления популярных типов аннотаций к файлам DOTX, изображениям, форматам файлов чертежей и документов."
############################# Header ############################
title: "Добавить аннотацию к DOTX в .NET"
...
preview:
    ...
    code: |
        ...
        using (Annotator annotator = new Annotator("input.dotx"))
        {
...
demos:
    ...
    content: |
        Добавьте аннотацию в файл DOTX прямо сейчас, посетив [живые демонстрации](https://products.groupdocs.app/annotation/family). 
