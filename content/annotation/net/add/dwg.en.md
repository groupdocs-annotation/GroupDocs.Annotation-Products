...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/dwg"/>

############################# Head ############################
head_title: "Add Annotations to DWG in Net Application"
head_description: "Net API to create and Add popular annotation types to DWG, images, drawings and document file formats."

############################# Header ############################
title: "Add DWG Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to DWG file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
