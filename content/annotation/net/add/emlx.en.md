...
############################# Head ############################
head_title: "Add Annotations to EMLX in Net Application"
head_description: "Net API to create and Add popular annotation types to EMLX, images, drawings and document file formats."

############################# Header ############################
title: "Add EMLX Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to EMLX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
