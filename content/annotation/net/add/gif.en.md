...
############################# Head ############################
head_title: "Add Annotations to GIF in Net Application"
head_description: "Net API to create and Add popular annotation types to GIF, images, drawings and document file formats."

############################# Header ############################
title: "Add GIF Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to GIF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
