...
############################# Head ############################
head_title: "Add Annotations to HTML in Net Application"
head_description: "Net API to create and Add popular annotation types to HTML, images, drawings and document file formats."

############################# Header ############################
title: "Add HTML Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to HTML file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
