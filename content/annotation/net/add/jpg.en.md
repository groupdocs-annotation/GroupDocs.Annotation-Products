...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/jpg"/>

############################# Head ############################
head_title: "Add Annotations to JPG in Net Application"
head_description: "Net API to create and Add popular annotation types to JPG, images, drawings and document file formats."

############################# Header ############################
title: "Add JPG Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to JPG file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
