...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/odt"/>

############################# Head ############################
head_title: "Add Annotations to ODT in Net Application"
head_description: "Net API to create and Add popular annotation types to ODT, images, drawings and document file formats."

############################# Header ############################
title: "Add ODT Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to ODT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
