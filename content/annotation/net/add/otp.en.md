...
############################# Head ############################
head_title: "Add Annotations to OTP in Net Application"
head_description: "Net API to create and Add popular annotation types to OTP, images, drawings and document file formats."

############################# Header ############################
title: "Add OTP Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to OTP file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
