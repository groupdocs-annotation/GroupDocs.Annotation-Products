...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/ott"/>

############################# Head ############################
head_title: "Add Annotations to OTT in Net Application"
head_description: "Net API to create and Add popular annotation types to OTT, images, drawings and document file formats."

############################# Header ############################
title: "Add OTT Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to OTT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
