...
############################# Head ############################
head_title: "Add Annotations to PDF in Net Application"
head_description: "Net API to create and Add popular annotation types to PDF, images, drawings and document file formats."

############################# Header ############################
title: "Add PDF Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to PDF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
