...
############################# Head ############################
head_title: "Add Annotations to POTX in Net Application"
head_description: "Net API to create and Add popular annotation types to POTX, images, drawings and document file formats."

############################# Header ############################
title: "Add POTX Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to POTX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
