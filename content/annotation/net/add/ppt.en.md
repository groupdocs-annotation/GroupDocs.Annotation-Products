...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/ppt"/>

############################# Head ############################
head_title: "Add Annotations to PPT in Net Application"
head_description: "Net API to create and Add popular annotation types to PPT, images, drawings and document file formats."

############################# Header ############################
title: "Add PPT Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to PPT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
