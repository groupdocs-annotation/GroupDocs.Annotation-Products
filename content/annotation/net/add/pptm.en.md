...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/pptm"/>

############################# Head ############################
head_title: "Add Annotations to PPTM in Net Application"
head_description: "Net API to create and Add popular annotation types to PPTM, images, drawings and document file formats."

############################# Header ############################
title: "Add PPTM Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to PPTM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
