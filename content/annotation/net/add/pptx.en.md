...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/pptx"/>

############################# Head ############################
head_title: "Add Annotations to PPTX in Net Application"
head_description: "Net API to create and Add popular annotation types to PPTX, images, drawings and document file formats."

############################# Header ############################
title: "Add PPTX Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to PPTX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
