...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/rtf"/>

############################# Head ############################
head_title: "Add Annotations to RTF in Net Application"
head_description: "Net API to create and Add popular annotation types to RTF, images, drawings and document file formats."

############################# Header ############################
title: "Add RTF Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to RTF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
