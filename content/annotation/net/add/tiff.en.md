...
############################# Head ############################
head_title: "Add Annotations to TIFF in Net Application"
head_description: "Net API to create and Add popular annotation types to TIFF, images, drawings and document file formats."

############################# Header ############################
title: "Add TIFF Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to TIFF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
