...
############################# Head ############################
head_title: "Add Annotations to VSD in Net Application"
head_description: "Net API to create and Add popular annotation types to VSD, images, drawings and document file formats."

############################# Header ############################
title: "Add VSD Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to VSD file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
