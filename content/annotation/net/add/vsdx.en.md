...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/vsdx"/>

############################# Head ############################
head_title: "Add Annotations to VSDX in Net Application"
head_description: "Net API to create and Add popular annotation types to VSDX, images, drawings and document file formats."

############################# Header ############################
title: "Add VSDX Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to VSDX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
