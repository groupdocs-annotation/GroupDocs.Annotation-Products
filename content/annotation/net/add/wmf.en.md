...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/wmf"/>

############################# Head ############################
head_title: "Add Annotations to WMF in Net Application"
head_description: "Net API to create and Add popular annotation types to WMF, images, drawings and document file formats."

############################# Header ############################
title: "Add WMF Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to WMF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
