...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/xls"/>

############################# Head ############################
head_title: "Add Annotations to XLS in Net Application"
head_description: "Net API to create and Add popular annotation types to XLS, images, drawings and document file formats."

############################# Header ############################
title: "Add XLS Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to XLS file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
