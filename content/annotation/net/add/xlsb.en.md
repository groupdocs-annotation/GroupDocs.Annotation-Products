...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/add/xlsb"/>

############################# Head ############################
head_title: "Add Annotations to XLSB in Net Application"
head_description: "Net API to create and Add popular annotation types to XLSB, images, drawings and document file formats."

############################# Header ############################
title: "Add XLSB Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to XLSB file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
