...
############################# Head ############################
head_title: "Add Annotations to XLSX in Net Application"
head_description: "Net API to create and Add popular annotation types to XLSX, images, drawings and document file formats."

############################# Header ############################
title: "Add XLSX Files to Net"
description: ""
...
demos:
    ...
    content: |
        Create and add annotations to XLSX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
