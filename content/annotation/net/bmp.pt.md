...
############################# Head ############################
head_title: "Remover Anotações de BMP no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de BMP, imagens, desenhos e formatos de arquivo de documento."
