...
############################# Head ############################
head_title: "Net CAD API de anotação anotar em C #"
head_description: "Net API para criar e anotar tipos de anotação populares de CAD, imagens, desenhos e formatos de arquivo de documento."

############################# Header ############################
title: "Anote CAD da rede"
description: ""
...
about:
    ...
    content: |
        ...
        Esta biblioteca permite que você trabalhe não apenas com documento CAD, mas também com muitos outros tipos de documentos, como Word, Excel, PowerPoint, e-mails do Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad e muitos outros.
...
steps_Remove:
    enable: true
    title_left: "Etapas para remover anotações de CAD na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede remover detalhes de anotação de arquivos CAD dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
steps_Edit:
    enable: true
    title_left: "Etapas para editar anotações de CAD na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede atualizar várias propriedades de anotação de arquivos CAD dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
...
steps_Extract:
    enable: true
    title_left: "Etapas para extrair anotações de CAD na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede anotar documentos e extrair informações de anotação de arquivos CAD em qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
demos:
    ...
    content: |
        Adicione, remova, edite e extraia anotações para o arquivo CAD agora mesmo visitando o site [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). A demonstração ao vivo tem os seguintes benefícios
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-cad"
          ...
          content: |
            CAD significa Desenho Assistido por Computador. O termo CADD (para Computer Aided Design and Drafting) também é usado. Ele é usado para um formato de arquivo gráfico 3D e pode conter designs 2D ou 3D. O arquivo CAD é um formato de arquivo digital de um objeto gerado e usado pelo software CAD. Um arquivo CAD contém um desenho técnico, projeto, esquema ou renderização 3D de um objeto. Pode haver outras ferramentas CAD que podem ser usadas para criar, abrir, editar e exportar esses arquivos .cad para formatos de arquivo de desenho CAD mais amplamente usados.
