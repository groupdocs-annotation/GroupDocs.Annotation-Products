...
############################# Head ############################
head_title: "Net CSV Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de CSV, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu CSV de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document CSV sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de CSV a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers CSV dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de CSV a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers CSV dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de CSV a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers CSV dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer CSV ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-csv"
          title: "Sobre el format de fitxer CSV"
          content: |
            Els fitxers amb extensió CSV (valors separats per comes) representen fitxers de text sense format que contenen registres de dades amb valors separats per comes. Cada línia d'un fitxer CSV és un registre nou del conjunt de registres continguts al fitxer. Aquests fitxers es generen quan es pretén transferir dades d'un sistema d'emmagatzematge a un altre. Com que totes les aplicacions poden reconèixer registres separats per comes, la importació d'aquests fitxers de dades a la base de dades es fa de manera molt còmoda. Gairebé totes les aplicacions de fulls de càlcul com Microsoft Excel o OpenOffice Calc poden importar CSV sense gaire esforç. Les dades importades d'aquests fitxers s'organitzen en cel·les d'un full de càlcul per a la seva representació a l'usuari.
