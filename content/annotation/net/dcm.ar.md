...
head_description: "Net API لإنشاء أنواع التعليقات التوضيحية الشائعة والتعليق عليها من DCM وتنسيقات ملفات الصور والرسومات والمستندات."

############################# Header ############################
title: "علق DCM من Net"
description: ""
...
about:
    ...
    content: |
        ...
        تتيح لك هذه المكتبة العمل ليس فقط مع مستند DCM ولكن أيضًا مع العديد من أنواع المستندات الأخرى مثل Word و Excel و PowerPoint ورسائل البريد الإلكتروني في Outlook و Visio و Adobe و OpenDocument و OpenOffice و Photoshop و AutoCad وغيرها الكثير.
        ...
        يوضح المثال (يرجى الاطلاع أدناه) العمل مع مستند DCM ، في هذا المثال يمكنك رؤية الخطوات الرئيسية لكيفية العمل مع GroupDocs.Annotation: إعداد ترخيص ، افتح المستند الذي تريد العمل معه ، وإنشاء التعليق التوضيحي وإضافة كائنات البيانات لتعيين خصائص التعليقات التوضيحية وفقًا لمتطلباتك وحفظ النتيجة في المكان المطلوب. يمكنك أيضًا إلقاء نظرة أكثر تفصيلاً على الميزات المدعومة على github [صفحة] (https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-.NET) ، أو في منتجنا [التوثيق] (https : //docs.groupdocs.com/annotation/net/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "خطوات إضافة التعليقات التوضيحية إلى DCM في الشبكة"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) يسهل على مطوري الإنترنت إضافة أنواع مختلفة من التعليقات التوضيحية إلى ملفات DCM داخل أي تطبيق قائم على الشبكة من خلال تنفيذ بضع خطوات سهلة.
...
steps_Remove:
    enable: true
    title_left: "خطوات إزالة التعليقات التوضيحية من DCM في الشبكة"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) يسهل على مطوري الإنترنت إزالة تفاصيل التعليقات التوضيحية من ملفات DCM داخل أي تطبيق قائم على الشبكة من خلال تنفيذ بضع خطوات سهلة.
        *   إنشاء كائنات الرد مع التعليق والتاريخ.
...
steps_Edit:
    enable: true
    title_left: "خطوات تحرير التعليقات التوضيحية من DCM في الشبكة"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) يسهل على مطوري الإنترنت تحديث خصائص التعليقات التوضيحية المتنوعة من ملفات DCM داخل أي تطبيق قائم على الشبكة من خلال تنفيذ بضع خطوات سهلة.
...
steps_Extract:
    enable: true
    title_left: "خطوات استخراج التعليقات التوضيحية من DCM في الشبكة"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) يُسهل على مطوري Net وضع تعليقات توضيحية على المستندات واستخراج معلومات التعليقات التوضيحية من ملفات DCM داخل أي تطبيق مستند إلى Net عن طريق تنفيذ بضع خطوات سهلة.
        *   إنشاء كائنات الرد مع التعليق والتاريخ.
...
demos:
    ...
    content: |
        قم بإضافة التعليقات التوضيحية وإزالتها وتعديلها واستخراجها إلى ملف DCM الآن من خلال زيارة موقع ويب [GroupDocs.Annotation Live Demos] (https://products.groupdocs.app/annotation/family). يحتوي العرض التوضيحي المباشر على الفوائد التالية
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dcm"
          title: "حول تنسيق الملف DCM"
          content: |
            تمثل الملفات ذات الامتداد .DCM الصورة الرقمية التي تخزن المعلومات الطبية للمرضى مثل التصوير بالرنين المغناطيسي والأشعة المقطعية وصور الموجات فوق الصوتية. تم تطويره من قبل الرابطة الوطنية لمصنعي الأجهزة الكهربائية (NEMA) وكان الهدف منه توحيد تنسيق ملف التصوير لتوزيع وعرض الصور الطبية. إنه مشابه لتنسيق ملف DICOM ويمكن أن يتضمن معلومات المريض للرجوع إليها.
