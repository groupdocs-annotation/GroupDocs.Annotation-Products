...
head_description: "Net API para crear y Eliminar tipos de anotaciones populares de DCM, imágenes, dibujos y formatos de archivos de documentos."
...
demos:
    ...
    content: |
        Vea y elimine las anotaciones del archivo DCM ahora mismo visitando el sitio web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
