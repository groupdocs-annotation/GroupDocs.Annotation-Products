...
about:
    ...
    content: |
        ...
        Esta biblioteca permite que você trabalhe não apenas com documento DCM, mas também com muitos outros tipos de documentos, como Word, Excel, PowerPoint, e-mails do Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad e muitos outros.
...
steps_Remove:
    enable: true
    title_left: "Etapas para remover anotações de DCM na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede remover detalhes de anotação de arquivos DCM dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
steps_Edit:
    enable: true
    title_left: "Etapas para editar anotações de DCM na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede atualizar várias propriedades de anotação de arquivos DCM dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
...
steps_Extract:
    enable: true
    title_left: "Etapas para extrair anotações de DCM na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede anotar documentos e extrair informações de anotação de arquivos DCM em qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
demos:
    ...
    content: |
        Adicione, remova, edite e extraia anotações para o arquivo DCM agora mesmo visitando o site [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). A demonstração ao vivo tem os seguintes benefícios
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dcm"
          ...
          content: |
            Arquivos com extensão .DCM representam imagens digitais que armazenam informações médicas de pacientes, como ressonâncias magnéticas, tomografias computadorizadas e imagens de ultrassom. Ele foi desenvolvido pela National Electrical Manufacturers Association (NEMA) e visa padronizar o formato de arquivo de imagem para distribuição e visualização de imagens médicas. É semelhante ao formato de arquivo DICOM e pode incluir informações do paciente para referência.
