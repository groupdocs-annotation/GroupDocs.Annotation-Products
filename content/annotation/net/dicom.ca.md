...
############################# Head ############################
head_title: "Net DICOM Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de DICOM, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu DICOM de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document DICOM sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de DICOM a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers DICOM dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de DICOM a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers DICOM dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de DICOM a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers DICOM dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer DICOM ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          title: "Sobre el format de fitxer DICOM"
          content: |
            DICOM és l'acrònim d'Imatge Digital i Comunicacions en Medicina i pertany a l'àmbit de la Informàtica Mèdica. DICOM és la combinació de la definició del format de fitxer i un protocol de comunicacions de xarxa. DICOM utilitza l'extensió .DCM. .DCM existeix en dos formats diferents, és a dir, el format 1.x i el format 2.x. DCM Format 1.x també està disponible en dues versions normal i ampliada. DICOM s'utilitza per a la integració de dispositius d'imatge mèdica com impressores, servidors, escàners, etc. de diversos proveïdors i també conté dades d'identificació de cada pacient per a la seva singularitat. Els fitxers DICOM es poden compartir entre dues parts si són capaços de rebre dades d'imatge en format DICOM. La part de comunicació de DICOM és el protocol de capa d'aplicació i utilitza TCP/IP per comunicar-se entre entitats. Els protocols HTTP i HTTPS s'utilitzen per als serveis web de DICOM. Les versions admeses pels serveis web són 1.0, 1.1, 2 o posteriors.
