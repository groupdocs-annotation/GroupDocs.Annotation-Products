...
############################# Head ############################
head_title: "Net DICOM Annotation API Annotate in C#"
head_description: "Net API პოპულარული ანოტაციის ტიპების შესაქმნელად და ანოტაციისთვის DICOM-დან, სურათებიდან, ნახატებიდან და დოკუმენტის ფაილის ფორმატებიდან."

############################# Header ############################
title: "ანოტაცია DICOM Net-დან"
description: ""
...
about:
    ...
    content: |
        ...
        ეს ბიბლიოთეკა საშუალებას გაძლევთ იმუშაოთ არა მხოლოდ DICOM დოკუმენტთან, არამედ მრავალი სხვა ტიპის დოკუმენტთან, როგორიცაა Word, Excel, PowerPoint, Outlook ელფოსტა, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad და მრავალი სხვა.
...
steps_Remove:
    enable: true
    title_left: "ნაბიჯები ანოტაციების წასაშლელად DICOM-დან Net-ში"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Net-ის დეველოპერებს უადვილებს ანოტაციის დეტალების წაშლას DICOM ფაილებიდან ნებისმიერი Net-ზე დაფუძნებული აპლიკაციიდან რამდენიმე მარტივი ნაბიჯის განხორციელებით.
        *   შექმენით პასუხის ობიექტები კომენტარებით და თარიღით.
...
steps_Edit:
    enable: true
    title_left: "ნაბიჯები ანოტაციების რედაქტირებისთვის DICOM-დან Net-ში"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) უადვილებს Net-ის დეველოპერებს განაახლონ სხვადასხვა ანოტაციის თვისებები DICOM ფაილებიდან ნებისმიერი Net-ზე დაფუძნებული აპლიკაციის ფარგლებში რამდენიმე მარტივი ნაბიჯის განხორციელებით.
...
steps_Extract:
    enable: true
    title_left: "ნაბიჯები ანოტაციების ამოსაღებად DICOM-დან Net-ში"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Net-ის დეველოპერებს უადვილებს დოკუმენტების ანოტაციას და ანოტაციის ინფორმაციის ამოღებას DICOM ფაილებიდან ნებისმიერი Net-ზე დაფუძნებული აპლიკაციის ფარგლებში რამდენიმე მარტივი ნაბიჯის განხორციელებით.
        *   შექმენით პასუხის ობიექტები კომენტარებით და თარიღით.
...
demos:
    ...
    content: |
        დაამატეთ, წაშალეთ, დაარედაქტირეთ და ამოიღეთ ანოტაციები DICOM ფაილში ახლავე, ეწვიეთ [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) ვებსაიტს. ცოცხალი დემოს აქვს შემდეგი უპირატესობები
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          title: "DICOM ფაილის ფორმატის შესახებ"
          content: |
            DICOM არის აკრონიმი ციფრული გამოსახულების და კომუნიკაციების მედიცინაში და ეხება სამედიცინო ინფორმატიკის სფეროს. DICOM არის ფაილის ფორმატის განმარტებისა და ქსელის საკომუნიკაციო პროტოკოლის კომბინაცია. DICOM იყენებს .DCM გაფართოებას. .DCM არსებობს ორ სხვადასხვა ფორმატში, ანუ ფორმატში 1.x და ფორმატში 2.x. DCM ფორმატი 1.x შემდგომში ხელმისაწვდომია ორ ვერსიაში ნორმალური და გაფართოებული. DICOM გამოიყენება ისეთი სამედიცინო ვიზუალიზაციის მოწყობილობების ინტეგრირებისთვის, როგორიცაა პრინტერები, სერვერები, სკანერები და ა.შ. სხვადასხვა მომწოდებლებისგან და ასევე შეიცავს თითოეული პაციენტის საიდენტიფიკაციო მონაცემებს უნიკალურობისთვის. DICOM ფაილების გაზიარება შესაძლებელია ორ მხარეს შორის, თუ მათ შეუძლიათ მიიღონ სურათის მონაცემები DICOM ფორმატში. DICOM-ის საკომუნიკაციო ნაწილი არის აპლიკაციის ფენის პროტოკოლი და იყენებს TCP/IP-ს ერთეულებს შორის კომუნიკაციისთვის. HTTP და HTTPS პროტოკოლები გამოიყენება DICOM-ის ვებ სერვისებისთვის. ვებ სერვისების მიერ მხარდაჭერილი ვერსიებია 1.0, 1.1, 2 ან უფრო ახალი.
