...
############################# Head ############################
head_title: "Net DICOM Annotation API Annotate C#"
head_description: "Net API, lai izveidotu un anotētu populārus anotāciju veidus no DICOM, attēliem, zīmējumiem un dokumentu failu formātiem."

############################# Header ############################
title: "Anotējiet DICOM no tīkla"
description: ""
...
about:
    ...
    content: |
        ...
        Šī bibliotēka ļauj strādāt ne tikai ar DICOM dokumentu, bet arī ar daudziem cita veida dokumentiem, piemēram, Word, Excel, PowerPoint, Outlook e-pastiem, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad un daudziem citiem.
...
steps_Remove:
    enable: true
    title_left: "Darbības, lai noņemtu anotācijas no DICOM pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Izmantojot dažas vienkāršas darbības, Net izstrādātājiem ir vieglāk noņemt anotāciju informāciju no DICOM failiem jebkurā Net lietojumprogrammā.
        *   Izveidojiet atbildes objektus ar komentāru un datumu.
...
steps_Edit:
    enable: true
    title_left: "Darbības, lai rediģētu anotācijas no DICOM pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ļauj Net izstrādātājiem vieglāk atjaunināt dažādus anotāciju rekvizītus no DICOM failiem jebkurā Net lietojumprogrammā, veicot dažas vienkāršas darbības.
...
steps_Extract:
    enable: true
    title_left: "Darbības, lai izvilktu anotācijas no DICOM pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ļauj Net izstrādātājiem viegli anotēt dokumentus un izvilkt anotāciju informāciju no DICOM failiem jebkurā Net lietojumprogrammā, veicot dažas vienkāršas darbības.
        *   Izveidojiet atbildes objektus ar komentāru un datumu.
...
demos:
    ...
    content: |
        Pievienojiet, noņemiet, rediģējiet un izvelciet anotācijas failam DICOM tūlīt, apmeklējot vietni [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Tiešraides demonstrācijai ir šādas priekšrocības
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          title: "Par DICOM faila formātu"
          content: |
            DICOM ir digitālās attēlveidošanas un sakaru saīsinājums medicīnā un attiecas uz medicīnas informātikas jomu. DICOM ir faila formāta definīcijas un tīkla sakaru protokola kombinācija. DICOM izmanto paplašinājumu .DCM. .DCM pastāv divos dažādos formātos, t.i., formātā 1.x un formātā 2.x. DCM Format 1.x ir pieejams arī divās versijās - parastajā un paplašinātajā. DICOM tiek izmantots dažādu pārdevēju medicīniskās attēlveidošanas ierīču, piemēram, printeru, serveru, skeneru utt., integrācijai, un tajā ir arī katra pacienta identifikācijas dati, lai nodrošinātu unikalitāti. DICOM failus var koplietot starp divām pusēm, ja tās spēj saņemt attēlu datus DICOM formātā. DICOM komunikācijas daļa ir lietojumprogrammas slāņa protokols un izmanto TCP/IP, lai sazinātos starp entītijām. DICOM tīmekļa pakalpojumiem tiek izmantoti HTTP un HTTPS protokoli. Tīmekļa pakalpojumu atbalstītās versijas ir 1.0, 1.1, 2 vai jaunākas versijas.
