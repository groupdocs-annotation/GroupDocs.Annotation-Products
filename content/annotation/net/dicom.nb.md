...
############################# Head ############################
head_title: "Nett DICOM Annotation API Annotate i C#"
head_description: "Net API for å lage og kommentere populære merknadstyper fra DICOM, bilder, tegninger og dokumentfilformater."

############################# Header ############################
title: "Merk DICOM fra Nett"
description: ""
...
about:
    ...
    content: |
        ...
        Dette biblioteket lar deg jobbe ikke bare med DICOM-dokumenter, men også med mange andre typer dokumenter som Word, Excel, PowerPoint, Outlook-e-post, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad og mange andre.
...
steps_Remove:
    enable: true
    title_left: "Trinn for å fjerne merknader fra DICOM i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enklere for Net-utviklere å fjerne merknadsdetaljer fra DICOM-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
        *   Lag svarobjekter med kommentar og dato.
...
steps_Edit:
    enable: true
    title_left: "Trinn for å redigere merknader fra DICOM i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enklere for Net-utviklere å oppdatere ulike merknadsegenskaper fra DICOM-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
...
steps_Extract:
    enable: true
    title_left: "Trinn for å trekke ut merknader fra DICOM i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enkelt for Net-utviklere å kommentere dokumenter og trekke ut merknadsinformasjon fra DICOM-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
        *   Lag svarobjekter med kommentar og dato.
...
demos:
    ...
    content: |
        Legg til, fjern, rediger og trekk ut merknader til DICOM-filen akkurat nå ved å gå til nettstedet [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Live-demoen har følgende fordeler
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dicom"
          title: "Om DICOM filformat"
          content: |
            DICOM er forkortelsen for Digital Imaging and Communications in Medicine og gjelder feltet medisinsk informatikk. DICOM er kombinasjonen av filformatdefinisjon og en nettverkskommunikasjonsprotokoll. DICOM bruker utvidelsen .DCM. .DCM finnes i to forskjellige formater, dvs. format 1.x og format 2.x. DCM Format 1.x er videre tilgjengelig i to versjoner normal og utvidet. DICOM brukes til integrering av medisinsk bildebehandlingsutstyr som skrivere, servere, skannere etc fra ulike leverandører og inneholder også identifikasjonsdata for hver pasient for unikhet. DICOM-filer kan deles mellom to parter hvis de er i stand til å motta bildedata i DICOM-format. Kommunikasjonsdelen av DICOM er applikasjonslagsprotokoll og bruker TCP/IP for å kommunisere mellom enheter. HTTP- og HTTPS-protokoller brukes for nettjenestene til DICOM. Versjoner som støttes av nettjenester er 1.0, 1.1, 2 eller nyere.
