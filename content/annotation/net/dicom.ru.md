...
############################# Head ############################
head_title: "Удаление Аннотаций с DICOM в Net приложении"
...
demos:
    ...
    content: |
        Просмотрите и удалите аннотации из файла DICOM прямо сейчас, посетив [живые демонстрации](https://products.groupdocs.app/annotation/family).
