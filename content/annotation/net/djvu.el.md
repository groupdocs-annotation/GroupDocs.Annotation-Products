...
demos:
    ...
    content: |
        Προσθέστε, αφαιρέστε, επεξεργαστείτε και εξαγάγετε σχολιασμούς στο αρχείο DJVU τώρα, μεταβαίνοντας στον ιστότοπο [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
