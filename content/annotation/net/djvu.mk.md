...
############################# Head ############################
head_title: "Нето DJVU Annotation API Annotate во C#"
head_description: "Net API за создавање и забележување популарни типови прибелешки од DJVU, слики, цртежи и формати на датотеки на документи."

############################# Header ############################
title: "Забелешка DJVU од Net"
description: ""
...
about:
    ...
    content: |
        ...
        Оваа библиотека ви овозможува да работите не само со документи DJVU туку и со многу други видови документи како што се Word, Excel, PowerPoint, Outlook е-пошта, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad и многу други.
        ...
        Примерот (видете подолу) покажува работа со документот DJVU, во овој пример можете да ги видите главните чекори како да работите со GroupDocs. Забелешка: Поставете лиценца, отворете документ со кој сакате да работите, креирајте прибелешка, додавање податочни објекти за поставување на својствата на прибелешка според вашите барања и зачувување на резултатот на потребното место. Исто така, можете подетално да ги погледнете поддржаните функции на нашата [github страница](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-.NET) или во нашиот производ [документација](https://docs.groupdocs.com/annotation/net/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Чекори за додавање прибелешки на DJVU во мрежата"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) им олеснува на развивачите на Net да додаваат различни типови на прибелешки на датотеките DJVU во која било апликација базирана на мрежа со спроведување на неколку лесни чекори.
...
steps_Remove:
    enable: true
    title_left: "Чекори за отстранување на прибелешки од DJVU во мрежата"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) им олеснува на развивачите на Net да ги отстранат деталите за прибелешки од датотеките DJVU во која било апликација базирана на мрежа со спроведување на неколку лесни чекори.
        *   Креирајте објекти за одговор со коментар и датум.
...
steps_Edit:
    enable: true
    title_left: "Чекори за уредување прибелешки од DJVU во Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) им олеснува на развивачите на Net да ажурираат различни својства на прибелешки од датотеките DJVU во која било апликација базирана на мрежа со спроведување на неколку лесни чекори.
...
steps_Extract:
    enable: true
    title_left: "Чекори за екстракција на прибелешки од DJVU во мрежата"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) им олеснува на програмерите на Net да ставаат прибелешки и да извлечат информации за прибелешки од датотеките DJVU во која било апликација базирана на мрежа со спроведување на неколку лесни чекори.
        *   Креирајте објекти за одговор со коментар и датум.
...
demos:
    ...
    content: |
        Додајте, отстранувајте, уредувајте и извлечете прибелешки во датотеката DJVU во моментов со посета на веб-локацијата [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Демото во живо ги има следните предности
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-djvu"
          title: "За форматот на датотеката DJVU"
          content: |
            DjVu, изговорен како „déjà vu“, е формат на графичка датотека наменета за скенирани документи и книги, особено оние што содржат комбинација од текст, цртежи, слики и фотографии. Таа е развиена од AT&T Labs. Користи повеќе техники како што се раздвојување на слојот на сликата на слики од текст и позадина, прогресивно вчитување, аритметичко кодирање и компресија со загуби за битонски слики. Бидејќи датотеката DJVU може да содржи компресирани, но сепак висококвалитетни слики во боја, фотографии, текст и цртежи и може да се зачува на помалку простор, затоа се користи на веб како е-книги, прирачници, весници, антички документи итн.
