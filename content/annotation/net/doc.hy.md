...
############################# Head ############################
head_title: "Net DOC Annotation API Annotate C#-ում"
head_description: "Net API՝ DOC-ից հայտնի ծանոթագրությունների տեսակներ ստեղծելու և ծանոթագրելու համար, պատկերներ, գծագրեր և փաստաթղթերի ֆայլերի ձևաչափեր:"

############################# Header ############################
title: "Նշեք DOC-ը Net-ից"
description: ""
...
about:
    ...
    content: |
        ...
        Այս գրադարանը թույլ է տալիս աշխատել ոչ միայն DOC փաստաթղթի, այլ նաև բազմաթիվ այլ տեսակի փաստաթղթերի հետ, ինչպիսիք են Word, Excel, PowerPoint, Outlook էլ. նամակներ, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad և շատ այլ փաստաթղթեր:
        ...
        Օրինակը (տես ստորև) ցույց է տալիս աշխատանքը DOC փաստաթղթի հետ, այս օրինակում կարող եք տեսնել GroupDocs-ի հետ աշխատելու հիմնական քայլերը: Ծանոթագրություն. Կարգավորեք լիցենզիա, բացեք փաստաթուղթ, որի հետ ցանկանում եք աշխատել, ստեղծելով անոտացիա՝ ավելացնելով տվյալների օբյեկտներ՝ ձեր պահանջներին համապատասխան անոտացիոն հատկություններ սահմանելու համար և արդյունքը պահելով անհրաժեշտ տեղում: Նաև կարող եք ավելի մանրամասն նայել մեր github-ի [էջի] աջակցվող գործառույթներին (https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-.NET) կամ մեր արտադրանքի [փաստաթղթերում] (https ://docs.groupdocs.com/annotation/net/getting-started/):

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "DOC-ին Net-ում ծանոթագրություններ ավելացնելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողներին ավելացնել անոտացիայի տարբեր տեսակներ DOC ֆայլերում ցանցի վրա հիմնված ցանկացած հավելվածի մեջ՝ իրականացնելով մի քանի հեշտ քայլեր:
...
steps_Remove:
    enable: true
    title_left: "Ծանոթագրությունները DOC-ից Net-ից հեռացնելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողների համար անոտացիայի մանրամասները DOC ֆայլերից հեռացնելը ցանցի վրա հիմնված ցանկացած հավելվածում` իրականացնելով մի քանի հեշտ քայլեր:
        *   Ստեղծեք Reply օբյեկտներ՝ մեկնաբանությամբ և ամսաթվով:
...
steps_Edit:
    enable: true
    title_left: "DOC-ից Net-ում ծանոթագրությունները խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողների համար թարմացնել անոտացիայի տարբեր հատկություններ DOC ֆայլերից ցանցի վրա հիմնված ցանկացած հավելվածում` իրականացնելով մի քանի հեշտ քայլեր:
...
steps_Extract:
    enable: true
    title_left: "Քայլեր՝ ծանոթագրություններ հանելու DOC-ից Net-ում"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողներին ծանոթագրել փաստաթղթերը և անոտացիոն տեղեկություններ հանել DOC ֆայլերից ցանցի վրա հիմնված ցանկացած հավելվածում՝ մի քանի հեշտ քայլեր իրականացնելով:
        *   Ստեղծեք Reply օբյեկտներ՝ մեկնաբանությամբ և ամսաթվով:
...
demos:
    ...
    content: |
        Ավելացրեք, հեռացրեք, խմբագրեք և հանեք ծանոթագրություններ DOC ֆայլում հենց հիմա՝ այցելելով [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) կայքը: Կենդանի ցուցադրությունն ունի հետևյալ առավելությունները
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-doc"
          title: "DOC Ֆայլի ձևաչափի մասին"
          content: |
            .doc ընդլայնմամբ ֆայլերը ներկայացնում են Microsoft Word-ի կամ բառի մշակման այլ փաստաթղթերի կողմից ստեղծված փաստաթղթերը երկուական ֆայլի ձևաչափով: Ընդլայնումն ի սկզբանե օգտագործվել է մի քանի տարբեր օպերացիոն համակարգերում պարզ տեքստային փաստաթղթերի համար: Այն կարող է պարունակել մի քանի տարբեր տեսակի տվյալներ, ինչպիսիք են պատկերները, ձևաչափված, ինչպես նաև պարզ տեքստը, գրաֆիկները, գծապատկերները, ներկառուցված օբյեկտները, հղումները, էջերը, էջի ձևաչափումը, տպման կարգավորումները և շատ ուրիշներ: Ձևաչափը հայտնի էր բոլոր տեսակի փաստաթղթերի համար, քանի որ այն օգտվողներին առաջարկում է ձեռնարկներ, առաջարկներ, առանձնահատկություններ, ռեզյումեներ, հոդվածներ կամ նմանատիպ այլ փաստաթղթեր գրելու տարբերակների բազմազանություն: DOC-ի թարմացված տարբերակը DOCX-ն է, որը հիմնված է Office OpenXML-ի վրա, որի բնութագրերը բաց են:
