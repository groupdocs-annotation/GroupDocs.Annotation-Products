...
############################# Head ############################
head_title: "Net DOC Annotation API Annotate C#"
head_description: "Net API, lai izveidotu un anotētu populārus anotāciju veidus no DOC, attēliem, zīmējumiem un dokumentu failu formātiem."

############################# Header ############################
title: "Anotējiet DOC no tīkla"
description: ""
...
about:
    ...
    content: |
        ...
        Šī bibliotēka ļauj strādāt ne tikai ar DOC dokumentu, bet arī ar daudziem cita veida dokumentiem, piemēram, Word, Excel, PowerPoint, Outlook e-pastiem, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad un daudziem citiem.
...
steps_Remove:
    enable: true
    title_left: "Darbības, lai noņemtu anotācijas no DOC pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Izmantojot dažas vienkāršas darbības, Net izstrādātājiem ir vieglāk noņemt anotāciju informāciju no DOC failiem jebkurā Net lietojumprogrammā.
        *   Izveidojiet atbildes objektus ar komentāru un datumu.
...
steps_Edit:
    enable: true
    title_left: "Darbības, lai rediģētu anotācijas no DOC pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ļauj Net izstrādātājiem vieglāk atjaunināt dažādus anotāciju rekvizītus no DOC failiem jebkurā Net lietojumprogrammā, veicot dažas vienkāršas darbības.
...
steps_Extract:
    enable: true
    title_left: "Darbības, lai izvilktu anotācijas no DOC pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ļauj Net izstrādātājiem viegli anotēt dokumentus un izvilkt anotāciju informāciju no DOC failiem jebkurā Net lietojumprogrammā, veicot dažas vienkāršas darbības.
        *   Izveidojiet atbildes objektus ar komentāru un datumu.
...
demos:
    ...
    content: |
        Pievienojiet, noņemiet, rediģējiet un izvelciet anotācijas failam DOC tūlīt, apmeklējot vietni [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Tiešraides demonstrācijai ir šādas priekšrocības
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-doc"
          title: "Par DOC faila formātu"
          content: |
            Faili ar paplašinājumu .doc ir Microsoft Word vai citu tekstapstrādes dokumentu ģenerēti dokumenti binārā faila formātā. Sākotnēji paplašinājums tika izmantots vienkārša teksta dokumentācijai vairākās dažādās operētājsistēmās. Tas var saturēt vairākus dažādu veidu datus, piemēram, attēlus, formatētus, kā arī vienkāršu tekstu, diagrammas, diagrammas, iegultos objektus, saites, lapas, lapas formatējumu, drukas iestatījumus un daudz ko citu. Formāts bija populārs visu veidu dokumentācijai, jo tas lietotājiem piedāvā rokasgrāmatu, priekšlikumu, specifikāciju, CV, rakstu vai citu līdzīgu dokumentu rakstīšanas iespējas. Atjauninātā DOC versija ir DOCX, kuras pamatā ir Office OpenXML, kuras specifikācijas ir atklāti pieejamas.
