...
head_description: "Net API om gewilde annotasietipes van DOCM, beelde, tekeninge en dokumentlêerformate te skep en te annoteer."

############################# Header ############################
title: "Annoteer DOCM vanaf Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Stappe om aantekeninge by DOCM in Net te voeg"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit maklik vir Net-ontwikkelaars om verskeie aantekeningtipes by DOCM-lêers binne enige Net-gebaseerde toepassing by te voeg deur 'n paar maklike stappe te implementeer.
...
steps_Remove:
    enable: true
    title_left: "Stappe om aantekeninge van DOCM in Net te verwyder"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit makliker vir Net-ontwikkelaars om aantekeningbesonderhede van DOCM-lêers binne enige Net-gebaseerde toepassing te verwyder deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
steps_Edit:
    enable: true
    title_left: "Stappe om aantekeninge van DOCM in Net te wysig"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit makliker vir Net-ontwikkelaars om verskeie annotasie-eienskappe vanaf DOCM-lêers binne enige Net-gebaseerde toepassing op te dateer deur 'n paar maklike stappe te implementeer.
...
steps_Extract:
    enable: true
    title_left: "Stappe om aantekeninge uit DOCM in Net te onttrek"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit maklik vir Net-ontwikkelaars om dokumente te annoteer en annotasie-inligting uit DOCM-lêers binne enige Net-gebaseerde toepassing te onttrek deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
