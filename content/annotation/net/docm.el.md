...
demos:
    ...
    content: |
        Προσθέστε, αφαιρέστε, επεξεργαστείτε και εξαγάγετε σχολιασμούς στο αρχείο DOCM τώρα, μεταβαίνοντας στον ιστότοπο [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
