...
head_description: "Net API to create and Annotate popular annotation types from DOCM, images, drawings and document file formats."
...
demos:
    ...
    content: |
        Add, remove, edit and extract annotations to DOCM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
