...
############################# Head ############################
head_title: "Remover Anotações de DOCM no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de DOCM, imagens, desenhos e formatos de arquivo de documento."
...
demos:
    ...
    content: |
        Visualize e remova as anotações do arquivo DOCM agora mesmo visitando o site [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family).
