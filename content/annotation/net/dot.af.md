...
############################# Head ############################
head_title: "Net DOT Annotation API Annotate in C#"
head_description: "Net API om gewilde annotasietipes van DOT, beelde, tekeninge en dokumentlêerformate te skep en te annoteer."

############################# Header ############################
title: "Annoteer DOT vanaf Net"
description: ""
...
about:
    ...
    content: |
        ...
        Hierdie biblioteek laat jou toe om nie net met DOT dokument te werk nie, maar ook met baie ander tipe dokumente soos Word, Excel, PowerPoint, Outlook-e-posse, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad en vele ander.
...
steps_Remove:
    enable: true
    title_left: "Stappe om aantekeninge van DOT in Net te verwyder"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit makliker vir Net-ontwikkelaars om aantekeningbesonderhede van DOT-lêers binne enige Net-gebaseerde toepassing te verwyder deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
steps_Edit:
    enable: true
    title_left: "Stappe om aantekeninge van DOT in Net te wysig"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit makliker vir Net-ontwikkelaars om verskeie annotasie-eienskappe vanaf DOT-lêers binne enige Net-gebaseerde toepassing op te dateer deur 'n paar maklike stappe te implementeer.
...
steps_Extract:
    enable: true
    title_left: "Stappe om aantekeninge uit DOT in Net te onttrek"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maak dit maklik vir Net-ontwikkelaars om dokumente te annoteer en annotasie-inligting uit DOT-lêers binne enige Net-gebaseerde toepassing te onttrek deur 'n paar maklike stappe te implementeer.
        *   Skep Antwoord-objekte met kommentaar en datum.
...
demos:
    ...
    content: |
        Voeg, verwyder, redigeer en onttrek aantekeninge by DOT-lêer op die oomblik deur [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) webwerf te besoek. Die lewendige demo het die volgende voordele
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          title: "Oor DOT Lêerformaat"
          content: |
            Lêers met .DOT-uitbreiding is sjabloonlêers wat deur Microsoft Word geskep is om vooraf geformateerde instellings te hê vir die generering van verdere DOC- of DOCX-lêers. 'n Sjabloonlêer word geskep om spesifieke gebruikerinstellings te hê wat toegepas moet word op daaropvolgende lêers wat daaruit geskep is. Hierdie instellings sluit bladsymarges, grense, koptekste, voettekste en ander bladsyinstellings in. Sulke sjablone word in amptelike dokumente soos maatskappybriefhoofde en gestandaardiseerde vorms gebruik. Die DOT-lêerformaat is spesifiek vir Microsoft Word 2003 en vroeër, maar word ook deur hoër weergawes ondersteun. Microsoft Word maak by verstek elke nuwe dokument oop gebaseer op normal.dot-lêer. As dit gewysig word, sal al die nuwe lêers wat geskep word, dieselfde instellings tot gevolg hê as vanaf die sjabloonlêer. In Microsoft Word 2007 is die DOT-lêerformaat vervang met Office OpenXML-gebaseerde DOTX-lêerformaat.
