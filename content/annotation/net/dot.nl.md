...
############################# Head ############################
head_title: "Net DOT Annotatie-API Annotatie in C#"
head_description: "Net API voor het maken en annoteren van populaire annotatietypen van DOT, afbeeldingen, tekeningen en documentbestandsindelingen."

############################# Header ############################
title: "Annoteer DOT van Net"
description: ""
...
about:
    ...
    content: |
        ...
        Met deze bibliotheek kunt u niet alleen met DOT-documenten werken, maar ook met vele andere soorten documenten, zoals Word, Excel, PowerPoint, Outlook-e-mails, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad en vele anderen.
...
steps_Remove:
    enable: true
    title_left: "Stappen om annotaties te verwijderen uit DOT in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maakt het gemakkelijker voor internetontwikkelaars om annotatiedetails te verwijderen uit DOT-bestanden binnen elke op internet gebaseerde applicatie door een paar eenvoudige stappen te implementeren.
        *   Maak Reply-objecten met commentaar en datum.
...
steps_Edit:
    enable: true
    title_left: "Stappen om annotaties te bewerken van DOT in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maakt het voor internetontwikkelaars gemakkelijker om verschillende annotatie-eigenschappen van DOT-bestanden binnen elke op internet gebaseerde applicatie bij te werken door een paar eenvoudige stappen te implementeren.
...
steps_Extract:
    enable: true
    title_left: "Stappen om annotaties te extraheren uit DOT in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) maakt het gemakkelijk voor internetontwikkelaars om documenten te annoteren en annotatie-informatie te extraheren uit DOT-bestanden binnen elke op internet gebaseerde applicatie door een paar eenvoudige stappen te implementeren.
        *   Maak Reply-objecten met commentaar en datum.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          title: "Over DOT bestandsindeling"
          content: |
            Bestanden met de extensie .DOT zijn sjabloonbestanden die door Microsoft Word zijn gemaakt met vooraf geformatteerde instellingen voor het genereren van verdere DOC- of DOCX-bestanden. Er wordt een sjabloonbestand gemaakt om specifieke gebruikersinstellingen te hebben die moeten worden toegepast op volgende bestanden die hiervan worden gemaakt. Deze instellingen omvatten paginamarges, randen, kopteksten, voetteksten en andere pagina-instellingen. Dergelijke sjablonen worden gebruikt in officiële documenten zoals briefhoofden van bedrijven en gestandaardiseerde formulieren. Het DOT-bestandsformaat is specifiek voor Microsoft Word 2003 en eerder, maar wordt ook ondersteund door hogere versies. Microsoft Word opent standaard elk nieuw document op basis van het bestand normal.dot. Indien gewijzigd, zullen alle nieuw gemaakte bestanden resulteren in dezelfde instellingen als in het sjabloonbestand. In Microsoft Word 2007 is het DOT-bestandsformaat vervangen door het op Office OpenXML gebaseerde DOTX-bestandsformaat.
