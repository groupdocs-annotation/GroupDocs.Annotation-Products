...
############################# Head ############################
head_title: "Nett DOT Annotation API Annotate i C#"
head_description: "Net API for å lage og kommentere populære merknadstyper fra DOT, bilder, tegninger og dokumentfilformater."

############################# Header ############################
title: "Merk DOT fra Nett"
description: ""
...
about:
    ...
    content: |
        ...
        Dette biblioteket lar deg jobbe ikke bare med DOT-dokumenter, men også med mange andre typer dokumenter som Word, Excel, PowerPoint, Outlook-e-post, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad og mange andre.
...
steps_Remove:
    enable: true
    title_left: "Trinn for å fjerne merknader fra DOT i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enklere for Net-utviklere å fjerne merknadsdetaljer fra DOT-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
        *   Lag svarobjekter med kommentar og dato.
...
steps_Edit:
    enable: true
    title_left: "Trinn for å redigere merknader fra DOT i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enklere for Net-utviklere å oppdatere ulike merknadsegenskaper fra DOT-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
...
steps_Extract:
    enable: true
    title_left: "Trinn for å trekke ut merknader fra DOT i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enkelt for Net-utviklere å kommentere dokumenter og trekke ut merknadsinformasjon fra DOT-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
        *   Lag svarobjekter med kommentar og dato.
...
demos:
    ...
    content: |
        Legg til, fjern, rediger og trekk ut merknader til DOT-filen akkurat nå ved å gå til nettstedet [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Live-demoen har følgende fordeler
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          ...
          content: |
            Filer med filtypen .DOT er malfiler laget av Microsoft Word for å ha forhåndsformaterte innstillinger for generering av ytterligere DOC- eller DOCX-filer. En malfil opprettes for å ha spesifikke brukerinnstillinger som skal brukes på etterfølgende filer opprettet fra disse. Disse innstillingene inkluderer sidemarger, kantlinjer, topptekster, bunntekster og andre sideinnstillinger. Slike maler brukes i offisielle dokumenter som firmabrevhoder og standardiserte skjemaer. DOT-filformatet er spesifikt for Microsoft Word 2003 og tidligere, men støttes også av høyere versjoner. Microsoft Word åpner som standard hvert nytt dokument basert på normal.dot-filen. Hvis de endres, vil alle de nye filene som opprettes, resultere i samme innstillinger som fra malfilen. I Microsoft Word 2007 er DOT-filformatet erstattet med Office OpenXML-basert DOTX-filformat.
