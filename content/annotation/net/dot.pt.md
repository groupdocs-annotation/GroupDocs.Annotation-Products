...
############################# Head ############################
head_title: "Net DOT API de anotação anotar em C #"
head_description: "Net API para criar e anotar tipos de anotação populares de DOT, imagens, desenhos e formatos de arquivo de documento."

############################# Header ############################
title: "Anote DOT da rede"
description: ""
...
about:
    ...
    content: |
        ...
        Esta biblioteca permite que você trabalhe não apenas com documento DOT, mas também com muitos outros tipos de documentos, como Word, Excel, PowerPoint, e-mails do Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad e muitos outros.
...
steps_Remove:
    enable: true
    title_left: "Etapas para remover anotações de DOT na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede remover detalhes de anotação de arquivos DOT dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
steps_Edit:
    enable: true
    title_left: "Etapas para editar anotações de DOT na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede atualizar várias propriedades de anotação de arquivos DOT dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
...
steps_Extract:
    enable: true
    title_left: "Etapas para extrair anotações de DOT na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede anotar documentos e extrair informações de anotação de arquivos DOT em qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
demos:
    ...
    content: |
        Adicione, remova, edite e extraia anotações para o arquivo DOT agora mesmo visitando o site [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). A demonstração ao vivo tem os seguintes benefícios
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dot"
          title: "Sobre o formato de arquivo DOT"
          content: |
            Arquivos com extensão .DOT são arquivos de modelo criados pelo Microsoft Word para ter configurações pré-formatadas para geração de outros arquivos DOC ou DOCX. Um arquivo de modelo é criado para ter configurações de usuário específicas que devem ser aplicadas a arquivos subseqüentes criados a partir deles. Essas configurações incluem margens de página, bordas, cabeçalhos, rodapés e outras configurações de página. Esses modelos são usados ​​em documentos oficiais, como papéis timbrados da empresa e formulários padronizados. O formato de arquivo DOT é específico para o Microsoft Word 2003 e versões anteriores, mas também é suportado por versões superiores. Por padrão, o Microsoft Word abre todos os novos documentos com base no arquivo normal.dot. Se modificado, todos os novos arquivos criados resultarão nas mesmas configurações do arquivo de modelo. No Microsoft Word 2007, o formato de arquivo DOT foi substituído pelo formato de arquivo DOTX baseado no Office OpenXML.
