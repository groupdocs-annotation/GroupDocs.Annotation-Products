...
############################# Head ############################
head_title: "Remover Anotações de DOT no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de DOT, imagens, desenhos e formatos de arquivo de documento."
