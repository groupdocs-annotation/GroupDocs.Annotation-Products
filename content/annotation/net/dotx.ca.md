...
############################# Head ############################
head_title: "Net DOTX Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de DOTX, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu DOTX de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document DOTX sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de DOTX a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers DOTX dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de DOTX a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers DOTX dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de DOTX a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers DOTX dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer DOTX ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dotx"
          title: "Sobre el format de fitxer DOTX"
          content: |
            Els fitxers amb extensió DOTX són fitxers de plantilla creats per Microsoft Word per tenir una configuració preformatada per a la generació de fitxers DOCX addicionals. Es crea un fitxer de plantilla per tenir una configuració d'usuari específica que s'hauria d'aplicar a les mosques posteriors creades a partir d'aquestes. Aquests paràmetres inclouen els marges de la pàgina, les vores, les capçaleres, els peus de pàgina i altres opcions de configuració de la pàgina. Aquestes plantilles s'utilitzen en documents oficials, com ara capçaleres d'empresa i formularis estandarditzats. El format de fitxer DOTX es va introduir amb el llançament de Microsoft Office 2007 per substituir el format de fitxer binari DOT, però també és compatible amb versions superiors. De manera predeterminada, Microsoft Word obre cada document nou basat en el fitxer normal.dot. Si es modifiquen, tots els fitxers nous creats tindran la mateixa configuració que el fitxer de plantilla. A Microsoft Word 2007, el format de fitxer DOT s'ha substituït pel format de fitxer DOTX basat en Office OpenXML.
