...
############################# Head ############################
head_title: "Net DOTX API de anotação anotar em C #"
head_description: "Net API para criar e anotar tipos de anotação populares de DOTX, imagens, desenhos e formatos de arquivo de documento."

############################# Header ############################
title: "Anote DOTX da rede"
description: ""
...
about:
    ...
    content: |
        ...
        Esta biblioteca permite que você trabalhe não apenas com documento DOTX, mas também com muitos outros tipos de documentos, como Word, Excel, PowerPoint, e-mails do Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad e muitos outros.
...
steps_Remove:
    enable: true
    title_left: "Etapas para remover anotações de DOTX na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede remover detalhes de anotação de arquivos DOTX dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
steps_Edit:
    enable: true
    title_left: "Etapas para editar anotações de DOTX na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede atualizar várias propriedades de anotação de arquivos DOTX dentro de qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
...
steps_Extract:
    enable: true
    title_left: "Etapas para extrair anotações de DOTX na rede"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) torna mais fácil para os desenvolvedores da rede anotar documentos e extrair informações de anotação de arquivos DOTX em qualquer aplicativo baseado na rede, implementando algumas etapas fáceis.
        *   Crie objetos Reply com comentário e data.
...
demos:
    ...
    content: |
        Adicione, remova, edite e extraia anotações para o arquivo DOTX agora mesmo visitando o site [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). A demonstração ao vivo tem os seguintes benefícios
