...
head_description: "Net API to create and Annotate popular annotation types from DWG, images, drawings and document file formats."

############################# Header ############################
title: "Annotate DWG from Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to DWG in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for Net developers to add various annotation types to DWG files within any Net-based application by implementing a few easy steps.
...
steps_Remove:
    enable: true
    title_left: "Steps to Remove Annotations from DWG in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for Net developers to remove annotation details from DWG files within any Net-based application by implementing a few easy steps.
        *   Create Reply objects with comment and date.
...
steps_Edit:
    enable: true
    title_left: "Steps to Edit Annotations from DWG in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for Net developers to update various annotation properties from DWG files within any Net-based application by implementing a few easy steps.
...
steps_Extract:
    enable: true
    title_left: "Steps to Extract Annotations from DWG in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for Net developers to annotate documents and extract annotation information from DWG files within any Net-based application by implementing a few easy steps.
        *   Create Reply objects with comment and date.
