...
############################# Head ############################
head_title: "Net DXF Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de DXF, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu DXF de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document DXF sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de DXF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers DXF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de DXF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers DXF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de DXF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers DXF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer DXF ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-dxf"
          title: "Sobre el format de fitxer DXF"
          content: |
            DXF, Drawing Interchange Format o Drawing Exchange Format, és una representació de dades etiquetades del fitxer de dibuix d'AutoCAD. Cada element del fitxer té un número enter prefix anomenat codi de grup. Aquest codi de grup representa realment l'element que segueix i indica el significat d'un element de dades per a un tipus d'objecte determinat. El DXF permet representar gairebé tota la informació especificada per l'usuari en un fitxer de dibuix. El format de fitxer DXF va ser desenvolupat per Autodesk com a format de fitxer de dades CAD per a la interoperabilitat de dades entre AutoCAD i altres aplicacions. Així, les dades es poden importar d'altres formats a DXF a AutoCAD segons les especificacions d'interoperabilitat del format de fitxer DXF.
