...
############################# Head ############################
head_title: "Edit Annotations in BMP in Net Application"
head_description: "Net API to create and Edit popular annotation types in BMP, images, drawings and document file formats."

############################# Header ############################
title: "Edit BMP Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in BMP in Net"
    content_left: |
