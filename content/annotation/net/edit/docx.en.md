...
############################# Head ############################
head_title: "Edit Annotations in DOCX in Net Application"
head_description: "Net API to create and Edit popular annotation types in DOCX, images, drawings and document file formats."

############################# Header ############################
title: "Edit DOCX Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in DOCX in Net"
    content_left: |
