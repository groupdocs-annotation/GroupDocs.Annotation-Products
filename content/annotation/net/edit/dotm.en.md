...
############################# Head ############################
head_title: "Edit Annotations in DOTM in Net Application"
head_description: "Net API to create and Edit popular annotation types in DOTM, images, drawings and document file formats."

############################# Header ############################
title: "Edit DOTM Files in Net"
description: "Add annotations in DOTM, Microsoft Office documents, images, HTML, drawings and other file formats in any type of Net application."
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in DOTM in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Net developers to update various annotation properties from DOTM files within any Net-based application by implementing a few easy steps.
