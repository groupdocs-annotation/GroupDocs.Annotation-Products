...
############################# Head ############################
head_title: "Edit Annotations in EMLX in Net Application"
head_description: "Net API to create and Edit popular annotation types in EMLX, images, drawings and document file formats."

############################# Header ############################
title: "Edit EMLX Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in EMLX in Net"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from EMLX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
