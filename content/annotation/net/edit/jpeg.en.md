...
############################# Head ############################
head_title: "Edit Annotations in JPEG in Net Application"
head_description: "Net API to create and Edit popular annotation types in JPEG, images, drawings and document file formats."

############################# Header ############################
title: "Edit JPEG Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in JPEG in Net"
    content_left: |
