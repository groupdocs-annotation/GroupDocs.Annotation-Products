...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/edit/jpeg"/>

############################# Head ############################
head_title: "Редактирование Аннотаций в JPEG в Net приложении"
head_description: "Net API для создания и Редактирование популярных типов аннотаций в JPEG, изображения, чертежи и форматы файлов документов."

############################# Header ############################
title: "Редактирование JPEG файла в Net"
description: ""
...
steps:
    enable: true
    title_left: "Шаги по Редактирование аннотаций в JPEG in Net"
    content_left: |
