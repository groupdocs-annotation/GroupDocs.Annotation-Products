...
head_title: "Baca &amp; Edit Anotasi dalam File OTT di Aplikasi C# .NET"
head_description: "C# .NET annotation editor API untuk memperbarui jenis anotasi populer ke file OTT, gambar, gambar, dan format file dokumen."

title: "Edit Anotasi dalam File OTT di .NET"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi dari OTT di C#"
    content_left: |
        [GroupDocs.Annotation](/id/annotation/net/) memudahkan pengembang .NET untuk mengedit detail anotasi dari file OTT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Edit anotasi dalam file OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Annotation Live Demo](https://products.groupdocs.app/annotation/family).  
