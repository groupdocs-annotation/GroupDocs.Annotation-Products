...
############################# Head ############################
head_title: "Edit Annotations in TIF in Net Application"
head_description: "Net API to create and Edit popular annotation types in TIF, images, drawings and document file formats."

############################# Header ############################
title: "Edit TIF Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in TIF in Net"
    content_left: |
