...
head_title: "読む＆amp; C＃.NETアプリケーションでVSDファイルの注釈を編集する"
head_description: "一般的な注釈タイプをVSDファイル、画像、図面、ドキュメントファイル形式に更新するC＃.NET注釈エディターAPI."

title: ".NETのVSDファイルの注釈を編集する"
...
steps:
    enable: true
    title_left: "C＃でVSDから注釈を編集する手順"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/）を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内のVSDファイルから注釈の詳細を簡単に編集できます。
...
demos:
    ...
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family）Webサイトにアクセスして、VSDファイルの注釈を今すぐ編集します。  
        ライブデモには次の利点があります
