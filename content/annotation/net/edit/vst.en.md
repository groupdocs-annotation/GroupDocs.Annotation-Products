...
############################# Head ############################
head_title: "Edit Annotations in VST in Net Application"
head_description: "Net API to create and Edit popular annotation types in VST, images, drawings and document file formats."

############################# Header ############################
title: "Edit VST Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in VST in Net"
    content_left: |
...
demos:
    ...
    content: |
        Read and edit annotations from VST file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
