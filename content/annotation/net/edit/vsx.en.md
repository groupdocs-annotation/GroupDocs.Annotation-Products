...
############################# Head ############################
head_title: "Edit Annotations in VSX in Net Application"
head_description: "Net API to create and Edit popular annotation types in VSX, images, drawings and document file formats."

############################# Header ############################
title: "Edit VSX Files in Net"
description: ""
...
steps:
    enable: true
    title_left: "Steps to Edit Annotations in VSX in Net"
    content_left: |
