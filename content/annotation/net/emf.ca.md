...
############################# Head ############################
head_title: "Net EMF Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de EMF, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu EMF de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document EMF sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de EMF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers EMF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de EMF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers EMF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de EMF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers EMF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer EMF ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-emf"
          title: "Sobre el format de fitxer EMF"
          content: |
            El format de metafitxer millorat (EMF) emmagatzema imatges gràfiques independentment del dispositiu. Els metafitxers d'EMF inclouen registres de longitud variable en ordre cronològic que poden representar la imatge emmagatzemada després d'analitzar-les en qualsevol dispositiu de sortida. Aquests registres de longitud variable poden ser definicions d'objectes tancats, ordres per dibuixar i propietats gràfiques crítiques per representar la imatge amb precisió. Quan un dispositiu obre un metàfitxer EMF utilitzant el seu propi entorn gràfic, les proporcions, dimensions, colors i altres propietats gràfiques de la imatge original segueixen sent les mateixes independentment de la plataforma del dispositiu d'obertura.
