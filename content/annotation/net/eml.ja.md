...
############################# Head ############################
head_title: "Net アプリケーションの 削除 注釈 から EML"
head_description: "Net API と 削除 の一般的な注釈タイプ から EML、画像、図面、ドキュメント ファイル形式を作成します。"
...
demos:
    ...
    title: "注釈を抽出するライブデモ"
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) Web サイトにアクセスして、今すぐ EML ファイルから注釈を表示して削除します。
