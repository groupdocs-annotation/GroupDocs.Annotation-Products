...
############################# Head ############################
head_title: "Net EMLX API di annotazione Annotate in C#"
head_description: "Net API per creare e Annotate tipi di annotazioni popolari da EMLX, immagini, disegni e formati di file di documenti."
...
steps_Add:
    enable: true
    title_left: "Passaggi per aggiungere annotazioni da EMLX in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende facile per gli sviluppatori Net aggiungere vari tipi di annotazioni ai file EMLX all'interno di qualsiasi applicazione basata su Net implementando pochi semplici passaggi.
...
steps_Remove:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende più facile per gli sviluppatori Net rimuovere i dettagli delle annotazioni dai file EMLX all'interno di qualsiasi applicazione basata su Net implementando alcuni semplici passaggi.
        * Crea oggetti di risposta con commento e data.
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende più facile per gli sviluppatori Net aggiornare varie proprietà di annotazione da file EMLX all'interno di qualsiasi applicazione basata su Net implementando pochi semplici passaggi.
...
steps_Extract:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) rende facile per gli sviluppatori Net annotare documenti ed estrarre informazioni di annotazione da file EMLX all'interno di qualsiasi applicazione basata su Net implementando pochi semplici passaggi.
        * Crea oggetti di risposta con commento e data.
