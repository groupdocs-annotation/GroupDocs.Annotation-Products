...
############################# Head ############################
head_title: "Remover Anotações de EMLX no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de EMLX, imagens, desenhos e formatos de arquivo de documento."
