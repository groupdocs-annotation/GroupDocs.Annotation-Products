...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/extract/dicom"/>

############################# Head ############################
head_title: "Extract Annotations from DICOM in Net Application"
head_description: "Net API to create and Extract popular annotation types from DICOM, images, drawings and document file formats."

############################# Header ############################
title: "Extract DICOM Files from Net"
description: ""
...
demos:
    ...
    content: |
        Extract annotation information from DICOM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
