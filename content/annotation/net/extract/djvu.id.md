...
head_title: "Ekstrak &amp; Ekspor Anotasi dari DJVU File di C# .NET"
head_description: "C# .NET anotasi ekstraksiAPI untuk mengekstrak jenis anotasi populer dari file DJVU, gambar, gambar, dan format file dokumen."

title: "Ekstrak Anotasi dari DJVU di C#"
...
steps:
    enable: true
    title_left: "Langkah-langkah Mengekstrak Anotasi dari DJVU"
    content_left: |
        [GroupDocs.Annotation](/id/annotation/net/) memudahkan pengembang .NET untuk mengekstrak informasi anotasi dari file DJVU dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ...
        using (Annotator annotator = new Annotator("annotated.djvu"))
        {
...
demos:
    ...
    content: |
        Ekstrak anotasi dari file DJVU sekarang juga dengan mengunjungi situs web [GroupDocs.Annotation Live Demo](https://products.groupdocs.app/annotation/family).  
