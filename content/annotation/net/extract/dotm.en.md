...
############################# Head ############################
head_title: "Extract Annotations from DOTM in Net Application"
head_description: "Net API to create and Extract popular annotation types from DOTM, images, drawings and document file formats."

############################# Header ############################
title: "Extract DOTM Files from Net"
...
steps:
    enable: true
    title_left: "Steps to Extract Annotations from DOTM in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easy for Net developers to annotate documents and extract annotation information from DOTM files within any Net-based application by implementing a few easy steps.
