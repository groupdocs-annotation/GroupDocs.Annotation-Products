...
############################# Head ############################
head_title: "Extract &amp; Export Annotations from HTM Files in C# .NET"
head_description: "C# .NET annotation extractionAPI to extract popular annotation types from HTM files, images, drawing and document file formats."

############################# Header ############################
title: "Extract Annotations from HTM in C#"
...
steps:
    enable: true
    title_left: "Steps for Extracting Annotations from HTM"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for .NET developers to extract annotation information from HTM files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // for using this example input file ("annotated.htm") must be with annotations
...
demos:
    ...
    content: |
        Extract annotation from HTM file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
