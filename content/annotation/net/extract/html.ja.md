...
head_title: "抽出＆amp; C＃.NETのHTMLファイルから注釈をエクスポートする"
head_description: "HTMLファイル、画像、描画、ドキュメントファイル形式から一般的な注釈タイプを抽出するためのC＃.NET注釈extractionAPI."

title: "C＃でHTMLから注釈を抽出する"
...
demos:
    ...
    content: |
        [GroupDocs.Annotationライブデモ](https://products.groupdocs.app/annotation/family)サイトにアクセスして、今すぐHTMLファイルから注釈を抽出します。  
        ライブデモには次の利点があります
