...
############################# Head ############################
head_title: "Extract &amp; Export Annotations from PPSX Files in C# .NET"
head_description: "C# .NET annotation extractionAPI to extract popular annotation types from PPSX files, images, drawing and document file formats."

############################# Header ############################
title: "Extract Annotations from PPSX in C#"
...
steps:
    ...
    code: |
        ```cs
        // for using this example input file ("annotated.ppsx") must be with annotations
...
demos:
    ...
    content: |
        Extract annotation from PPSX file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
