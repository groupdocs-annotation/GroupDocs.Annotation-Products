...
############################# Head ############################
head_title: "Extract Annotations from TIFF in Net Application"
head_description: "Net API to create and Extract popular annotation types from TIFF, images, drawings and document file formats."

############################# Header ############################
title: "Extract TIFF Files from Net"
description: ""
...
demos:
    ...
    content: |
        Extract annotation information from TIFF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
