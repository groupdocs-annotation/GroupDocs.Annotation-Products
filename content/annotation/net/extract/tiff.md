...
############################# Head ############################
head_title: "Extract &amp; Export Annotations from TIFF Files in C# .NET"
head_description: "C# .NET annotation extractionAPI to extract popular annotation types from TIFF files, images, drawing and document file formats."

############################# Header ############################
title: "Extract Annotations from TIFF in C#"
...
steps:
    ...
    code: |
        ```cs
        // for using this example input file ("annotated.tiff") must be with annotations
...
demos:
    ...
    content: |
        Extract annotation from TIFF file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.  
