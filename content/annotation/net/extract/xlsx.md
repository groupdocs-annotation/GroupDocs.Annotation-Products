...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for .NET developers to extract annotation information from XLSX files within their applications by implementing a few easy steps.
