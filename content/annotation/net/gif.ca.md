...
############################# Head ############################
head_title: "Net GIF Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de GIF, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu GIF de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document GIF sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de GIF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers GIF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de GIF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers GIF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de GIF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers GIF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer GIF ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-gif"
          title: "Sobre el format de fitxer GIF"
          content: |
            Un GIF o format d'intercanvi gràfic és un tipus d'imatge altament comprimida. Propietat d'Unisys, GIF utilitza l'algoritme de compressió LZW que no degrada la qualitat de la imatge. Per a cada imatge, els GIF normalment permeten fins a 8 bits per píxel i es permeten fins a 256 colors a la imatge. En contrast amb una imatge JPEG, que pot mostrar fins a 16 milions de colors i toca bastant els límits de l'ull humà. Quan va sorgir Internet, els GIF continuaven sent la millor opció perquè requerien un ample de banda baix i compatibles amb els gràfics que consumeixen zones sòlides de color. Un GIF animat combina nombroses imatges o fotogrames en un sol fitxer i els mostra en una seqüència per generar un clip animat o un vídeo curt. Les limitacions de color són de fins a 256 per a cada fotograma i és probable que siguin les menys adequades per reproduir altres imatges i fotografies amb degradat de color.
