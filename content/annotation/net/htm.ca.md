...
############################# Head ############################
head_title: "Net HTM Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de HTM, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu HTM de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document HTM sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de HTM a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers HTM dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de HTM a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers HTM dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de HTM a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers HTM dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer HTM ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-htm"
          title: "Sobre el format de fitxer HTM"
          content: |
            Els fitxers amb extensió HTM representen Hypertext Markup Language per crear pàgines web per mostrar-les en navegadors web com ara Google Chrome, Internet Explorer, Firefox i una sèrie d'altres. Defineix les marques per crear pàgines estàtiques que es publicaran a la World Wide Web (WWW) per accedir-hi. Aquestes marques indiquen als navegadors com mostrar el contingut d'una pàgina web. Aquestes pàgines poden contenir text sense format, imatges, hiperenllaços a altres pàgines, vídeos i altres mitjans de comunicació. Quan es publica una pàgina web, podeu fer una ullada al codi de marcatge que hi ha darrere si vegeu la font de la pàgina. Els navegadors moderns permeten inspeccionar cada secció d'una pàgina web on s'elabora cada subdivisió o element de marcatge de la font HTM.
