...
############################# Head ############################
head_title: "Bersih HTM Anotasi API Anotasi dalam C#"
head_description: "Net API untuk mencipta dan Menganotasi jenis anotasi popular daripada HTM, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi HTM daripada Net"
description: ""
...
about:
    ...
    content: |
        ...
        Pustaka ini membolehkan anda bekerja bukan sahaja dengan dokumen HTM tetapi juga dengan banyak jenis dokumen lain seperti Word, Excel, PowerPoint, e-mel Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad dan banyak lagi.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada HTM dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net mengalih keluar butiran anotasi daripada fail HTM dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada HTM dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net mengemas kini pelbagai sifat anotasi daripada fail HTM dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada HTM dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail HTM dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
demos:
    ...
    content: |
        Tambahkan, alih keluar, edit dan ekstrak anotasi pada fail HTM sekarang dengan melawati tapak web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Demo langsung mempunyai faedah berikut
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-htm"
          title: "Mengenai Format Fail HTM."
          content: |
            Fail dengan sambungan HTM mewakili Hypertext Markup Language untuk mencipta halaman web untuk paparan dalam pelayar web seperti Google Chrome, Internet Explorer, Firefox dan beberapa yang lain. Ia mentakrifkan penanda untuk mencipta halaman statik untuk diterbitkan di World Wide Web (WWW) untuk akses oleh orang lain. Penanda ini memberitahu penyemak imbas cara memaparkan kandungan halaman web. Halaman sedemikian boleh mengandungi teks biasa, imej, hiperpautan ke halaman lain, video dan maklumat media lain. Apabila halaman web diterbitkan, anda boleh melihat kod penanda di belakangnya dengan melihat sumber halamannya. Pelayar moden membenarkan untuk memeriksa setiap bahagian halaman web di mana setiap sub-bahagian atau elemen penanda dalam sumber HTM dihuraikan.
