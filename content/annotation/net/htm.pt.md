...
############################# Head ############################
head_title: "Remover Anotações de HTM no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de HTM, imagens, desenhos e formatos de arquivo de documento."
