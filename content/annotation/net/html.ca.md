...
############################# Head ############################
head_title: "Net HTML Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de HTML, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu HTML de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document HTML sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de HTML a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers HTML dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de HTML a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers HTML dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de HTML a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers HTML dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer HTML ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Sobre el format de fitxer HTML"
          content: |
            HTML (Hyper Text Markup Language) és l'extensió per a pàgines web creades per mostrar-les als navegadors. Conegut com a llenguatge del web, l'HTML ha evolucionat amb els requisits de nous requisits d'informació per mostrar-se com a part de les pàgines web. L'última variant es coneix com a HTML 5 que ofereix molta flexibilitat per treballar amb el llenguatge. Les pàgines HTML es reben del servidor, on estan allotjades, o també es poden carregar des del sistema local. Cada pàgina HTML està formada per elements HTML com ara formularis, text, imatges, animacions, enllaços, etc. Aquests elements estan representats per etiquetes com img, a, p i diverses altres on cada etiqueta té inici i final. També pot incrustar aplicacions escrites en llenguatges de script com ara JavaScript i Fulls d'estil (CSS) per a la representació global del disseny.
