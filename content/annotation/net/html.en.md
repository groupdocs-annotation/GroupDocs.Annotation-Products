...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to HTML in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for Net developers to add various annotation types to HTML files within any Net-based application by implementing a few easy steps.
...
steps_Remove:
    enable: true
    title_left: "Steps to Remove Annotations from HTML in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for Net developers to remove annotation details from HTML files within any Net-based application by implementing a few easy steps.
        *   Create Reply objects with comment and date.
...
steps_Edit:
    enable: true
    title_left: "Steps to Edit Annotations from HTML in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for Net developers to update various annotation properties from HTML files within any Net-based application by implementing a few easy steps.
...
steps_Extract:
    enable: true
    title_left: "Steps to Extract Annotations from HTML in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for Net developers to annotate documents and extract annotation information from HTML files within any Net-based application by implementing a few easy steps.
        *   Create Reply objects with comment and date.
