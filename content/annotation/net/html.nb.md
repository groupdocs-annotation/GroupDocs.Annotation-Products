...
############################# Head ############################
head_title: "Nett HTML Annotation API Annotate i C#"
head_description: "Net API for å lage og kommentere populære merknadstyper fra HTML, bilder, tegninger og dokumentfilformater."

############################# Header ############################
title: "Merk HTML fra Nett"
description: ""
...
about:
    ...
    content: |
        ...
        Dette biblioteket lar deg jobbe ikke bare med HTML-dokumenter, men også med mange andre typer dokumenter som Word, Excel, PowerPoint, Outlook-e-post, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad og mange andre.
...
steps_Remove:
    enable: true
    title_left: "Trinn for å fjerne merknader fra HTML i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enklere for Net-utviklere å fjerne merknadsdetaljer fra HTML-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
        *   Lag svarobjekter med kommentar og dato.
...
steps_Edit:
    enable: true
    title_left: "Trinn for å redigere merknader fra HTML i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enklere for Net-utviklere å oppdatere ulike merknadsegenskaper fra HTML-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
...
steps_Extract:
    enable: true
    title_left: "Trinn for å trekke ut merknader fra HTML i Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) gjør det enkelt for Net-utviklere å kommentere dokumenter og trekke ut merknadsinformasjon fra HTML-filer i en hvilken som helst Net-basert applikasjon ved å implementere noen få enkle trinn.
        *   Lag svarobjekter med kommentar og dato.
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-html"
          title: "Om HTML filformat"
          content: |
            HTML (Hyper Text Markup Language) er utvidelsen for nettsider som er opprettet for visning i nettlesere. HTML, som er kjent som nettets språk, har utviklet seg med krav til nye informasjonskrav som skal vises som en del av nettsider. Den siste varianten er kjent som HTML 5 som gir mye fleksibilitet for å jobbe med språket. HTML-sider mottas enten fra serveren, hvor disse er vert, eller kan også lastes fra lokalt system. Hver HTML-side består av HTML-elementer som skjemaer, tekst, bilder, animasjoner, lenker osv. Disse elementene er representert med tagger som img, a, p og flere andre hvor hver tag har start og slutt. Den kan også bygge inn applikasjoner skrevet i skriptspråk som JavaScript og Style Sheets (CSS) for generell layoutrepresentasjon.
