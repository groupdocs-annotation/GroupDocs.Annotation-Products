...
############################# Head ############################
head_title: "Remover Anotações de HTML no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de HTML, imagens, desenhos e formatos de arquivo de documento."
