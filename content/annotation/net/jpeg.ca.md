...
############################# Head ############################
head_title: "Net JPEG Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de JPEG, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu JPEG de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document JPEG sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de JPEG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers JPEG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de JPEG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers JPEG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de JPEG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers JPEG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer JPEG ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-jpeg"
          title: "Sobre el format de fitxer JPEG"
          content: |
            Un JPEG és un tipus de format d'imatge que es desa mitjançant el mètode de compressió amb pèrdues. La imatge de sortida, com a resultat de la compressió, és una compensació entre la mida d'emmagatzematge i la qualitat de la imatge. Els usuaris poden ajustar el nivell de compressió per aconseguir el nivell de qualitat desitjat i alhora reduir la mida d'emmagatzematge. La qualitat de la imatge es veu afectada de manera insignificant si s'aplica una compressió de 10:1 a la imatge. Com més alt sigui el valor de compressió, més gran serà la degradació de la qualitat de la imatge. El format de fitxer d'imatge JPEG va ser estandarditzat pel Joint Photographic Experts Group i, per tant, el nom JPEG. El format ha estat l'elecció d'emmagatzemar i transmetre imatges fotogràfiques a la xarxa. Gairebé tots els sistemes operatius ara tenen visors que admeten la visualització d'imatges JPEG, que sovint també s'emmagatzemen amb l'extensió JPG. Fins i tot els navegadors web admeten la visualització d'imatges JPEG.
