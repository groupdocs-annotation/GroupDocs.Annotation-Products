...
############################# Head ############################
head_title: "Net JPG Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de JPG, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu JPG de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document JPG sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de JPG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers JPG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de JPG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers JPG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de JPG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers JPG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer JPG ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-jpg"
          title: "Sobre el format de fitxer JPG"
          content: |
            Un JPG és un tipus de format d'imatge que es desa mitjançant el mètode de compressió amb pèrdues. La imatge de sortida, com a resultat de la compressió, és una compensació entre la mida d'emmagatzematge i la qualitat de la imatge. Els usuaris poden ajustar el nivell de compressió per aconseguir el nivell de qualitat desitjat i alhora reduir la mida d'emmagatzematge. La qualitat de la imatge es veu afectada de manera insignificant si s'aplica una compressió de 10:1 a la imatge. Com més alt sigui el valor de compressió, més gran serà la degradació de la qualitat de la imatge.
