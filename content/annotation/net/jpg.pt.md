...
############################# Head ############################
head_title: "Remover Anotações de JPG no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de JPG, imagens, desenhos e formatos de arquivo de documento."
