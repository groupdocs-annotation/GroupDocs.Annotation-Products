...
############################# Head ############################
head_title: "Net MSG Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de MSG, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu MSG de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document MSG sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de MSG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers MSG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de MSG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers MSG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de MSG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers MSG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer MSG ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-msg"
          title: "Sobre el format de fitxer MSG"
          content: |
            MSG és un format de fitxer utilitzat per Microsoft Outlook i Exchange per emmagatzemar missatges de correu electrònic, contactes, cites o altres tasques. Aquests missatges poden contenir un o més camps de correu electrònic, amb el remitent, el destinatari, l'assumpte, la data i el cos del missatge, o informació de contacte, dades de la cita i una o més especificacions de tasques. Les propietats que constitueixen l'objecte Message, inclòs, també formen part del fitxer MSG. El fitxer MSG té capçaleres, cos del missatge principal i hiperenllaços com a text ASCII senzill. Els fitxers MSG també són adequats amb els programes que necessiten la interfície de programació d'aplicacions de missatgeria (MAPI) de Microsoft.
