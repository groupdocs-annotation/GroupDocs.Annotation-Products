...
############################# Head ############################
head_title: "Remove Annotations from ODP in Net Application"
head_description: "Net API to create and Remove popular annotation types from ODP, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations from ODP in Net"
    content_left: |
...
steps_Remove:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Net developers to remove annotation details from ODP files within any Net-based application by implementing a few easy steps.
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Net developers to update various annotation properties from ODP files within any Net-based application by implementing a few easy steps.
...
steps_Extract:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easy for Net developers to annotate documents and extract annotation information from ODP files within any Net-based application by implementing a few easy steps.
