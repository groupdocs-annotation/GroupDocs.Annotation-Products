...
############################# Head ############################
head_title: "Net ODP Anotasi API Anotasi dalam C#"
head_description: "Net API untuk membuat dan Menganotasi jenis anotasi populer dari ODP, gambar, gambar, dan format file dokumen."

############################# Header ############################
title: "Beri anotasi ODP dari Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Langkah-langkah untuk Menambahkan Anotasi dari ODP di Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pengembang Net untuk menambahkan berbagai jenis anotasi ke file ODP dalam aplikasi berbasis Net apa pun dengan menerapkan beberapa langkah mudah.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Menghapus Anotasi dari ODP di Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) mempermudah pengembang Net untuk menghapus detail anotasi dari file ODP dalam aplikasi berbasis Net apa pun dengan menerapkan beberapa langkah mudah.
        * Buat objek Balas dengan komentar dan tanggal.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi dari ODP di Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) mempermudah pengembang Net untuk memperbarui berbagai properti anotasi dari file ODP dalam aplikasi berbasis Net apa pun dengan menerapkan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengekstrak Anotasi dari ODP di Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) memudahkan pengembang Net untuk menganotasi dokumen dan mengekstrak informasi anotasi dari file ODP dalam aplikasi berbasis Net apa pun dengan menerapkan beberapa langkah mudah.
        * Buat objek Balas dengan komentar dan tanggal.
