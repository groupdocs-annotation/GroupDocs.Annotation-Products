...
############################# Head ############################
head_title: "Remover Anotações de ODP no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de ODP, imagens, desenhos e formatos de arquivo de documento."
