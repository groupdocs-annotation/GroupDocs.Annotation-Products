...
############################# Head ############################
head_title: "Net ODS Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de ODS, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu ODS de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document ODS sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de ODS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers ODS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de ODS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers ODS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de ODS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers ODS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer ODS ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-ods"
          title: "Sobre el format de fitxer ODS"
          content: |
            Els fitxers amb extensió ODS representen el format OpenDocument Spreadsheet Document que l'usuari pot editar. Les dades s'emmagatzemen dins del fitxer ODF en files i columnes. És un format basat en XML i és un dels diversos subtipus de la família de formats de document obert (ODF). El format s'especifica com a part de les especificacions ODF 1.2 publicades i mantingudes per OASIS. Diverses aplicacions a Windows i altres sistemes operatius poden obrir fitxers ODS per editar-los i manipular-los, inclosos Microsoft Excel, NeoOffice i LibreOffice. Els fitxers ODS també es poden convertir en altres formats de full de càlcul, com ara XLS, XLSX i altres mitjançant diferents aplicacions.
