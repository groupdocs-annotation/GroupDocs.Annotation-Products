...
############################# Head ############################
head_title: "Remover Anotações de ODS no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de ODS, imagens, desenhos e formatos de arquivo de documento."
