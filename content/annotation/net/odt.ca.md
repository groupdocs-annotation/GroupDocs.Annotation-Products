...
############################# Head ############################
head_title: "Net ODT Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de ODT, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu ODT de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document ODT sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de ODT a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers ODT dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de ODT a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers ODT dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de ODT a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers ODT dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer ODT ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-odt"
          title: "Sobre el format de fitxer ODT"
          content: |
            Els fitxers ODT són tipus de documents creats amb aplicacions de processament de textos que es basen en el format de fitxer de text OpenDocument. Es creen amb aplicacions de processador de textos com ara OpenOffice Writer gratuït i poden contenir contingut com ara text, imatges, objectes i estils. El fitxer ODT és per al processador de textos Writer el que el DOCX és per a Microsoft Word. Diverses aplicacions, com ara Google Docs i el processador de textos basat en web de Google inclòs amb Google Drive, poden obrir els fitxers ODT per editar-los. Microsoft Word també pot obrir fitxers ODT i desar-los en altres formats com DOC i DOCX.
