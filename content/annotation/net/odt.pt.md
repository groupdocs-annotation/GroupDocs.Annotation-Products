...
############################# Head ############################
head_title: "Remover Anotações de ODT no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de ODT, imagens, desenhos e formatos de arquivo de documento."
