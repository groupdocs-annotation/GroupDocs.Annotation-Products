...
############################# Head ############################
head_title: "Net OTP Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de OTP, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu OTP de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document OTP sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de OTP a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers OTP dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de OTP a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers OTP dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de OTP a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers OTP dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer OTP ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-otp"
          title: "Sobre el format de fitxer OTP"
          content: |
            Els fitxers amb extensió .OTP representen fitxers de plantilla de presentació creats per aplicacions en format estàndard OASIS OpenDocument. El contingut d'aquest fitxer inclou informació de presentació en forma de diapositives amb text, imatges, formes, contingut multimèdia, efectes de transició i altres elements de diapositiva. Aquests fitxers de plantilla s'utilitzen per crear noves presentacions ràpidament basant-se en la informació d'estil emmagatzemada a la pròpia plantilla. Els fitxers OTP es poden crear i desar amb diverses aplicacions diferents, com ara Impress, que inclou la suite OpenOffice i Microsoft PowerPoint. El format de fitxer OTP és similar als fitxers de plantilla de Microsoft PowerPoint .POT i .POTX.
