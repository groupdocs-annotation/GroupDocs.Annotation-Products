...
############################# Head ############################
head_title: "Remover Anotações de OTP no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de OTP, imagens, desenhos e formatos de arquivo de documento."
