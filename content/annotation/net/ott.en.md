...
############################# Head ############################
head_title: "Remove Annotations from OTT in Net Application"
head_description: "Net API to create and Remove popular annotation types from OTT, images, drawings and document file formats."
...
demos:
    ...
    content: |
        View and remove annotations from OTT file right now by visiting [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) website.
