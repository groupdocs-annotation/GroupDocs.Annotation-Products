...
############################# Head ############################
head_title: "Net PDF Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de PDF, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu PDF de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document PDF sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de PDF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers PDF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de PDF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers PDF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de PDF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers PDF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer PDF ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-pdf"
          title: "Sobre el format de fitxer PDF"
          content: |
            El format de document portàtil (PDF) és un tipus de document creat per Adobe a la dècada de 1990. L'objectiu d'aquest format de fitxer era introduir un estàndard per a la representació de documents i altres materials de referència en un format independent del programari d'aplicació, el maquinari i el sistema operatiu. Els fitxers PDF es poden obrir a Adobe Acrobat Reader/Writer també a la majoria de navegadors moderns com Chrome, Safari, Firefox mitjançant extensions/connectors. La majoria de les suites de programari disponibles comercialment també ofereixen la conversió dels seus documents a format de fitxer PDF sense necessitat de cap component de programari addicional. Per tant, el format de fitxer PDF té la capacitat total per contenir informació com text, imatges, hiperenllaços, camps de formulari, mitjans enriquits, signatures digitals, fitxers adjunts, metadades, funcions geoespacials i objectes 3D que poden convertir-se en part del document font.
