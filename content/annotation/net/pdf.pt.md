...
steps_Add:
    enable: true
    title_left: "Etapas para adicionar anotações de PDF em Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita para os desenvolvedores Net adicionar vários tipos de anotação a arquivos PDF em qualquer aplicativo baseado em Net implementando algumas etapas fáceis.
...
steps_Remove:
    enable: true
    title_left: "Etapas para remover anotações de PDF em Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) torna mais fácil para os desenvolvedores Net remover detalhes de anotação de arquivos PDF em qualquer aplicativo baseado em Net implementando algumas etapas fáceis.
        * Crie objetos de resposta com comentário e data.
...
steps_Edit:
    enable: true
    title_left: "Etapas para editar anotações de PDF em Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) torna mais fácil para os desenvolvedores Net atualizar várias propriedades de anotação de arquivos PDF dentro de qualquer aplicativo baseado em Net implementando algumas etapas fáceis.
...
steps_Extract:
    enable: true
    title_left: "Etapas para extrair anotações de PDF em Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita para os desenvolvedores Net anotar documentos e extrair informações de anotação de arquivos PDF em qualquer aplicativo baseado em Net implementando algumas etapas fáceis.
        * Crie objetos de resposta com comentário e data.
