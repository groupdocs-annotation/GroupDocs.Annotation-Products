...
############################# Head ############################
head_title: "Net PNG Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de PNG, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu PNG de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document PNG sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de PNG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers PNG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de PNG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers PNG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de PNG a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers PNG dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer PNG ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-png"
          title: "Sobre el format de fitxer PNG"
          content: |
            PNG, Portable Network Graphics, fa referència a un tipus de format de fitxer d'imatge ràster que utilitza compressió sense pèrdues. Aquest format de fitxer es va crear com a substitució del format d'intercanvi de gràfics (GIF) i no té limitacions de drets d'autor. Tanmateix, el format de fitxer PNG no admet animacions. El format de fitxer PNG admet la compressió d'imatges sense pèrdua que el fa popular entre els seus usuaris. Amb el pas del temps, PNG ha evolucionat com un dels formats de fitxer d'imatge més utilitzats. Gairebé tots els sistemes operatius tenen suport per obrir fitxers PNG. Per exemple, el visualitzador de Microsoft Windows té la capacitat d'obrir fitxers PNG ja que el sistema operatiu té per defecte el suport disponible com a part de la instal·lació.
