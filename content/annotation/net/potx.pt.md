...
############################# Head ############################
head_title: "Remover Anotações de POTX no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de POTX, imagens, desenhos e formatos de arquivo de documento."
