...
############################# Head ############################
head_title: "C#의 Net PPS 주석 API 주석"
head_description: "PPS, 이미지, 그림 및 문서 파일 형식에서 인기 있는 주석 유형을 만들고 주석을 추가하는 Net API."

############################# Header ############################
title: "Net에서 PPS에 주석 달기"
description: ""
...
about:
    ...
    content: |
        ...
        예제(아래 참조)는 PPS 문서 작업을 보여줍니다. 이 예제에서는 GroupDocs 작업 방법의 주요 단계를 볼 수 있습니다. 주석: 라이선스 설정, 작업할 문서 열기, 주석, 데이터 개체를 추가하여 요구 사항에 따라 주석 속성을 설정하고 결과를 필요한 위치에 저장합니다. 또한 [github 페이지](https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-.NET) 또는 제품 [문서](https://docs.groupdocs.com/annotation/net/getting-started/).

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "Net에서 PPS에 주석을 추가하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Net 개발자가 몇 가지 간단한 단계를 구현하여 Net 기반 응용 프로그램 내의 PPS 파일에 다양한 주석 유형을 쉽게 추가할 수 있습니다.
...
steps_Remove:
    enable: true
    title_left: "Net의 PPS에서 주석을 제거하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Net 개발자가 몇 가지 간단한 단계를 구현하여 Net 기반 응용 프로그램 내의 PPS 파일에서 주석 세부 정보를 쉽게 제거할 수 있습니다.
        *   댓글과 날짜가 포함된 Reply 객체를 생성합니다.
...
steps_Edit:
    enable: true
    title_left: "Net에서 PPS의 주석을 편집하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Net 개발자가 몇 가지 간단한 단계를 구현하여 Net 기반 응용 프로그램 내의 PPS 파일에서 다양한 주석 속성을 쉽게 업데이트할 수 있습니다.
...
steps_Extract:
    enable: true
    title_left: "Net의 PPS에서 주석을 추출하는 단계"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Net 개발자가 몇 가지 간단한 단계를 구현하여 Net 기반 응용 프로그램 내의 PPS 파일에서 문서에 쉽게 주석을 달고 주석 정보를 추출할 수 있습니다.
        *   댓글과 날짜가 포함된 Reply 객체를 생성합니다.
