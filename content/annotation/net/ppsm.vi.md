...
############################# Head ############################
head_title: "Net PPSM Chú thích API Chú thích trong C#"
head_description: "Net API để tạo và Chú thích các loại chú thích phổ biến từ PPSM, hình ảnh, bản vẽ và định dạng tệp tài liệu."

############################# Header ############################
title: "Chú thích PPSM từ Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Các bước để thêm chú thích vào PPSM trong Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) giúp các nhà phát triển Net dễ dàng thêm nhiều loại chú thích khác nhau vào các tệp PPSM trong bất kỳ ứng dụng dựa trên Net nào bằng cách triển khai một vài bước đơn giản.
...
steps_Remove:
    enable: true
    title_left: "Các bước để xóa chú thích khỏi PPSM trong Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) giúp các nhà phát triển Net dễ dàng xóa các chi tiết chú thích khỏi các tệp PPSM trong bất kỳ ứng dụng dựa trên Net nào bằng cách triển khai một vài bước đơn giản.
        *   Tạo các đối tượng Trả lời với nhận xét và ngày tháng.
...
steps_Edit:
    enable: true
    title_left: "Các bước để chỉnh sửa chú thích từ PPSM trong Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) giúp các nhà phát triển Net dễ dàng cập nhật các thuộc tính chú thích khác nhau từ các tệp PPSM trong bất kỳ ứng dụng dựa trên Net nào bằng cách triển khai một vài bước đơn giản.
...
steps_Extract:
    enable: true
    title_left: "Các bước để trích xuất chú thích từ PPSM trong Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) giúp các nhà phát triển Net dễ dàng chú thích tài liệu và trích xuất thông tin chú thích từ các tệp PPSM trong bất kỳ ứng dụng dựa trên Net nào bằng cách triển khai một vài bước đơn giản.
        *   Tạo các đối tượng Trả lời với nhận xét và ngày tháng.
