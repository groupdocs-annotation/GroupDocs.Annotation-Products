...
############################# Head ############################
head_title: "API Anodi net PPSX Anodi yn C#"
head_description: "API Net i greu ac Anodi mathau o anodiadau poblogaidd o PPSX, delweddau, lluniadau a fformatau ffeil dogfen."

############################# Header ############################
title: "Anodwch PPSX o Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Camau i Ychwanegu Anodiadau i PPSX yn Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) yn ei gwneud hi'n hawdd i ddatblygwyr Net ychwanegu gwahanol fathau o anodiadau i PPSX ffeil o fewn unrhyw raglen Net-seiliedig trwy weithredu ychydig o gamau hawdd.
...
steps_Remove:
    enable: true
    title_left: "Camau i Dynnu Anodiadau o PPSX yn Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) yn ei gwneud yn haws i ddatblygwyr Net dynnu manylion anodiad o PPSX o ffeiliau o fewn unrhyw raglen Net-seiliedig trwy roi ychydig o gamau hawdd ar waith.
        *   Creu gwrthrychau Ateb gyda sylw a dyddiad.
...
steps_Edit:
    enable: true
    title_left: "Camau i Olygu Anodiadau o PPSX yn Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) yn ei gwneud hi'n haws i ddatblygwyr Net ddiweddaru priodweddau anodi amrywiol o PPSX ffeil o fewn unrhyw raglen Net-seiliedig trwy roi ychydig o gamau hawdd ar waith.
...
steps_Extract:
    enable: true
    title_left: "Camau i Echdynnu Anodiadau o PPSX yn Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) yn ei gwneud hi'n hawdd i ddatblygwyr Net anodi dogfennau a thynnu gwybodaeth anodiad o PPSX o ffeiliau o fewn unrhyw raglen Net-seiliedig trwy roi ychydig o gamau hawdd ar waith.
        *   Creu gwrthrychau Ateb gyda sylw a dyddiad.
