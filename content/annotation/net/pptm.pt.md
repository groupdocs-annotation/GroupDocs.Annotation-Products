...
############################# Head ############################
head_title: "Remover Anotações de PPTM no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de PPTM, imagens, desenhos e formatos de arquivo de documento."
