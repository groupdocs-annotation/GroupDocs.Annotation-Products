...
############################# Head ############################
head_title: "Interfejs API adnotacji Net PPTX Adnotacja w języku C#"
head_description: "Net API do tworzenia i opisywania popularnych typów adnotacji z PPTX, obrazów, rysunków i formatów plików dokumentów."

############################# Header ############################
title: "Adnotacja PPTX z sieci"
description: ""
...
steps_Add:
    enable: true
    title_left: "Kroki, aby dodać adnotacje do PPTX w sieci"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ułatwia programistom sieciowym dodawanie różnych typów adnotacji do plików PPTX w dowolnej aplikacji sieciowej poprzez wykonanie kilku prostych kroków.
...
steps_Remove:
    enable: true
    title_left: "Kroki, aby usunąć adnotacje z PPTX w sieci"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ułatwia programistom sieci usuwanie szczegółów adnotacji z plików PPTX w dowolnej aplikacji sieciowej, wykonując kilka prostych kroków.
        *   Utwórz obiekty odpowiedzi z komentarzem i datą.
...
steps_Edit:
    enable: true
    title_left: "Kroki, aby edytować adnotacje z PPTX w sieci"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ułatwia programistom sieci aktualizowanie różnych właściwości adnotacji z plików PPTX w dowolnej aplikacji sieciowej poprzez wykonanie kilku prostych kroków.
...
steps_Extract:
    enable: true
    title_left: "Kroki, aby wyodrębnić adnotacje z PPTX w sieci"
    content_left: |
