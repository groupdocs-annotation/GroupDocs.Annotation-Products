...
############################# Head ############################
head_title: "Remover Anotações de PPTX no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de PPTX, imagens, desenhos e formatos de arquivo de documento."
