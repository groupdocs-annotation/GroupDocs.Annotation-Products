...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for .NET developers to remove annotation details from BMP files within their applications by implementing a few easy steps.
