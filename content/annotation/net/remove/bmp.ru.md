...
###_DIMA_### link rel="canonical" href="https://products.groupdocs.com/annotation/net/remove/bmp"/>
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с BMP in Net"
    content_left: |
