...
draft: false
############################# Head ############################
head_title: "Удаление аннотаций из файлов PDF в приложениях C# .NET"
head_description: "API аннотаций C# .NET для удаления популярных типов аннотаций в файлы PDF, изображения, чертежи и форматы файлов документов."
############################# Header ############################
title: "Удалить аннотации из PDF в С#"
...
demos:
    ...
    content: |
        Удалите аннотацию из файла PDF прямо сейчас, посетив [живые демонстрации](https://products.groupdocs.app/annotation/family). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
