...
head_title: "C＃.NETアプリケーションのPOTXファイルから注釈を削除する"
head_description: "一般的な注釈タイプをPOTXファイル、画像、描画、およびドキュメントファイル形式に削除するC＃.NET注釈API."

title: "C＃でPOTXから注釈を削除する"
...
steps:
    enable: true
    title_left: "POTXから注釈を削除する手順"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/）を使用すると、.NET開発者は、いくつかの簡単な手順を実装することで、アプリケーション内のPOTXファイルから注釈の詳細を簡単に削除できます。
...
demos:
    ...
    content: |
        [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family）Webサイトにアクセスして、POTXファイルから注釈を今すぐ削除してください。  
        ライブデモには次の利点があります
