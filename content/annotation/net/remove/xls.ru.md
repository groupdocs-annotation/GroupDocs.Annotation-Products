...
############################# Head ############################
head_title: "Удаление Аннотаций с XLS в Net приложении"
...
steps:
    enable: true
    title_left: "Шаги по Удаление аннотаций с XLS in Net"
    content_left: |
