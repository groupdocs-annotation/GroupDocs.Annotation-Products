...
############################# Head ############################
head_title: "Net RTF Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de RTF, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu RTF de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document RTF sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de RTF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers RTF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de RTF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers RTF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de RTF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers RTF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer RTF ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-rtf"
          title: "Sobre el format de fitxer RTF"
          content: |
            Introduït i documentat per Microsoft, el format de text enriquit (RTF) representa un mètode de codificació de text i gràfics amb format per utilitzar-los dins de les aplicacions. El format facilita l'intercanvi de documents multiplataforma amb altres productes de Microsoft, complint així el propòsit d'interoperabilitat. Aquesta capacitat el converteix en un estàndard de transferència de dades entre programari de processament de textos i, per tant, el contingut es pot transferir d'un sistema operatiu a un altre sense perdre el format del document. Les especificacions de format de fitxer estan disponibles per Microsoft per a la seva descàrrega pública i es pot consultar des de la perspectiva del desenvolupador.
