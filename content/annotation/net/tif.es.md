...
############################# Head ############################
head_title: "Net TIF API de anotación Anotar en C#"
head_description: "Net API para crear y anotar tipos de anotaciones populares de TIF, imágenes, dibujos y formatos de archivos de documentos."

############################# Header ############################
title: "Anotar TIF de Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Pasos para agregar anotaciones a TIF en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita a los desarrolladores de Net agregar varios tipos de anotaciones a los archivos TIF dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
...
steps_Remove:
    enable: true
    title_left: "Pasos para eliminar anotaciones de TIF en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) hace que sea más fácil para los desarrolladores de Net eliminar los detalles de las anotaciones de los archivos TIF dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
        *   Cree objetos de respuesta con comentario y fecha.
...
steps_Edit:
    enable: true
    title_left: "Pasos para editar anotaciones de TIF en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) hace que sea más fácil para los desarrolladores de Net actualizar varias propiedades de anotación de los archivos TIF dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
...
steps_Extract:
    enable: true
    title_left: "Pasos para extraer anotaciones de TIF en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita a los desarrolladores de Net anotar documentos y extraer información de anotaciones de archivos TIF dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
        *   Cree objetos de respuesta con comentario y fecha.
