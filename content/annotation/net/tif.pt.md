...
############################# Head ############################
head_title: "Remover Anotações de TIF no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de TIF, imagens, desenhos e formatos de arquivo de documento."
