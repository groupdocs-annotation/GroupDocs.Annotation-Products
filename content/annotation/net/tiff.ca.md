...
############################# Head ############################
head_title: "Net TIFF Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de TIFF, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu TIFF de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document TIFF sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de TIFF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers TIFF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de TIFF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers TIFF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de TIFF a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers TIFF dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer TIFF ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-tiff"
          title: "Sobre el format de fitxer TIFF"
          content: |
            TIFF o TIF, Tagged Image File Format, representa imatges ràster destinades a utilitzar-se en diversos dispositius que compleixen amb aquest estàndard de format de fitxer. És capaç de descriure dades d'imatge a dos nivells, escala de grisos, paleta de colors i a tot color en diversos espais de color. Admet esquemes de compressió amb pèrdues i sense pèrdues per triar entre l'espai i el temps per a les aplicacions que utilitzen el format. El format és extensible i ha sofert diverses revisions que permeten incloure una quantitat il·limitada d'informació privada o amb finalitats especials. El format no depèn de la màquina i està lliure de límits com ara processador, sistema operatiu o sistemes de fitxers.
