...
############################# Head ############################
head_title: "Net VSDX Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de VSDX, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu VSDX de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document VSDX sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de VSDX a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers VSDX dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de VSDX a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers VSDX dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de VSDX a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers VSDX dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer VSDX ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-vsdx"
          title: "Sobre el format de fitxer VSDX"
          content: |
            Els fitxers amb extensió .VSDX representen el format de fitxer de Microsoft Visio introduït a partir de Microsoft Office 2013. Va ser desenvolupat per substituir el format de fitxer binari, .VSD, que és compatible amb versions anteriors de Microsoft Visio. També s'admet als serveis de Visio a Microsoft SharePoint Server 2013 i no requereix un format de fitxer intermediari per publicar-lo a SharePoint Server. Els fitxers Visio s'utilitzen per crear dibuixos que contenen objectes visuals, diagrames de flux, diagrames UML, flux d'informació, organigrames, diagrames de programari, disseny de xarxa, models de bases de dades, mapes d'objectes i altra informació similar. Els fitxers generats amb Visio també es poden exportar a diferents formats de fitxer com ara PNG, BMP, PDF i altres.
