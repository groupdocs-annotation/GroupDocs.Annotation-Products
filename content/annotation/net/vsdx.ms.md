...
############################# Head ############################
head_title: "Bersih VSDX Anotasi API Anotasi dalam C#"
head_description: "Net API untuk mencipta dan Menganotasi jenis anotasi popular daripada VSDX, imej, lukisan dan format fail dokumen."

############################# Header ############################
title: "Anotasi VSDX daripada Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Langkah Menambah Anotasi pada VSDX dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net menambah pelbagai jenis anotasi pada fail VSDX dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
...
steps_Remove:
    enable: true
    title_left: "Langkah-langkah untuk Mengalih keluar Anotasi daripada VSDX dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net mengalih keluar butiran anotasi daripada fail VSDX dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
...
steps_Edit:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit Anotasi daripada VSDX dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net mengemas kini pelbagai sifat anotasi daripada fail VSDX dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
...
steps_Extract:
    enable: true
    title_left: "Langkah-langkah untuk Mengeluarkan Anotasi daripada VSDX dalam Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) memudahkan pembangun Net untuk menganotasi dokumen dan mengekstrak maklumat anotasi daripada fail VSDX dalam mana-mana aplikasi berasaskan Net dengan melaksanakan beberapa langkah mudah.
        *   Cipta objek Balas dengan ulasan dan tarikh.
