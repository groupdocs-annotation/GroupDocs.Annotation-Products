...
############################# Head ############################
head_title: "Net VSS Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de VSS, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu VSS de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document VSS sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de VSS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers VSS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de VSS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers VSS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de VSS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers VSS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer VSS ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-vss"
          title: "Sobre el format de fitxer VSS"
          content: |
            Els VSS són fitxers de plantilla creats amb Microsoft Visio 2007 i anteriors. Un format de fitxer relativament nou és .VSSX que es va introduir amb Microsoft Visio 2013. Els fitxers stencil proporcionen objectes de dibuix que es poden incloure en un dibuix .VSD Visio. Microsoft Visio és conegut per crear elements de dibuix com ara col·leccions de formes, connectors, diagrames de flux, disseny de xarxa, diagrames UML, diagrames de programari, models de bases de dades, mapes d'objectes i altra informació similar. També té funcions de conversió riques de documents de Visio a altres formats de fitxer com PNG, BMP, PDF i altres. Visio està disponible tant per a Windows com per a Mac OS.
