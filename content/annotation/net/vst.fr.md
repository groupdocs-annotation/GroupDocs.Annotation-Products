...
############################# Head ############################
head_title: "Retirer Annotations depuis VST dans l'application Net"
head_description: "Net API pour créer et Retirer types d'annotations populaires depuis VST, images, dessins et formats de fichiers de documents."
