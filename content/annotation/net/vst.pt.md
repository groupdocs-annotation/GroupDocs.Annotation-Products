...
############################# Head ############################
head_title: "Remover Anotações de VST no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de VST, imagens, desenhos e formatos de arquivo de documento."
