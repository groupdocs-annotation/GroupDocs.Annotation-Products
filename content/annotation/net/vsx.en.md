...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations from VSX in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easy for Net developers to add various annotation types to VSX files within any Net-based application by implementing a few easy steps.
...
steps_Remove:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Net developers to remove annotation details from VSX files within any Net-based application by implementing a few easy steps.
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) makes it easier for Net developers to update various annotation properties from VSX files within any Net-based application by implementing a few easy steps.
