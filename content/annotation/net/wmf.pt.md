...
############################# Head ############################
head_title: "Remover Anotações de WMF no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de WMF, imagens, desenhos e formatos de arquivo de documento."
