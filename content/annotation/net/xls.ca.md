...
############################# Head ############################
head_title: "Net XLS Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de XLS, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu XLS de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document XLS sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de XLS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers XLS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de XLS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers XLS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de XLS a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers XLS dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer XLS ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "Sobre el format de fitxer XLS"
          content: |
            Els fitxers amb extensió XLS representen el format de fitxer binari d'Excel. Aquests fitxers els poden crear Microsoft Excel, així com altres programes de fulls de càlcul similars com OpenOffice Calc o Apple Numbers. El fitxer desat per Excel es coneix com a llibre de treball, on cada llibre de treball pot tenir un o més fulls de treball. Les dades s'emmagatzemen i es mostren als usuaris en format de taula en un full de treball i poden incloure valors numèrics, dades de text, fórmules, connexions de dades externes, imatges i gràfics. Aplicacions com Microsoft Excel us permeten exportar dades del llibre de treball a diversos formats diferents, com ara PDF, CSV, XLSX, TXT, HTML, XPS i diversos altres. El format de fitxer XLS es va substituir per un format més obert i estructurat, XLSX, amb el llançament de Microsoft Excel 2007. Les últimes versions encara ofereixen suport per crear i llegir fitxers XLS, tot i que XLSX és la primera opció d'ús ara.
