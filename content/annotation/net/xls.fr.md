...
############################# Head ############################
head_title: "Net XLS Annotation API Annoter en C#"
head_description: "Net API pour créer et Annoter types d'annotations populaires depuis XLS, images, dessins et formats de fichiers de documents."
