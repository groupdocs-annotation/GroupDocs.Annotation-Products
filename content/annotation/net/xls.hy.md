...
############################# Head ############################
head_title: "Net XLS Annotation API Annotate C#-ում"
head_description: "Net API՝ XLS-ից հայտնի ծանոթագրությունների տեսակներ ստեղծելու և ծանոթագրելու համար, պատկերներ, գծագրեր և փաստաթղթերի ֆայլերի ձևաչափեր:"

############################# Header ############################
title: "Նշեք XLS-ը Net-ից"
description: ""
...
about:
    ...
    content: |
        ...
        Այս գրադարանը թույլ է տալիս աշխատել ոչ միայն XLS փաստաթղթի, այլ նաև բազմաթիվ այլ տեսակի փաստաթղթերի հետ, ինչպիսիք են Word, Excel, PowerPoint, Outlook էլ. նամակներ, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad և շատ այլ փաստաթղթեր:
        ...
        Օրինակը (տես ստորև) ցույց է տալիս աշխատանքը XLS փաստաթղթի հետ, այս օրինակում կարող եք տեսնել GroupDocs-ի հետ աշխատելու հիմնական քայլերը: Ծանոթագրություն. Կարգավորեք լիցենզիա, բացեք փաստաթուղթ, որի հետ ցանկանում եք աշխատել, ստեղծելով անոտացիա՝ ավելացնելով տվյալների օբյեկտներ՝ ձեր պահանջներին համապատասխան անոտացիոն հատկություններ սահմանելու համար և արդյունքը պահելով անհրաժեշտ տեղում: Նաև կարող եք ավելի մանրամասն նայել մեր github-ի [էջի] աջակցվող գործառույթներին (https://github.com/groupdocs-annotation/GroupDocs.Annotation-for-.NET) կամ մեր արտադրանքի [փաստաթղթերում] (https ://docs.groupdocs.com/annotation/net/getting-started/):

############################# Steps ############################
howTo_Add:
steps_Add:
    enable: true
    title_left: "XLS-ին Net-ում ծանոթագրություններ ավելացնելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողներին ավելացնել անոտացիայի տարբեր տեսակներ XLS ֆայլերում ցանցի վրա հիմնված ցանկացած հավելվածի մեջ՝ իրականացնելով մի քանի հեշտ քայլեր:
...
steps_Remove:
    enable: true
    title_left: "Ծանոթագրությունները XLS-ից Net-ից հեռացնելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողների համար անոտացիայի մանրամասները XLS ֆայլերից հեռացնելը ցանցի վրա հիմնված ցանկացած հավելվածում` իրականացնելով մի քանի հեշտ քայլեր:
        *   Ստեղծեք Reply օբյեկտներ՝ մեկնաբանությամբ և ամսաթվով:
...
steps_Edit:
    enable: true
    title_left: "XLS-ից Net-ում ծանոթագրությունները խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողների համար թարմացնել անոտացիայի տարբեր հատկություններ XLS ֆայլերից ցանցի վրա հիմնված ցանկացած հավելվածում` իրականացնելով մի քանի հեշտ քայլեր:
...
steps_Extract:
    enable: true
    title_left: "Քայլեր՝ ծանոթագրություններ հանելու XLS-ից Net-ում"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) հեշտացնում է Net ծրագրավորողներին ծանոթագրել փաստաթղթերը և անոտացիոն տեղեկություններ հանել XLS ֆայլերից ցանցի վրա հիմնված ցանկացած հավելվածում՝ մի քանի հեշտ քայլեր իրականացնելով:
        *   Ստեղծեք Reply օբյեկտներ՝ մեկնաբանությամբ և ամսաթվով:
...
demos:
    ...
    content: |
        Ավելացրեք, հեռացրեք, խմբագրեք և հանեք ծանոթագրություններ XLS ֆայլում հենց հիմա՝ այցելելով [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family) կայքը: Կենդանի ցուցադրությունն ունի հետևյալ առավելությունները
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "XLS Ֆայլի ձևաչափի մասին"
          content: |
            XLS ընդլայնմամբ ֆայլերը ներկայացնում են Excel Երկուական Ֆայլի ձևաչափը: Նման ֆայլերը կարող են ստեղծվել Microsoft Excel-ի, ինչպես նաև այլ նմանատիպ աղյուսակային ծրագրերի միջոցով, ինչպիսիք են OpenOffice Calc-ը կամ Apple Numbers-ը: Excel-ի կողմից պահպանված ֆայլը հայտնի է որպես Աշխատանքային գիրք, որտեղ յուրաքանչյուր աշխատանքային գիրք կարող է ունենալ մեկ կամ մի քանի աշխատանքային թերթ: Տվյալները պահվում և ցուցադրվում են օգտատերերին աղյուսակի ձևաչափով աշխատանքային թերթում և կարող են ներառել թվային արժեքներ, տեքստային տվյալներ, բանաձևեր, արտաքին տվյալների միացումներ, պատկերներ և գծապատկերներ: Microsoft Excel-ի նման հավելվածները թույլ են տալիս աշխատանքային գրքույկի տվյալները արտահանել մի քանի տարբեր ձևաչափերով՝ ներառյալ PDF, CSV, XLSX, TXT, HTML, XPS և մի քանի այլ ձևաչափեր: XLS ֆայլի ձևաչափը փոխարինվեց ավելի բաց և կառուցվածքային ձևաչափով՝ XLSX, Microsoft Excel 2007-ի թողարկմամբ: Վերջին տարբերակները դեռևս ապահովում են XLS ֆայլեր ստեղծելու և կարդալու աջակցություն, թեև XLSX-ն այժմ օգտագործման առաջին ընտրությունն է:
