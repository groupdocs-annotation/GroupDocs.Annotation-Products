...
head_description: "Net API ku ji XLS, wêne, xêzkirin û formatên pelên pelgeyê celebên annotasyonên populer biafirîne û şîrove bike."

############################# Header ############################
title: "Nîşe XLS ji Net"
description: ""
...
about:
    ...
    content: |
        ...
        Ev pirtûkxane dihêle hûn ne tenê bi belgeya XLS re lê her weha bi gelek celeb belgeyên din ên wekî Word, Excel, PowerPoint, e-nameyên Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad û gelekên din re bixebitin.
...
steps_Add:
    enable: true
    title_left: "Gavên Zêdekirina Şîroveyan li XLS di Net-ê de"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ji bo pêşdebirên Net-ê hêsan dike ku bi pêkanîna çend gavên hêsan ve cûrbecûr şîrovekirina pelan li pelên XLS zêde bikin.
...
steps_Remove:
    enable: true
    title_left: "Gavên Rakirina Şîroveyan ji XLS li Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Ji pêşdebirên Net-ê re hêsantir dike ku hûrguliyên annotasyonê ji pelên XLS di nav her serîlêdana Net-ê de bi cîbicîkirina çend gavên hêsan rakin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
steps_Edit:
    enable: true
    title_left: "Gavên Guherandinên Şîrove ji XLS li Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Ji pêşdebirên Net-ê re hêsantir dike ku bi pêkanîna çend gavên hêsan ve nûvekirina taybetmendiyên cûrbecûr şîrovekirinê ji pelên XLS di nav her serlêdanek Net-ê de nûve bikin.
...
steps_Extract:
    enable: true
    title_left: "Gavên Derxistina Şîroveyan ji XLS li Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ji bo pêşdebirên Net-ê hêsan dike ku bi pêkanîna çend gavên hêsan ve belgeyan şîrove bikin û agahdariya şîrovekirinê ji pelên XLS derxînin.
        *   Tiştên Bersiv bi şîrove û tarîxê biafirînin.
...
demos:
    ...
    content: |
        Bi seredana malpera [GroupDocs.Annotation Demos Zindî](https://products.groupdocs.app/annotation/family) niha li pelê XLS şîroveyan zêde bikin, jêbikin, biguherînin û derxin. Demoya zindî xwedî feydeyên jêrîn e
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "Derbarê XLS Forma Pelê"
          content: |
            Pelên bi dirêjkirina XLS Forma Pelê Binary Excel temsîl dikin. Pelên bi vî rengî dikarin ji hêla Microsoft Excel û her weha bernameyên din ên berbelav ên mîna OpenOffice Calc an Apple Numbers ve werin afirandin. Pelê ku ji hêla Excel ve hatî tomar kirin wekî Pirtûka Xebatê tête zanîn ku her pirtûkek kar dikare yek an çend pelên xebatê hebin. Daneyên di forma tabloyê de di pelgeya xebatê de têne hilanîn û ji bikarhêneran re têne xuyang kirin û dikarin nirxên hejmarî, daneya nivîsê, formul, girêdanên daneya derveyî, wêne û nexşeyan bigirin. Serlêdanên mîna Microsoft Excel dihêle hûn daneyên pirtûka xebatê bi çend formatên cihêreng ên wekî PDF, CSV, XLSX, TXT, HTML, XPS, û çend kesên din derxînin. Forma pelê XLS bi serbestberdana Microsoft Excel 2007 bi formatek vekirîtir û birêkûpêktir, XLSX, hate guheztin. Guhertoyên herî paşîn hîn jî piştgirî ji bo afirandin û xwendina pelên XLS peyda dikin, her çend XLSX bijareya yekem a karanîna nuha ye.
