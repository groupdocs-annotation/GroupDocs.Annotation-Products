...
############################# Head ############################
head_title: "Net XLS Annotation API Annotate C#"
head_description: "Net API, lai izveidotu un anotētu populārus anotāciju veidus no XLS, attēliem, zīmējumiem un dokumentu failu formātiem."

############################# Header ############################
title: "Anotējiet XLS no tīkla"
description: ""
...
about:
    ...
    content: |
        ...
        Šī bibliotēka ļauj strādāt ne tikai ar XLS dokumentu, bet arī ar daudziem cita veida dokumentiem, piemēram, Word, Excel, PowerPoint, Outlook e-pastiem, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad un daudziem citiem.
...
steps_Remove:
    enable: true
    title_left: "Darbības, lai noņemtu anotācijas no XLS pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) Izmantojot dažas vienkāršas darbības, Net izstrādātājiem ir vieglāk noņemt anotāciju informāciju no XLS failiem jebkurā Net lietojumprogrammā.
        *   Izveidojiet atbildes objektus ar komentāru un datumu.
...
steps_Edit:
    enable: true
    title_left: "Darbības, lai rediģētu anotācijas no XLS pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ļauj Net izstrādātājiem vieglāk atjaunināt dažādus anotāciju rekvizītus no XLS failiem jebkurā Net lietojumprogrammā, veicot dažas vienkāršas darbības.
...
steps_Extract:
    enable: true
    title_left: "Darbības, lai izvilktu anotācijas no XLS pakalpojumā Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) ļauj Net izstrādātājiem viegli anotēt dokumentus un izvilkt anotāciju informāciju no XLS failiem jebkurā Net lietojumprogrammā, veicot dažas vienkāršas darbības.
        *   Izveidojiet atbildes objektus ar komentāru un datumu.
...
demos:
    ...
    content: |
        Pievienojiet, noņemiet, rediģējiet un izvelciet anotācijas failam XLS tūlīt, apmeklējot vietni [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). Tiešraides demonstrācijai ir šādas priekšrocības
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xls"
          title: "Par XLS faila formātu"
          content: |
            Faili ar XLS paplašinājumu ir Excel binārā faila formāts. Šādus failus var izveidot, izmantojot Microsoft Excel, kā arī citas līdzīgas izklājlapu programmas, piemēram, OpenOffice Calc vai Apple Numbers. Programmā Excel saglabātais fails ir pazīstams kā darbgrāmata, kurā katrā darbgrāmatā var būt viena vai vairākas darblapas. Dati tiek saglabāti un parādīti lietotājiem tabulas formātā darblapā, un tie var aptvert skaitliskās vērtības, teksta datus, formulas, ārējos datu savienojumus, attēlus un diagrammas. Programmas, piemēram, Microsoft Excel, ļauj eksportēt darbgrāmatas datus vairākos dažādos formātos, tostarp PDF, CSV, XLSX, TXT, HTML, XPS un vairākos citos. XLS faila formāts tika aizstāts ar atvērtāku un strukturētāku formātu XLSX, izlaižot programmu Microsoft Excel 2007. Jaunākās versijas joprojām nodrošina atbalstu XLS failu izveidei un lasīšanai, lai gan XLSX šobrīd ir pirmā izmantošanas izvēle.
