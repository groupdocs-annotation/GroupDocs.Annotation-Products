...
############################# Head ############################
head_title: "Remover Anotações de XLS no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de XLS, imagens, desenhos e formatos de arquivo de documento."
