...
############################# Head ############################
head_title: "Net XLSB Annotation API Annotate en C#"
head_description: "Net API per crear i anotar tipus d'anotacions populars a partir de XLSB, imatges, dibuixos i formats de fitxers de documents."

############################# Header ############################
title: "Anoteu XLSB de Net"
description: ""
...
about:
    ...
    content: |
        ...
        Aquesta biblioteca us permet treballar no només amb el document XLSB sinó també amb molts altres tipus de documents com ara Word, Excel, PowerPoint, correus electrònics d'Outlook, Visio, Adobe, OpenDocument, OpenOffice, Photoshop, AutoCad i molts altres.
...
steps_Remove:
    enable: true
    title_left: "Passos per eliminar les anotacions de XLSB a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net eliminar els detalls de les anotacions dels fitxers XLSB dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
steps_Edit:
    enable: true
    title_left: "Passos per editar les anotacions de XLSB a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita que els desenvolupadors de Net actualitzin diverses propietats d'anotació dels fitxers XLSB dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
...
steps_Extract:
    enable: true
    title_left: "Passos per extreure anotacions de XLSB a Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) facilita als desenvolupadors de Net anotar documents i extreure informació d'anotacions dels fitxers XLSB dins de qualsevol aplicació basada en Net mitjançant la implementació d'uns quants passos senzills.
        *   Creeu objectes de resposta amb comentari i data.
...
demos:
    ...
    content: |
        Afegiu, suprimiu, editeu i extreu anotacions al fitxer XLSB ara mateix visitant el lloc web [GroupDocs.Annotation Live Demos](https://products.groupdocs.app/annotation/family). La demostració en directe té els següents avantatges
...
about_formats:
    ...
    format:
        ...
        - icon: "far fa-file-xlsb"
          title: "Sobre el format de fitxer XLSB"
          content: |
            El format de fitxer XLSB especifica el format de fitxer binari d'Excel, que és una col·lecció de registres i estructures que especifiquen el contingut del llibre de treball d'Excel. El contingut pot incloure taules de números no estructurades o semiestructurades, text, o ambdós números i text, fórmules, connexions de dades externes, gràfics i imatges. A diferència de XLSX (que es basa en el format de fitxer Open XML), el XLSB representa un fitxer de llibre de treball d'Excel binari. Els fitxers XLSB es poden llegir i escriure més ràpidament, cosa que els fa útils per treballar amb fitxers grans. XLSB s'utilitza poques vegades per emmagatzemar llibres de treball, ja que XLSX (i anteriorment XLS) són els formats de fitxer seleccionats per l'usuari més habituals per desar llibres de treball. Es pot obrir amb Microsoft Office 2007 i posteriors.
