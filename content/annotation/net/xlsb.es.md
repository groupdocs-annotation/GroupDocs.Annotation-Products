...
############################# Head ############################
head_title: "Net XLSB API de anotación Anotar en C#"
head_description: "Net API para crear y Anotar tipos de anotaciones populares de XLSB, imágenes, dibujos y formatos de archivos de documentos."

############################# Header ############################
title: "Anotar XLSB de Net"
description: ""
...
steps_Add:
    enable: true
    title_left: "Pasos para agregar anotaciones de XLSB en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita a los desarrolladores de Net agregar varios tipos de anotaciones a los archivos XLSB dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
...
steps_Remove:
    enable: true
    title_left: "Pasos para eliminar anotaciones de XLSB en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) hace que sea más fácil para los desarrolladores de Net eliminar los detalles de las anotaciones de los archivos XLSB dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
        * Crear objetos de respuesta con comentario y fecha.
...
steps_Edit:
    enable: true
    title_left: "Pasos para editar anotaciones de XLSB en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) hace que sea más fácil para los desarrolladores de Net actualizar varias propiedades de anotación de archivos XLSB dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
...
steps_Extract:
    enable: true
    title_left: "Pasos para extraer anotaciones de XLSB en Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/java/) facilita a los desarrolladores de Net anotar documentos y extraer información de anotaciones de archivos XLSB dentro de cualquier aplicación basada en Net mediante la implementación de unos sencillos pasos.
        * Crear objetos de respuesta con comentario y fecha.
