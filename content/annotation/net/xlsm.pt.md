...
############################# Head ############################
head_title: "Remover Anotações de XLSM no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de XLSM, imagens, desenhos e formatos de arquivo de documento."
