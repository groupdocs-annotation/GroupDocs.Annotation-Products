...
head_description: "Net API to create and Annotate popular annotation types from XLSX, images, drawings and document file formats."
...
steps_Add:
    enable: true
    title_left: "Steps to Add Annotations to XLSX in Net"
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for Net developers to add various annotation types to XLSX files within any Net-based application by implementing a few easy steps.
...
steps_Remove:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for Net developers to remove annotation details from XLSX files within any Net-based application by implementing a few easy steps.
        *   Create Reply objects with comment and date.
...
steps_Edit:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easier for Net developers to update various annotation properties from XLSX files within any Net-based application by implementing a few easy steps.
...
steps_Extract:
    ...
    content_left: |
        [GroupDocs.Annotation](/annotation/net/) makes it easy for Net developers to annotate documents and extract annotation information from XLSX files within any Net-based application by implementing a few easy steps.
        *   Create Reply objects with comment and date.
