...
############################# Head ############################
head_title: "Remover Anotações de XLSX no aplicativo Net"
head_description: "Net API para criar e Remover tipos de anotação populares de XLSX, imagens, desenhos e formatos de arquivo de documento."
