...
############################# Head ############################
head_title: "Edit BMP File Annotations in Java Applications"
head_description: "Java annotations editor API to update popular annotation types from BMP, images, drawings and document file formats."

############################# Header ############################
title: "Edit Annotations in BMP File in Java"
description: "Java annotation editor for images, Microsoft Office and other document file formats. Annotate BMP files using 13 different annotation types like; area, text, notes, watermark etc."
...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/java) makes it easier for Java developers to update various annotation properties from BMP files within any Java-based application by implementing a few easy steps.
