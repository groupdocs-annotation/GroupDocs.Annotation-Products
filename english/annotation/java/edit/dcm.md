...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/java) makes it easier for Java developers to update various annotation properties from DCM files within any Java-based application by implementing a few easy steps.
