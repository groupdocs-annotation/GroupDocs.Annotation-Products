...
############################# Head ############################
head_title: "Remove Annotations from VST in Java Applications"
head_description: "Javaannotation API to remove popular annotation types from VST, images, drawings and document file formats."

############################# Header ############################
title: "Remove Annotations from VST in Java"
...
steps:
    enable: true
    title_left: "Steps to Delete Annotations from VST in Java"
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/java) makes it easier for Java developers to remove annotation details from VST files within any Java-based application by implementing a few easy steps.
