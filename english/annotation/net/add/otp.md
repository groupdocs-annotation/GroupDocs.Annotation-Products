...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/net) makes it easy for .NET developers to add annotation properties to OTP files from within their applications by implementing a few easy steps.
