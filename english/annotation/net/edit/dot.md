...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/net) makes it easy for .NET developers to edit annotation details from DOT files within their applications by implementing a few easy steps.
