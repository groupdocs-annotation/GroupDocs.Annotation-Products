...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/net) makes it easier for .NET developers to extract annotation information from CAD files within their applications by implementing a few easy steps.
