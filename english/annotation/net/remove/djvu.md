...
steps:
    ...
    content_left: |
        [GroupDocs.Annotation](https://products.groupdocs.com/annotation/net) makes it easy for .NET developers to remove annotation details from DJVU files within their applications by implementing a few easy steps.
